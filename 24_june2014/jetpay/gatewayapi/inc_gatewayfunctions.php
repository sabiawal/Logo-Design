<?php
	...
	function cardTypeAccepted (&$cardnum, $GatewaySettings = NULL) {
	...
	function CheckCardAcceptance($cardType, $GatewaySettings = NULL)
	{
		//global $GatewaySettings;
	...
	// Gateway cURL Check
		function sendXMLString ( &$xmlString, $GatewaySettings = NULL )
			{
		//global $GatewaySettings;
