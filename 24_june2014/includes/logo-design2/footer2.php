<div class="footer" style="background: url(images/body-bg-bottom.jpg) bottom left no-repeat scroll; padding:0; width: 1002px;" >
<span style="display: block; background: url(images/body-bg-mid.jpg) top left repeat-y scroll; padding:15px; margin: 0 0 5px;">
<div class="list-1">
<ul>
<li><a href="<?php echo site_url('ourmgmt2'); ?>">Management team </a></li>
<li><a href="<?php echo site_url('qualitycontrol2'); ?>">Quality control</a></li>
<li><a href="<?php echo site_url('partnership2'); ?>">Partnership programmes</a></li>
<li><a href="<?php echo site_url('terms2'); ?>">Terms and conditions</a></li>
</ul>
</div>
<div class="list-2">
<ul>
<li><a href="<?php echo site_url('guarantee2'); ?>">Guarantee</a></li>
<li><a href="<?php echo site_url('privacypolicy2'); ?>">Privacy policy</a></li>
<li><a href="<?php echo site_url('casestudy2'); ?>">Sample project</a></li>
<li><a href="<?php echo site_url('portfolio2'); ?>">View our portfolio </a></li>
</ul>
</div>
<div class="list-3">
<ul>
<li><a href="<?php echo site_url('faq2'); ?>">FAQ</a></li>
<li><a href="<?php echo site_url('packages2'); ?>">See our packages </a></li>
<li><a href="<?php echo site_url('packages2'); ?>">Start my logo</a></li>
<li><a href="<?php echo site_url('partnership2'); ?>">Partnership opportunities</a></li>
</ul>
</div>
<div class="list-4">
<ul>
<li><a href="<?php echo site_url('contact2'); ?>">Contact us </a></li>
<li><a href="<?php echo site_url('compare2'); ?>">Compare prices</a></li>
<li><a href="<?php echo site_url('casestudy2'); ?>">Case study </a></li>
<li><a href="<?php echo site_url('charity2'); ?>">Our charitable work</a></li>
</ul>
</div>
