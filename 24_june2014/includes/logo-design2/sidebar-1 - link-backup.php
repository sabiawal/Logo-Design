<div class="money-back">
    ...
    <div class="money-back-text">
        <div align="center"><a href="<?= site_url('guarantee2'); ?>"><img src="<?php echo base_url()?>images/guarantee.png" alt="Money Back Guarantee" title="Money Back Guarantee" /></a></div>
        <ul>
        <li>100 % original, custom-made</li>
        <li>No clipart </li>
        <?php if($this->router->method == 'packages2'){ echo "<li>24/7 ".COUNTRY." Phone Support</li>";} ?>
        </ul>
        <?php if($this->router->method != 'packages2'){  ?>
        <div align="center"><a href="<?=site_url('packages2');?>"><img src="<?= base_url()?>images/start-logo.jpg" alt="Start My Logo" title="Start My Logo" /></a></div>
        <?php } ?>
    </div>
...
<div align="center"><a href="<?= site_url('charity2'); ?>"><img src="<?= base_url()?>images/rtdthumb.jpg" alt="RTD" title="RTD" /></a></div><p>&nbsp;</p>
<p>Logo Design Guarantee has designed many logos for leading charities. See some of our logos we have designed for Churches. <a href="<?php echo site_url('charity2')?>"><span class="text-bold"> Read more.</span></a></p>
</div>
<div><img src="<?= base_url()?>images/side-bar-bg-bottom.jpg" title="bg-top" /></div>
</div>