<div class="money-back">
    ...
    <div class="money-back-text">
        <div align="center"><a href="<?= site_url('logodesign2/guarantee'); ?>"><img src="<?php echo base_url()?>images/guarantee.png" alt="Money Back Guarantee" title="Money Back Guarantee" /></a></div>
        <ul>
        ...
        <div align="center"><a href="<?=site_url('logodesign2/packages2');?>"><img src="<?= base_url()?>images/start-logo.jpg" alt="Start My Logo" title="Start My Logo" /></a></div>
        <?php } ?>
    </div>
...
<div align="center"><a href="<?= site_url('logodesign2/charity'); ?>"><img src="<?= base_url()?>images/rtdthumb.jpg" alt="RTD" title="RTD" /></a></div><p>&nbsp;</p>
<p>Logo Design Guarantee has designed many logos for leading charities. See some of our logos we have designed for Churches. <a href="<?php echo site_url('logodesign2/charity')?>"><span class="text-bold"> Read more.</span></a></p>
</div>
<div><img src="<?= base_url()?>images/side-bar-bg-bottom.jpg" title="bg-top" /></div>
</div>