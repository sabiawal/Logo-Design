<div class="money-back">
    <div><img src="<?= base_url()?>images/side-bar-bg-top.jpg" title="bg-top" alt="bg-top" /></div>
    <div class="money-back-text">
    <div align="center"><a href="<?= site_url('guarantee'); ?>"><img src="<?= base_url()?>images/guarantee.png" alt="Money Back Guarantee" title="Money Back Guarantee" /></a></div>
        <ul>
    ...
    <div align="center"><a href="<?= site_url('packages');?>"><img src="<?= base_url()?>images/start-logo.jpg" alt="Start My Logo" title="Start My Logo" /></a></div>
    <?php } ?>
    </div>
    <div><img src="<?= base_url()?>images/side-bar-bg-bottom.jpg" title="bg-top" alt="bg-top" /></div>
</div>
...
<div align="center"><a href="<?= site_url('charity'); ?>"><img src="<?= base_url()?>images/rtdthumb.jpg" alt="RTD" title="RTD" /></a></div><p>&nbsp;</p>
<p>Logo Design Guarantee has designed many logos for leading charities. See some of our logos we have designed for Churches. <a href="<?= site_url('charity')?>"><span class="text-bold"> Read more.</span></a></p>
</div>
<div><img src="<?= base_url()?>images/side-bar-bg-bottom.jpg" title="bg-top" alt="bg-top" /></div>
</div>