    ...
    <div align="center"><a href="<?php echo site_url('portfolio'); ?>"><img src="<?php echo base_url()?>images/trini.jpg" /></a></div>
    ...
    <p><a href="<?php echo site_url('portfolio')?>"><span class="text-underline">Read over 50 testimonials.</span></a></p>
    </div>
    <div><img src="<?php echo base_url()?>images/side-bar-bg-bottom.jpg" title="bg-top" /></div>
    </div>
