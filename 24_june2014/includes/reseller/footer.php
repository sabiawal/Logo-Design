...
<div class="list-1">
<ul>
<li><a href="<?php echo site_url('reseller/ourmgmt'); ?>">Management team </a></li>
<li><a href="<?php echo site_url('reseller/qualitycontrol'); ?>">Quality control</a></li>
<li><a href="<?php echo site_url('reseller/partnership'); ?>">Partnership programmes</a></li>
<li><a href="<?php echo site_url('reseller/terms'); ?>">Terms and conditions</a></li>
</ul>
</div>
<div class="list-2">
<ul>
<li><a href="<?php echo site_url('reseller/guarantee'); ?>">Guarantee</a></li>
<li><a href="<?php echo site_url('reseller/privacypolicy'); ?>">Privacy policy</a></li>
<li><a href="<?php echo site_url('reseller/casestudy'); ?>">Sample project</a></li>
<li><a href="<?php echo site_url('reseller/portfolio'); ?>">View our portfolio </a></li>
</ul>
</div>
<div class="list-3">
<ul>
<li><a href="<?php echo site_url('reseller/faq'); ?>">FAQ</a></li>
<li><a href="<?php echo site_url('reseller/packages'); ?>">See our packages </a></li>
<li><a href="<?php echo site_url('reseller/packages'); ?>">Start my logo</a></li>
<li><a href="<?php echo site_url('reseller/partnership'); ?>">Partnership opportunities</a></li>
</ul>
</div>
<div class="list-4">
<ul>
<li><a href="<?php echo site_url('reseller/contact'); ?>">Contact us </a></li>
<li><a href="<?php echo site_url('reseller/compare'); ?>">Compare prices</a></li>
<li><a href="<?php echo site_url('reseller/charity'); ?>">Our charitable work</a></li>
<li><a href="<?php echo site_url('reseller'); ?>">Reseller Opportunity</a></li>
</ul>
</div>
...
//]]>
        ...
        <!-- END SCANALERT CODE CODE FOR LDG.CO.UK --></li>
