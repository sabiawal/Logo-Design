<div class="money-back">
    ...
    <div align="center"><a href="<?php echo site_url('reselleropportunity/guarantee'); ?>"><img src="<?php echo base_url()?>images/guarantee.png" alt="Money Back Guarantee" title="Money Back Guarantee" /></a></div>
        <ul>
    ...
    <div align="center"><a href="<?php echo site_url('reselleropportunity/packages');?>"><img src="<?php echo base_url()?>images/start-logo.jpg" alt="Start My Logo" title="Start My Logo" /></a></div>
    <?php } ?>
    </div>
...
<div align="center"><a href="<?php echo site_url('reselleropportunity/charity'); ?>"><img src="<?php echo base_url()?>images/rtdthumb.jpg" alt="RTD" title="RTD" /></a></div><p>&nbsp;</p>
<p>Logo Design Guarantee has designed many logos for leading charities. See some of our logos we have designed for Churches. <a href="<?php echo site_url('reselleropportunity/charity')?>"><span class="text-bold"> Read more.</span></a></p>
</div>
<div><img src="<?php echo base_url()?>images/side-bar-bg-bottom.jpg" title="bg-top" /></div>
</div>