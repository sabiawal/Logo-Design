...
?>"><img src="<?php echo base_url()?>images/webdesign/best-value.jpg" alt="Best Value" title="Best Value" /></a></div>
  </div>
</div>
...
<div class="awards">
      ...
      <div class="awards-text">
        ...
        <p><span class="text-red">The American Design Awards was founded in the year 2000 rewarding <span class="text-bold">excellence in design</span> and business.</span> <span class="text-bold"><a href="<?php echo site_url('reselleropportunity/webadaward'); ?>">Read more.</a></span></p>
        <h2 class="text-blue text-bold">Summit international awards</h2>
        <p><span class="text-blue">Throughout its 13 year history, the Summit organization has established itself as one of the premier arbiters of <span class="text-bold"> communication excellence.</span></span><span class="text-bold"> <a href="<?php echo site_url('reselleropportunity/websaward'); ?>">Read more.</a></span></p>
        <h2 class="text-dark-red">Red dot awards</h2>
        <p><span class="text-dark-red">This award ranks among the largest and <span class="text-bold">most renowned design competitions</span> in the world. The red dot design award attracted almost 6,000 submissions from 52 countries in 2006 alone. </span><span class="text-bold"><a href="<?php echo site_url('reselleropportunity/webrdaward'); ?>" >Read more.</a></span> </p>
      </div>
