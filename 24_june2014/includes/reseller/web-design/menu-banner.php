  ...
  <div class="top">
    ...
    <div class="multi-order">
      <p>
        ...
        <span style="padding: 0 0 0 20px;" id="CustomerDetail">Dear <span class="text-green" > Customer Name2,</span> You ordered the logo &quot;<strong>Logo Name</strong>&quot; on <span class="text-red">2012-7-18</span></span> </p>
    </div>
    <?php
    ...
    <div class="limited-offer"> <a href="<?= site_url('web-site-design/webdesigner-limited-sale/index');?>" target="_blank"><img src="<?= base_url().'images/client/limited-offer.jpg'?>" width="972" alt="Limited Offer, 50% off" title="Limited Offer, 50% off" /></a> </div>
    <div class="menu">
      <ul>
    ...
    if($this->router->method == "guarantee")
     ...
     ?>"><img src="<?=base_url()?>images/webdesign/price_banner-<?= COUNTRY; ?>.jpg"/></a></div>
      <div id="rotator"> <img src="<?=base_url()?>images/webdesign/slide_show/1.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/2.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/3.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/4.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/5.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/6.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/7.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/8.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/9.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/10.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/11.jpg" /> </div>
      <div class="clear"></div>
...
<div class="top-container">
  <div class="top">
    ...
    <div class="menu">
      <ul>
        <li id="nav-web-packages"><a href="<?= site_url('reselleropportunity/webdesignindex');?>" title="home">Web Packages</a></li>
        <li id="nav-web-portfolio"><a href="<?= site_url('reselleropportunity/webdesignportfolio'); ?>" title="packages">Web Portfolio</a></li>
        <li id="nav-web-guarantee"><a href="<?= site_url('reselleropportunity/webdesignguarantee'); ?>" title="Guarantee">Guarantee</a></li>
        <li id="nav-web-howworks"><a href="<?= site_url('reselleropportunity/webdesignhowworks'); ?>" title="Process">How It Works</a></li>
        <li id="nav-web-whyus"><a href="<?= site_url('reselleropportunity/webdesignwhyus'); ?>" title="Compare Us">Why Choose Us</a></li>
        <li id="nav-web-hosting"><a href="<?= site_url('reselleropportunity/webdesignhosting'); ?>" title="Hosting">Hosting</a></li>
        <li id="nav-web-seo"><a href="<?= site_url('reselleropportunity/webdesignseo'); ?>" title="SEO">SEO</a></li>
        <li id="nav-web-about"><a href="<?= site_url('reselleropportunity/webdesignabout'); ?>" title="Portfolio">About Us</a></li>
        <li id="nav-logodesign"><a href="<?= site_url('reselleropportunity/resellerindex');?>" title="Logodesign">Logo Design</a></li>
      </ul>
    </div>
    <div class="main-banner"> 
      <!--Start Slide Show Banner-->
    ...
    if($this->router->method == "guarantee")
     ...
     echo site_url('reselleropportunity/webdesignguarantee'); 
     ?>"><img src="<?=base_url()?>images/reseller/price_banner-<?= COUNTRY; ?>.png" width="304px" height="285px" /></a></div>
      <div id="rotator"> <img src="<?=base_url()?>images/webdesign/slide_show/1.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/2.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/3.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/4.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/5.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/6.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/7.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/8.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/9.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/10.jpg" /> <img src="<?=base_url()?>images/webdesign/slide_show/11.jpg" /> </div>
      <div class="clear"></div>
      <!--End Slide Show Banner--> 
    </div>
