...
define('PHONE_NO','0800 279 6215');
define('PHONE_CLIENT_PANEL','0800 279 6215');  #phone number for client panel new login design
define('PHONE_RESELLER_SALES','0800 756 9441');
define('PHONE_RESELLER_SUPPORT','0800 756 9646');
...
define('HOSTING_RANGE1',10);                            #19 or 10
define('HOSTING_RANGE2',30);                            #59 or 30  
/*
|--------------------------------------------------------------------------
| File Stream Modes
|--------------------------------------------------------------------------
...
// For Buy More SAVE MORE!
// For ldg.co.UK
define('PACKAGE1', 25);
define('PACKAGE11VAL', 50);
define('PACKAGE11PER', 5);
define('PACKAGE12VAL', 75);
define('PACKAGE12PER', 10);
define('PACKAGE13VAL', 100);
define('PACKAGE13PER', 15);
define('PACKAGE2', 39); 
define('PACKAGE21VAL', 60);
define('PACKAGE21PER', 5);
define('PACKAGE22VAL', 90);
define('PACKAGE22PER', 10);
define('PACKAGE23VAL', 120);
define('PACKAGE23PER', 15);
define('PACKAGE3', 49); 					    
define('PACKAGE31VAL', 75);
define('PACKAGE31PER', 5);
define('PACKAGE32VAL', 100);
define('PACKAGE32PER', 10);
define('PACKAGE33VAL', 130);
define('PACKAGE33PER', 15);
define('PACKAGE4', 35);  
define('PACKAGE41VAL', 60);
define('PACKAGE41PER', 5);
define('PACKAGE42VAL', 90);
define('PACKAGE42PER', 10);
define('PACKAGE43VAL', 120);
define('PACKAGE43PER', 15);
define('PACKAGE5', 49); 
define('PACKAGE51VAL', 75);
define('PACKAGE51PER', 5);
define('PACKAGE52VAL', 100);
define('PACKAGE52PER', 10);
define('PACKAGE53VAL', 130);
define('PACKAGE53PER', 15);
define('PACKAGE6', 59);	
define('PACKAGE61VAL', 85);
define('PACKAGE61PER', 5);
define('PACKAGE62VAL', 110);
define('PACKAGE62PER', 10);
define('PACKAGE63VAL', 140);
define('PACKAGE63PER', 15);

define('PACKAGE1_RESELLER', 22.50);
define('PACKAGE2_RESELLER', 35.10); 
define('PACKAGE3_RESELLER', 44.10); 
define('PACKAGE4_RESELLER', 31.50); 
define('PACKAGE5_RESELLER', 44.10); 
define('PACKAGE6_RESELLER', 53.10);
