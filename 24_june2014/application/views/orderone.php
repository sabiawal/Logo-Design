...
<form action="<?php echo site_url('ordertwomid');?>" method="post">
<div class="wrapper">
...
<div align="center" style="width: 140px;"> 
          ...
          <h1 class="text-blue">Our 1 month Offer Must End @
            <span class="text-red"><?php echo $today; ?>
            </span></h1>
            <br/>-->
...
<table width="100%"  border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <td>
                      ...
                      <table width="538" border="0" cellpadding="0" cellspacing="0" bgcolor="#F8FCE3">
                        ...
                        <tr>
                          ...
                          <td width="372" bgcolor="" class="text-blue" style="font-size:18px; font-weight:bold; text-align: center;"><strong>24 Hours Express Delivery. <br /> </strong><img src="<?php echo base_url()?>images/prices/order1/express-delivery-price-<?php echo COUNTRY; ?>.png" align="absbottom" />
                  ...
                  <table width="538" border="0" cellpadding="o" cellspacing="0" bgcolor="#F8FCE3">
                        ...
                        <td width="372" class="text-blue" style="font-size:18px; font-weight:bold; text-align:center;"><strong>Black + White Logo File. <br />
                    ...
                    <tr> 
                      <td class="totalpricetxt" colspan="2" align="center" bgcolor="#ffffff"> 
                      	<?php 
                            ...
                            $_SESSION['sub_total'] = $totalAmount;
                            $_SESSION['purchase_discount'] = $packageDiscount;
                            $_SESSION['sub_total_before_discount'] = $_SESSION['sub_total'] - $_SESSION['purchase_discount'];
                            $_SESSION['discount_amount']=0;
                            $_SESSION['sub_total_before_tax'] = $_SESSION['sub_total_before_discount'] + $_SESSION['discount_amount'];
                            
                            $_SESSION['tax_amount'] = $_SESSION['sub_total_before_tax']*$tax_rate;
                            $_SESSION['net_total']= $_SESSION['sub_total_before_tax']+$_SESSION['tax_amount'];
						?>
