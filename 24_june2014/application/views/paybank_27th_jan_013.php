...
//        {
		...
		if(isset($_SESSION['package_discount_amount']) && $_SESSION['package_discount_amount'] > 0)
        {
            $order_discription .=  ' Discount '.$_SESSION['package_discount_amount_per'].'% (';
            $order_discription .=  number_format(($_SESSION['package_discount_amount']*CONVERSION_MULTIPLYER),2,".","").$gbp.") ";   
        }
        ...
        if(isset($_SESSION['p_discount']) && $_SESSION['p_discount'] != '')
        {
            ...
            //if(COUNTRY == "USA")
//            {
//            $order_discription .=  $_SESSION['p_discount']."USD=";
//            }
            $order_discription .=  number_format(($_SESSION['p_discount']*CONVERSION_MULTIPLYER),2,".","").$gbp.") ";   
        }
    ...
    else
    {
		...
		if(isset($_SESSION['package_discount_amount']) && $_SESSION['package_discount_amount'] > 0)
        {
           ...
           $order_discription .=  number_format(($_SESSION['package_discount_amount']*CONVERSION_MULTIPLYER),2,".","").$gbp.") "; 
            ...
            $order_discription .=  number_format(($_SESSION['package_discount_amount']*CONVERSION_MULTIPLYER),2,".","")."USD) ";   
        }
