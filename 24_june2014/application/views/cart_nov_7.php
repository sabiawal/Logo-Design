    ...
    <div class="buy-more-top">
      <div class="buy-more-bottom">
        ...
        <div class="save-offer">
          <ul>
            <li>spend <?php echo CURRENCY.$discountVal1?> or more, Save <?php echo CURRENCY.$discountPer1?>%!</li>
            <li>spend <?php echo CURRENCY.$discountVal2?> or more, Save <?php echo CURRENCY.$discountPer2?>%!</li>
            <li>spend <?php echo CURRENCY.$discountVal3?> or more, Save <?php echo CURRENCY.$discountPer3?>%!</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <tbody>
              <tr>
                <td colspan="3" class="baskettopheader"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                      <tr>
                        <td class="shoppingheading" style="padding-top: 5px;font-size:15px;" width="95%">&nbsp;&nbsp;&nbsp;Shopping Basket - Grow Your Business!<div style="float:right"><img src="<?php echo base_url()?>images/basket-image/edit.gif" id="editBasket"/></div></td>
                      </tr>
                    </tbody>
                  </table></td>
              </tr>
                      ...
                      <tr>
                        ...
                        <table width="345" border="0" cellpadding="0" cellspacing="0" class="formtoptext">
                            ...
                            <tr id="packageDiscount" class="packageDiscount" style="display:<?php echo $display?>">
                                ...
                                <input type="hidden" id="package_discount_amount" name="package_discount_amount" value="<?php echo $packageDiscount?>"/>                                
                                </td>
                            </tr>
	...
	?>
						...
						else
						{
                            ...
                            <!-- Calculation of promotional including tax -->
                              ...
                              <tr align="right">
                                ...
                                <td width="14" rowspan="2" align="right">&nbsp;</td>
                                <td colspan="2" align="right" style="padding-right:10px;vertical-align:bottom;text-align:right;padding-top:5px;"><input name="LblCurrencySign3" id="LblCurrencySign3" style="text-align: right; width: 15px;" class="pricetxt" readonly="readonly" value="<?php echo CURRENCY; ?>" type="text"/><input name="LblYouPay" id="LblYouPay" class="pricetxt" readonly="readonly" style="width: 45px; text-align: left;" value="<?php echo number_format($netTotal + @$tax_in_total,2,".",""); ?>" type="hidden" /><span id="LblYouPayTxt" class="pricetxt"><?php echo number_format(@$netTotal + @$tax_in_total,2,".",""); ?></span></td>
                              </tr>                              
                              <!--<tr align="right">
              ...
              <tr>
                <td colspan="3" class="bgpic"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                  ...
                  <!--<p class="pad" style="text-decoration:blink;">&nbsp;</p>-->
                  </td>
              </tr>
