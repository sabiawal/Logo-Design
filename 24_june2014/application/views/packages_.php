...
<div class="col-main">
    ...
    <p><span class="text-red"><span class="text-bold">Warning:</span> Many logo firms will tempt you with low fees such as &ldquo;<?=CURRENCY . Silver_Logo_Package_Price; ?>&rdquo; or &ldquo;<?=CURRENCY . Super_Silver_Plus_Logo_Package_Price; ?>&rdquo; but they will only provide 1 or 2 samples for their advertised fee.</span> Do not fall for this! Several logo variations are essential in getting the logo you have in mind!</p>
    ...
    <p class="factors">There are 7 core factors which will give you 100% confidence to place an order with us today...</p>
        ...
        <li><span class="text-bold"><?=GUARANTEE_DAY; ?>-Day, 100% Money Back Guarantee</span> on all our packages. We provide you with the best guarantee in the industry. Most firms only state 100% money back guarantee as a marketing gimmick. Their policies often apply solely to expensive packages and have lots of small print, subjecting you to incurring administration charges often at <?=CURRENCY ." ". Super_Silver_Plus_Logo_Package_Price; ?>.</li>
...
<div class="button-silver" align="center"><span class="text-orange"><strong>Only <?=CURRENCY ." ". Silver_Logo_Package_Price; ?></strong></span>
<br />
<input type="image" onclick="submitPackage('<?=Silver_Logo_Package;?>','<?=Silver_Logo_Package_Price;?>');" src="<?=base_url(); ?>images/silver-order.gif" name="silver" id="silver" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('silver','','<?=base_url(); ?>images/silver-order-hover.gif',1)" />
...
<div class="button-extra">
    ...
    <div align="center"><span class="text-orange"><strong>Only <?=CURRENCY ." ". Super_Silver_Logo_Package_Price; ?> </strong> </span>
    <br />
    <input type="image" onclick="submitPackage('<?=Super_Silver_Logo_Package;?>','<?=Super_Silver_Logo_Package_Price;?>');" src="<?=base_url(); ?>images/silver-order.gif" name="super-silver" id="super-silver" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('super-silver','','<?=base_url(); ?>images/silver-order-hover.gif',1)" />
    ...
    <div align="center"><span class="text-orange"><strong>Total only: <?=CURRENCY ." ". Super_Silver_Plus_Logo_Package_Price; ?></strong></span>
    <br />
    <input type="image" onclick="submitPackage('<?=Super_Silver_Plus_Logo_Package;?>','<?=Super_Silver_Plus_Logo_Package_Price;?>');" src="<?=base_url(); ?>images/silver-order.gif" name="super-silver-plus" id="super-silver-plus" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('super-silver-plus','','<?=base_url(); ?>images/silver-order-hover.gif',1)" />
...
<p><strong><span class="text-blue">See our current <span class="text-orange">free special offer</span> banner at the top of the page -</span><br />
<span class="text-blink text-black"><span class="border-bottom">Free offer Must End Midnight, <span class="text-green"><?=$today;?>.</span></span> </span></strong></p>
<div class="button-silver" align="center"><span class="text-orange"><strong>Only <?=CURRENCY ." " . Elite_Logo_Package_Price; ?></strong></span>
<br />
<input type="image" onclick="submitPackage('<?=Elite_Logo_Package;?>','<?=Elite_Logo_Package_Price;?>');" src="<?=base_url(); ?>images/elite-order.gif" name="elite" id="elite" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('elite','','<?=base_url(); ?>images/elite-order-hover.gif',1)" />
...
<div align="center"><span class="text-orange"><strong>Only <?= CURRENCY . " " . Super_Elite_Logo_Package_Price; ?></strong></span>
<br />
<input type="image" onclick="submitPackage('<?= Super_Elite_Logo_Package;?>','<?= Super_Elite_Logo_Package_Price;?>');" src="<?= base_url(); ?>images/elite-order.gif" name="super-elite" id="super-elite" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('super-elite','','<?= base_url(); ?>images/elite-order-hover.gif',1)" />
...
<div align="center"><span class="text-orange"><strong>Only <?= CURRENCY ." " . Super_Elite_Plus_Logo_Package_Price; ?></strong></span>
<br />
<input type="image" onclick="submitPackage('<?= Super_Elite_Plus_Logo_Package;?>','<?= Super_Elite_Plus_Logo_Package_Price;?>');" src="<?= base_url(); ?>images/elite-order.gif" name="super-elite-plus" id="super-elite-plus" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('super-elite-plus','','<?= base_url(); ?>images/elite-order-hover.gif',1)" />
...
<img src="<?= base_url(); ?>images/purple-banner-<?= COUNTRY; ?>.jpg" />
<span class="text-red text-16"><strong><?= $today;?></strong></span></div></div>
</div>
</div>
<div class="side-bar">
<?php 
