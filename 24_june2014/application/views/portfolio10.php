    ...
    <div class="main col2-right-layout">
      <div class="col-main"> <a href="#" id="testimonial" name="portfolio"></a>
        <div class="portfolio">
          ...
          <div class="portfolio-botton" align="center"><a href="javascript:history.go(-1);"><img src="<?php echo base_url();?>images/prev.gif" /></a><a href="<?php echo site_url('portfolio11'); ?>#testimonial"><img src="<?php echo base_url();?>images/next.gif" /></a></div>
        </div>
