...
<div class="wrapper">
  ...
  <div class="main-container">
    ...
    ?>
          <h1 style="font-size:34px; font-family:Arial, Helvetica, sans-serif; color:#000; margin-top:20px; line-height:46px;"> Logo Design Guarantee&rsquo;s <span style="color:red;">innovation</span> within<br/>
          ...
          <div class="charity-works">
            ...
            <h1 style="font-size:35px; font-family:Arial, Helvetica, sans-serif; color:#000; margin-top:20px; line-height:45px;"> We give you back <span style="color:red;">all the best that you<br/>
              deserve,</span> for the kindness you&rsquo;ve done!</h1>
            ...
            <p style="color:#000;">Charitable institutions seldom receive support from the outside, as people<br/>
              wrongly tend to think of some institutions as <i>phony,</i> unless you&rsquo;ve become<br/>
            ...
            <p style="color:#000;"><i>In short, trust is still required to run your charity, profit or non-profit.</i><br/>
              We&rsquo;d like to extend a hand... No, even a whole arm, to help charitable<br/>
            ...
            <p style="color:#000;">We can help you <span style="color:red;">express that love,</span> even with the logos that you&rsquo;d have us<br/>
            ...
            <p style="color:#000;">And yes, to help you even further, as a way of humbling ourselves just<br/>
              like you do, we&rsquo;re offering your charity a 10% discount if you give us <br/>
              a <a href="<?php echo base_url();?>./contact.php" style="color:#06C;"><u>call</u></a>, on any and all design packages you order... <br/>
            </p>
            ...
            <p style="color:#000;">For all of your design needs, we at Logo Design Guarantee would be<br/>
              ...
              with us! </p>
            <p style="color:#000;">See our <a href="<?php echo base_url();?>./packages.php" style="color:#06C;"><u>packages</u></a> now, and then call us to get your 10% OFF Today!</p>
          </div>
