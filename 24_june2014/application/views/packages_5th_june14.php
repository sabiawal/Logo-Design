            ...
            <div class="silver" align="center">
              ...
              <div class="silver-text" align="left"> <img src="<?=base_url(); ?>images/sliver-package.jpg" alt="Silver Package" title="Silver Package" />
                ...
                <!--<p><strong><span class="text-blue">See our current <span class="text-orange">free special offer</span> banner at the top of the page -</span><br />
                  <span class="text-blink text-black"><span class="border-bottom">Free offer Must End <span class="text-green">
                  <?=$today;?>
                  .</span></span> </span></strong></p>-->
                <div align="center">
                	<!--<div class="text-price">
                    <label class="newpricena">Price:</label>
                    <label><?=CURRENCY . $silver_price_regular; ?></label>
                  </div>-->
                  <div class="text-sale">
                  ...
                  <!--<div class="text-save">
                    ...
                    <label><?=CURRENCY . ($silver_price_regular-$silver_price); ?>)</label>
                  </div>-->
