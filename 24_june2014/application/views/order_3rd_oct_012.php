    ...
    <div class="main col1-layout">
      <div class="col-main">
        <div class="order-page">
          ...
          <div class="order-form-container">
            <div class="order-form">
              ...
              <form class="cmxform" id="commentForm" method="post" action="<?php echo site_url('logodesign/orderonemid');?>" enctype="multipart/form-data">
        ...
        <span style="margin:0 0 0 75px;"> Use one in-house design team for all your design needs!</span></strong></h5></td>
                  ...
                  ////////////////// -->
                      <tr class="tablebg">
                        <td colspan="2" align="center"><a href="javascript: window.location='<?php echo base_url()?>packages.php'"><img src="<?php echo base_url()?>images/back.jpg" width="100" height="49" border="0" align="middle" style="display:inline;" /></a>
                         <input name="submit" type="image" src="<?php echo base_url()?>images/pay_continue.jpg" alt="continue" align="middle" onclick="checkerror()"/></td>
                      </tr>
                    </table>
                    </div>
                </form>
