...
<div class="wrapper">
    ...
    ***********************************************/
    ...
    &nbsp; Package (Only <?= CURRENCY.Budget_Website_Price; ?> )</span></p></td>
    <td width="146" ><p><span>Gold Web Design &nbsp;<br />
    &nbsp;Package (Only <?= CURRENCY.Gold_Website_Price; ?> )</span></p></td>
    <td width="146" ><p><span>Elite Web Design <br /> &nbsp;
    &nbsp;Package (Only <?= CURRENCY.Elite_Website_Price; ?> )</span></p> </td>
    </tr>
    </table>
    ...
    <td width="150"><p><!--<span style="background: #ff0; margin: 0 0 15px; padding: 3px;">You Save <?= CURRENCY.(WEB_BUDGECT_OTHERS_PRICE-Budget_Website_Price)?>! </span><br />--><?= "<span class=\"text-18\">".CURRENCY.Budget_Website_Price."</span>"; ?></p></td>
    <td width="150" class="bg-green" style="border-bottom:4px solid #8AC134 ;"><p><!--<span style="background: #ff0; margin: 0 0 15px; padding: 3px;">You Save <?= CURRENCY.(WEB_GOLD_OTHERS_PRICE-Gold_Website_Price)?>! </span><br />--><?= "<span class=\"text-18\">".CURRENCY.Gold_Website_Price."</span>"; ?></p></td>
    <td width="150"><p><!--<span style="background: #ff0; margin: 0 0 15px; padding: 3px;">You Save <?= CURRENCY.(WEB_ELITE_OTHERS_PRICE-Elite_Website_Price)?>! </span><br />--><?= "<span class=\"text-18\">".CURRENCY.Elite_Website_Price."</span>"; ?></p></td>
    </tr>
    <tr>
    ...
    <tr class="bg-gray">
    <th width="240"></th>
    <td width="146"><input type="button" class="button" onclick="submitPackage('<?= Budget_Website;?>','<?= Budget_Website_Price;?>',1);" value=""/></td>
    <td width="146"><input type="button" class="button" src="<?php echo base_url()."images/webdesign/order_now.png"; ?>" onclick="submitPackage('<?= Gold_Website;?>','<?= Gold_Website_Price;?>',6);" value=""/></td>
    <td width="146"><input type="button" class="button" src="<?php echo base_url()."images/webdesign/order_now.png"; ?>" onclick="submitPackage('<?= Elite_Website;?>','<?= Elite_Website_Price;?>',12);" value=""/></td>
    </tr></table>
    </form>
    </td>
    </tr>
