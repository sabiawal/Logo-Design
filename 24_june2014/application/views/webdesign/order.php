...
if(isset($_SESSION['temp_web_price'])){
	...
	unset($_SESSION['temp_web_price']);
	unset($_SESSION['temp_logo_price']);
}
?>
<div class="wrapper">
  ...
  <div class="main-container">
    ...
    <form action='<?php echo site_url('web-site-design/webdesigner-limited-sale/cartmid');?>' method='post' id="frmWebOrder" name='frmWebOrder' enctype='multipart/form-data'>
