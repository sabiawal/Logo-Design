...
<div class="wrapper">
  ...
  <div class="main-container">
    <div class="main col2-right-layout">
      <div class="col-main">
        <div class="footer-link contact" id="successShow">
          <h1>Contact us? </h1>
          <h1><img src="<?php echo base_url(); ?>images/webdesign/contact-banner.jpg" title="kontakt" alt="kontakt"/></h1>
        ...
        value="Algeria">Algeria</option>
                    ...
                    <option 
        value="Antigua &amp; Barb.">Antigua &amp; Barb.</option>
                    <option 
        ...
        value="Brazil">Brazil</option>
                    <option value="British Virgin Is.">British 
                    Virgin Is.</option>
        ...
        value="Dominica">Dominica</option>
                    <option 
        value="Dominican Rep.">Dominican Rep.</option>
                    <option 
        ...
        value="Oman">Oman</option>
                    ...
                    <option 
        value="Papua N. Guinea">Papua N. Guinea</option>
                    <option 
        ...
        value="Romania">Romania</option>
                    <option value="Russian Fed.">Russian 
                    Fed.</option>
                    <option value="Saudi Arabia">Saudi Arabia</option>
                    <option 
        value="Serbia">Serbia and Montenegro</option>
                    <option 
        ...
        value="Switzerland">Switzerland</option>
                    <option 
        value="Syrian Arab Rep.">Syrian Arab Rep.</option>
                    <option 
        ...
        value="United Kingdom">United Kingdom</option>
                    <option 
        value="United States" selected="selected">United States</option>
                    <option 
        value="Untd. Arab Emir.">Untd. Arab Emir.</option>
                    <option 
        value="Uruguay">Uruguay</option>
                    <option value="US Virgin Islands">US 
        ...
        value="Zimbabwe">Zimbabwe</option>
               ...
               <div class="contact-list">
                  <input class="submit" name="submit" type="submit" value="Send Contact Data"/>
                </div>
            </form>
          </div>
  ...
  <tr>
    <td>Order & Billing: </td>
    <td><strong><a href="javascript:void(0)"><?=ORDER_MAIL ?></a></strong></td>
  </tr>
  <tr>
