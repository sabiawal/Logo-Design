...
<?php include_once("includes/client/top_container.php"); ?> 
  ...
  <div class="main-container">
    ...
    ***********************************************/
    ...
    <td width="146"><input type="button" class="button" onclick="submitPackage('<?= Gold_Website;?>','<?= Gold_Website_Price;?>',6);" value=""/></td>
    <td width="146"><input type="button" class="button" onclick="submitPackage('<?= Elite_Website;?>','<?= Elite_Website_Price;?>',12);" value=""/></td>
    </tr></table>
    </form>
    </td>
    </tr>
