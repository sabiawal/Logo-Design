...
<link rel="stylesheet" href="<?php echo base_url()?>css/dialogbox/jquery-ui.css">
<script src="<?php echo base_url()?>css/dialogbox/jquery-1.9.0.js"></script>
<script src="<?php echo base_url()?>css/dialogbox/jquery-ui.js"></script>
...
$(function(){
	...
	buttons: {
			...
			"OK": function() {
				...
				$('.success_img').remove();
				$('#commentForm').submit();
				$('#loading').html("<img src='<?php echo base_url()?>css/dialogbox/loader.gif' class='loads'/><span class='Loader'>Processing...</span>").fadeIn('fast');	
	...
	$( ".newbuttoncontinue" ).click(function() {
		...
		$('.ui-dialog').append('<img class="success_img" src="<?php echo base_url()?>images/success_icon.png">');
		}
	});
...
<?php include "includes/client/top_container.php";
...
<a href="https://www.scanalert.com/RatingVerify?ref=www.logodesignguarantee.co.uk" target="_blank"><img src="<?php echo base_url()?>images/thumb_hackersafe.jpg" width="159" height="63" /></a><span class="style3  style1">TESTED</span><font color='red' size='1' align='right'>13-April</font><br />
</div>
</div>
<div class="clear"></div>
</div>
...
<img src="<?php echo base_url()?>images/cards/invalid.gif" alt="card_logo" name="cardimage" width="36"  height="24" hspace="10" vspace="0" align="middle" />
</td>
</tr>
...
<input type="button" class="newbuttoncontinue" name="submit_upgrade" value="Continue" align="middle" />
    ...
    <div align="center"><a href="<?php echo base_url()?>guarantee.php"><img src="<?php echo base_url()?>images/guarantee.png" alt="Money Back Guarantee" title="Money Back Guarantee" /></a></div>
        <ul>
        <li>100 % original, custom-made</li>
        <li>No clipart </li>
                </ul>
        <div align="center"><a href="<?php echo base_url()?>packages.php"><img src="<?php echo base_url()?>images/start-logo.jpg" alt="Start My Logo" title="Start My Logo" /></a></div>
        </div>
...
<div align="center"><a href="<?php echo base_url()?>charity.php"><img src="<?php echo base_url()?>images/rtdthumb.jpg" alt="RTD" title="RTD" /></a></div><p>&nbsp;</p>
