...
{
if(!empty($qrys['sample_name']))
{
?>
<!-----live site = http://50dollarlogo.com/   localhost = http://localhost/50dl/------>
<li id="logo_select<?php echo $qrys['designer_post_order_id']?>"><img src="http://50dollarlogo.com/admin_panel/sample/thumb_<?php echo rawurlencode($qrys['sample_name']);?>" title="<?php echo rawurlencode($qrys['sample_name']);?>" height="140px" width="140px" class="select-this" id="logo<?php echo $qrys['designer_post_order_id']?>" />
<form id="cheked_bx" name="check_this1" class="check_this1" method="post">
<input class="checked_box" name="checked_all[]" value="<?php echo rawurlencode($qrys['sample_name'])?>" id="select_all<?php echo $qrys['designer_post_order_id']?>" type="checkbox">
</form>
</li>
<?php }else{?>
<?php
