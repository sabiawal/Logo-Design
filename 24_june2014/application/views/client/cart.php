...
<div class="buy-more-container">
	...
	?>
              ...
              <tr>
                <td colspan="3" class="basketbg2" align="center"><table border="0" cellpadding="0" cellspacing="0" width="330">
                    <tbody>
                      ...
                      <tr>
                        <td class="basketbg3" colspan="2" align="center"><img src="<?php echo base_url()?>images/basket-image/textboxbtm.gif" width="343" height="8" /></td>
                      </tr>
                    </tbody>
                  </table></td>
              </tr>              
      ...
      <div class="info-text-bottom">
        <div align="center">
          <form action='<?php if(COUNTRY == "UK") {echo site_url('client_panel/paybankmid');} else{echo site_url('client_panel/jetpaymid'); }?>' method='post' name='frmOrder' enctype='multipart/form-data'>
            <a href="javascript: window.location='<?php echo base_url()?>client_panel/printing'"><img src="<?php echo base_url(); ?>images/sback.jpg" width="80" height="35" align="middle" /></a>
            ...
            <input type="hidden" name="net_total" id="net_total" value="<?= $TotalAmounts; ?> " />
