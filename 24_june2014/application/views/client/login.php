...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo base_url()?>css_client/login.css" rel="stylesheet" type="text/css" />
        <!--[if lt IE 8]>
...
<div class="new-top">
    <div class="new-top-inner">
        <div class="logo-left">
            <img src="<?php echo base_url();?>images/client/logo.jpg" alt="Logo Design Guarantee" height="91" width="337" />
        </div>
