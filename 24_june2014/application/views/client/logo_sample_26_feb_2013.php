...
//if(!empty($samples) or isset($_GET['fortest'])) {	?>
        ...
        <div class="feedback-containner" style="margin:20px 0;display:none;">
        ...
        <form method="post" name="form1" action="<?php echo base_url()?>client_panel/questions" class="sample" id="send-question"  onsubmit="return checkForm1()">
            ...
            <div>For any <u><strong>question about other design services</strong></u>, provide them on the box <br />below to get latest information about our promos.<br><textarea name="msgcustomer1" rows="8" cols="60" id="msgcustomer1"></textarea></div>            
