...
margin:0 auto;">
   ...
   <td valign="top" style="background: #FFD700 !important;
    ...
    "><span>ELITE LOGO WITH COMPLETE STATIONARY</span></td>
  </tr>
  <!--<tr>
    ...
    line-height: 1.5;
    padding: 0 23px; float:left; background: none repeat scroll 0 0 #F7EFAF;width:405px;">12 custom made logos</h3>
    </td>
    <td>
    <span style="background-color: #F6E017;
    ...
    line-height: 1.5;
    padding: 0 23px;
    "><?php echo CURRENCY.$_SESSION['current_package_amount']?></span>
    </td>
  ...
  <li style="  font: bold 17px/24px Tahoma,Geneva,sans-serif;
    margin: 0 0 20px; color:#666666;"><span style="color:#BCA000">3 letterhead designs</li>
 <li style="  font: bold 17px/24px Tahoma,Geneva,sans-serif;
    margin: 0 0 20px; color:#666666;"><span style="color:#BCA000">3 complement slip designs</li>
  <li style="  font: bold 17px/24px Tahoma,Geneva,sans-serif;
