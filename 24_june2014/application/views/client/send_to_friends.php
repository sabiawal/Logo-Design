...
<script src="<?php echo base_url();?>js/all_jquery.js" type="text/javascript"></script>
...
?>
<li id="logo_select<?php echo $qrys->designer_post_order_id?>" value="<?php echo rawurlencode($qry->sample_name)?>"><img src="http://50dollarlogo.com/admin_panel/sample/thumb_<?php echo rawurlencode($qry->sample_name);?>" title="<?php echo rawurlencode($qry->sample_name);?>" height="140px" width="140px" class="select-this" id="logo<?php echo $qry->designer_post_order_id?>" />
