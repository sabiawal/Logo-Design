...
?>
        ...
        <input type="hidden" name="returnurl" value="https://<?php echo SITE_NAME; ?>/client_panel/thankyouPage.php?ip=<?php echo $ip; ?>&mainlogowebid=<?php echo @$_SESSION['insert']; ?>&price=<?=@$total_real_price;?>" />
