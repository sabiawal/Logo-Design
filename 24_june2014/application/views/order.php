                      ...
                      <tr class="tablebg">
                        ...
                        <td valign="top" class="text-bold"> Select Package:&nbsp;&nbsp;&nbsp;
                          <select name="web" class="text-bold" >
                            ...
                            <option <?php if(isset($_SESSION['web']) && $_SESSION['web'] == Budget_Website_Price ) echo "selected='selected'"; ?> value="<?php echo Budget_Website_Price; ?>"><?php echo Budget_Website." - Now ". CURRENCY . Budget_Website_Price; ?></option>
                            <option <?php if(isset($_SESSION['web']) && $_SESSION['web'] == Gold_Website_Price ) echo "selected='selected'"; ?> value="<?php echo Gold_Website_Price; ?>"><?php echo Gold_Website." - Now ". CURRENCY . Gold_Website_Price; ?></option>
                            <option <?php if(isset($_SESSION['web']) && $_SESSION['web'] == Elite_Website_Price ) echo "selected='selected'"; ?> value="<?php echo Elite_Website_Price; ?>"><?php echo Elite_Website." - Now ". CURRENCY . Elite_Website_Price; ?></option>
                      ...
                      <tr class="tablebg">
                        ...
                        <td valign="top" class="text-bold"> Select Package:&nbsp;&nbsp;&nbsp;
                          <select name="brouchure" class="text-bold" >
                            ...
                            <option value="">See Package Options</option>                            
                            <option <?php if(isset($_SESSION['brouchure']) && $_SESSION['brouchure'] == Brochure_Tri_Fold_Price ) echo "selected='selected'"; ?> value="<?php echo Brochure_Tri_Fold_Price; ?>"><?php echo Brochure_Tri_Fold." - Now ". CURRENCY . Brochure_Tri_Fold_Price;?></option>
                            <option <?php if(isset($_SESSION['brouchure']) && $_SESSION['brouchure'] == Brochure_4_Page_Price ) echo "selected='selected'"; ?> value="<?php echo Brochure_4_Page_Price; ?>"><?php echo Brochure_4_Page." - Now ". CURRENCY . Brochure_4_Page_Price; ?></option>
                            <option <?php if(isset($_SESSION['brouchure']) && $_SESSION['brouchure'] == Brochure_8_Page_Price ) echo "selected='selected'"; ?> value="<?php echo Brochure_8_Page_Price; ?>"><?php echo Brochure_8_Page." - Now ". CURRENCY . Brochure_8_Page_Price; ?></option>
