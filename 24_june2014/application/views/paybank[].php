...
$headers .= 'From: Logo Admin<fiftydollarlogo@gmail.com>' . "\r\n";

$headers1  = 'MIME-Version: 1.0' . "\r\n";
$headers1 .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
//$headers1 .= 'From: LogoDesignGuarantee<enquiries@logodesignguarantee.co.uk>' . "\r\n";	
$headers1 .= 'From: Logo Admin<fiftydollarlogo@gmail.com>' . "\r\n";
...
$mailbody1="<table width=\"100%\" border=\"0\">
  <tr>
	...
	<p>Thank you for your order with Logo Design Guarantee.</p>
		  ...
		  <p align=\"justify\"><a href=\"http://logodesignguarantee.co.uk/payment.html?package=$package&amp;price=$price&amp;web=$web&amp;brouchure=$brouchure&amp;option=$option&amp;web_gold=$web_gold&amp;web_elite=$web_elite\">http://logodesignguarantee.co.uk/payment.html</a></p>
...
mail('fiftydollarlogo@gmail.com',$subject,$mailbody,$headers);
mail('prajapatijagat2009@gmail.com',$subject,$mailbody,$headers);
...
<?php if(@$_SESSION['option']!=="" && @$_SESSION['web_elite']=="" && @$_SESSION['web_gold']=="" && $total_g2s_price <='700')
	{
...
<input type="hidden" name="returnurl" value="http://www.logodesignguarantee.co.uk/logodesign/thankyou.html?ip=<?php echo $ip; ?>&mainlogowebid=<?php echo @$_SESSION['insert']; ?>">
...
{
 if(@$_SESSION['option']=="" && @$_SESSION['web_elite']=="" && @$_SESSION['web_gold']=="" && $total_g2s_price<='700')
	{
	?>	
<!--<form name="checkoutform" action="https://www.nochex.com/nochex.dll/checkout" method="post">-->
<form name="checkoutform" action="https://secure.nochex.com" method="post">
