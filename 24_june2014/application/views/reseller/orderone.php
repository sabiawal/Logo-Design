...
<form action="<?php echo site_url('reseller/ordertwomid');?>" method="post">
<div class="wrapper">
...
<input type="button" class="newbuttonback" value="Back" onclick="javascript:window.location='<?= site_url('reseller/order') ?>'" />
...
<!-- Ends Buy More -->
            <table summary="ShoppingBasket" border="0" cellpadding="0" cellspacing="0" width="365">
              <tbody>
              <tr> 
                <td colspan="3" class="baskettopheader" style="height:35px;">
                      ...
                      <td class="totalpricetxt" colspan="2" align="center" bgcolor="#ffffff"> 
                        ...
                        <table width="345" border="0" cellpadding="0" cellspacing="0" class="formtoptext">
                          <tbody>
                            ...
                            <tr align="right">
                              <td width="175" rowspan="2"align="left" style="width: 165px; padding-left: 10px;padding-top:5px;"> 
                                <span id="LblYouPayText" style="font-weight: bold;" class="totalpricetxt">Total </span></td>
                              <td width="14" rowspan="2" align="right">&nbsp;</td>
                              <td colspan="2" align="right" style="padding-right:10px;color:#f00;padding-top:5px;"><input name="LblCurrencySign3" id="LblCurrencySign3" style="text-align: right; width: 15px;" class="pricetxt" readonly="readonly" value="<?php echo CURRENCY; ?>" type="hidden"/><input name="LblYouPay" id="LblYouPay" class="pricetxt" readonly="readonly" style="width: 45px; text-align: left;" value="<?php echo number_format($netTotal,2);?>" type="hidden" /><?php echo CURRENCY?><span id="LblYouPayAmount"><?php echo number_format($netTotal,2,".","");?></span></td>
                            </tr>
							<!--<tr align="right">
              ...
              <tr> 
                <td colspan="3" class="bgpic"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                  <tr>
                    ...
                    <td width="38%" id="bgimg" align="left" style="padding-top: 7px; padding-left: 10px;" valign="top"><img src="<?php echo base_url()?>images/basket-image/photolia5.gif" /></td>
                  </tr>
