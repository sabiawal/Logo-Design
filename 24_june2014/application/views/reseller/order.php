...
document.getElementById('captcha').src = '<?php echo base_url()?>includes/reseller/security_image.php?x='+ c_miliseconds;
...
$(document).ready(function() {
	$("#commentForm").validate(
    {
        rules:
        {
            ...
            verificationcode: {
        		required: true,
        	    remote: "<?php echo base_url()?>includes/reseller/process-capcha.php"
    		},
...
service has been already ordered). </p><br/>-->
          ...
          <div class="order-form-container">
            <div class="order-form">
              ...
              <form class="cmxform" id="commentForm" method="post" action="<?php echo site_url('reseller/orderonemid');?>" enctype="multipart/form-data">
                  ...
                  ////////////////// -->
                      <tr class="tablebg">
                        ...
                        <!--<a href="javascript: window.location='<?php echo base_url()?>packages.php'"><img src="<?php echo base_url()?>images/back.jpg" width="100" height="49" border="0" align="middle" style="display:inline;" /></a>
                         ...
                         <input type="button" class="newbuttonback" value="Back" onclick="javascript:window.location='<?= site_url('reseller/packages') ?>'" />
