						...
						else
						{
							$tax_in_total = 0;	
                              ...
                              <tr align="right">
                                ...
                                <td width="14" rowspan="2" align="right">&nbsp;</td>
                                <td colspan="2" align="right" style="padding-right:10px;vertical-align:bottom;text-align:right;padding-top:5px;"><input name="LblCurrencySign3" id="LblCurrencySign3" style="text-align: right; width: 15px; margin-right: -5px;" class="pricetxt" readonly="readonly" value="<?php echo CURRENCY; ?>" type="text"/>
                                  <span id="LblYouPayTxt" class="pricetxt"><?php echo number_format(@$netTotal + @$tax_in_total,2,".",""); ?></span><input name="LblYouPay" id="LblYouPay" class="pricetxt" readonly="readonly" style="width: 45px; text-align: left;" value="<?php echo number_format($netTotal + @$tax_in_total,2,".",""); ?>" type="hidden" /></td>
                              </tr>
                              <!--<tr align="right">
      ...
      <div class="info-text-bottom">
        <div align="center">
          <form action='<?php if(COUNTRY == "UK") {echo site_url('reseller/paybankmid');} else{echo site_url('reseller/jetpaymid'); }?>' method='post' name='frmOrder' enctype='multipart/form-data'>
            <a href="javascript: window.location='<?php echo site_url('reseller/ordertwo'); ?>'"><img src="<?php echo base_url(); ?>images/sback.jpg" width="80" height="35" align="middle" /></a>
