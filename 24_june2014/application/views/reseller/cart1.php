    ...
    <div class="main col2-right-layout">
      <div class="col-main">
        <div class="cart"> 
           ...
           <h1> Before you proceed to the payment page.....</h1><br />
...
that will greatly support your business:</strong></h2>
            ...
            <ul>
                    ...
                    <li>We provide certified in-house <?php echo COUNTRY; ?> designers. All our designers are degreed. We hire &ldquo;Quality&rdquo; to produce &ldquo;Quality&rdquo;. Nearly all competitors outsource to India.</li>
...
web design company!</h2><br />
			<h2>If you later find a more affordable offer,<br />
			we will refund the difference. </h2><br />
			<h2>IF THE ABOVE IS NOT ENOUGH:</h2><br />
            ...
            <p>We offer a <strong><?php echo GUARANTEE_DAY; ?>-Day, 100% Money Back<BR /> Guarantee </strong>on all your order.</p>
            <p>If you don&rsquo;t think your web site is worth at <BR />least <strong><?php echo CURRENCY.WEB_QUALITY_PRICE; ?></strong> to your business we will refund you in full.</p>
...
<p>We have tried to provide peace of mind via our <?php echo GUARANTEE_DAY; ?>-Day, 100% Money Back Guarantee Policy.</p>
...
<p>That simple.</p>
      ...
      <div class="clear"></div>
      <div class="cart-bottom-list" align="center">
            
      <img src="<?php echo base_url()."images/webdesign/sback.jpg"; ?>" title="back" alt="back" onclick="javascript:history.go(-1);" name="back" align="absmiddle" style="display:inline;" class="button" />
      <img src="<?php echo base_url()."images/webdesign/continue.jpg"; ?>" title="continue" alt="continue" name="continue" align="absmiddle" onclick="document.location='<?php echo site_url("webdesign/paybank");?>'" class="button"  />
      
      
      
      
      
      <p>*This order qualifies for our <?php echo GUARANTEE_DAY; ?>-Day, 100% Money Back Guarantee Policy.<br />
		Simple No fees. No questions asked. </p>
     <?php if(COUNTRY == 'UK'){ } else {?> 
