...
<div class="wrapper">
  ...
  <div class="main-container">
    <div class="main col1-layout">
      <div class="col-main">
        <div class="forget-pw">
            <h1>Enter Your Email Id to Reset Your Password</h1><br />
            <form method="post" action="#">
                <p><label>Email</label><input type="text" name="email_id" /></p>
                <p class="button"><input type="submit" name="submit" value="Send" /></p>
            </form>
        </div>
      </div>
    </div>
