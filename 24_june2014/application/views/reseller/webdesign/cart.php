...
that will greatly support your business:</strong></h2>
            <ul>
                    ...
                    <li>We provide certified in-house <?=COUNTRY; ?> designers. All our designers are degreed. We hire &ldquo;Quality&rdquo; to produce &ldquo;Quality&rdquo;. Nearly all competitors outsource to India.</li>
...
<p>We have tried to provide peace of mind via our <?=GUARANTEE_DAY; ?>-Day, 100% Money Back Guarantee Policy.</p>
...
<p>That simple.</p>
      ...
      <img src="<?=base_url()."images/webdesign/sback.jpg"; ?>" title="back" alt="back" onclick="javascript:history.go(-1);" name="back" align="absmiddle" style="display:inline;" class="button" />
      <img src="<?=base_url()."images/webdesign/continue.jpg"; ?>" title="continue" alt="continue" name="continue" align="absmiddle" onclick="document.location='<?php if(COUNTRY == "UK") {echo site_url('reseller_web/paybank');} else{echo site_url('reseller_web/jetpay'); }?>'" class="button"  />
      <p>*This order qualifies for our <strong><?=GUARANTEE_DAY; ?>-Day, 100% Money Back Guarantee Policy.</strong><br />
