<?php
    ...
    $usd = "USD";
    $_SESSION['amount'] = $web_price + $logo_price; 
    $order_discription = $web_package.' '.$web_price.$usd.' ';
    if($logo_price > 0)
    {        
        $order_discription .= $logo_package.' '.$logo_price.$usd;
    }
?>
...
<div class="wrapper">
  ...
  <div class="main-container">
    <div class="main col1-layout">
      ...
      <h1>Almost Done!...</h1>
        <form method="post" onSubmit="submitonce(this)" name="form1" action="<?= site_url('webdesign/process_transactionmid'); ?>">
        ...
        <a href="javascript:popUp('<?= site_url('cvv')?>')" style="float: right;">The CVV Number is the last 3 digits found on the back of your debit or credit card. </a></span>
                ...
                <div class="label-wrap">
                <input type="button"  onclick="document.location='<?= site_url('reseller_web/cart'); ?>'" value="Back" class="button-back" />
