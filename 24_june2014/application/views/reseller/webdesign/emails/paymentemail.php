...
echo "<table width=\"730\" border=\"0\" align=\"center\" bgcolor=\"#FFFFFF\">
  ...
  <tr align=\"left\" bgcolor=\"white\">
	...
	<br/>
          ...
          <p align=\"justify\">
		  <a href=\"".base_url()."web-site-design/webdesigner-limited-sale/payment.php?web_package=".@$_SESSION['web_package']."&amp;web_price=".@$_SESSION['web_price']."&amp;logo_package=".@$_SESSION['logo_package']."&amp;logo_price=".@$_SESSION['logo_price']."&amp;web_id=".@$_SESSION['insert_id']."&amp;logo_id=".@$_SESSION['insert_id2']."&amp;ip=".$ip."&authentication_code =".$_SESSION['authentication_code']."\">".base_url()."web-site-design/webdesigner-limited-sale/payment.php</a>
		  </p>
