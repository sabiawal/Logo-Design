			...
			$( "#dialog-confirm" ).dialog({
				...
				buttons: {
					...
					"Yes": function() {
                        ...
                        var add = '<tr id="'+values[1]+'_del"><td valign="top" align="left" class="basketdesc">'+values[4]+'</td><td valign="top" align="right" class="basketdesc"><img id="'+values[0]+'___'+values[1]+'___'+values[2]+'___'+values[3]+'___'+values[4]+'" class="basketEdit_reselect" src="<?php echo base_url();?>images/basket-image/select.gif" alt="'+values[4]+'" title="'+values[4]+'"></td><td valign="top" align="right" class="basketdesc">'+currency+values[2]+'<input type="hidden" name="deletedServices['+values[1]+']" value="'+values[0]+'___'+values[1]+'___'+values[2]+'___'+values[3]+'___'+values[4]+'" ></td></tr>';						
						$('#reselect').append(add);						
						$('#forReselect').show();
						calculatePrice();
						//End reselect
			...
			$( "#dialog-confirm" ).dialog({
				...
				buttons: {
					...
					"Yes": function() {
						...
						var add = '<tr id="'+values[1]+'_del"><td valign="top" align="left" class="basketdesc">'+values[4]+'</td><td valign="top" align="right" class="basketdesc"><img id="'+values[0]+'___'+values[1]+'___'+values[2]+'___'+values[3]+'___'+values[3]+'" class="basketEdit_reselect" src="<?php echo base_url();?>images/basket-image/select.gif" alt="'+values[4]+'" title="'+values[4]+'"></td><td valign="top" align="right" class="basketdesc">'+currency+totalprice+'<input type="hidden" name="deletedServices['+values[1]+']" value="'+values[0]+'___'+values[1]+'___'+values[2]+'___'+values[3]+'___'+values[4]+'" ></td></tr>';						
						$('#reselect').append(add);						
						$('#forReselect').show();
						//End reselect
						$( this ).dialog( "close" );
...
<div class="wrapper">
  ...
  <div class="main-container">
    <div class="main col2-right-layout">
      <form id="form1" name="form1" method="post" action="<?php echo site_url('reseller/cartmid');?>">
                  ...
                  <table width="500" height="150" border="0" bordercolor="#ccc" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF" class="new-tr">
                    <tr>
                      ...
                      <td align="left" width="364" height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Add an extra 6 logo concepts to your logo package</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(SIX_LOGO_CONCEPT*2); ?></del></span>. Now only <strong><?= CURRENCY.SIX_LOGO_CONCEPT; ?></strong></h2></td>
                    </tr>
                    <tr>
...
<?=GUARANTEE_DAY; ?>-Day, 100% Money Back guarantee. </span></p>
                  ...
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td align="left" width="364" height="38" bgcolor="#FFFFFF"><h2 class="para" style="font-size:15px;"> Get each one of you logos created by a different designer</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(LOGO_BY_DIFFERENT_DESIGNER*2); ?></del></span>. Now only <strong><?= CURRENCY.LOGO_BY_DIFFERENT_DESIGNER; ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td align="left" width="364" height="30" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order lifetime file storage</h2>
                        <h2 style="clear:both; float:left;"><span style="color:#f00;"><del><?= CURRENCY.(LIFE_TIME_FILE_STORAGE*2) ?></del></span>. Now only <strong><?= CURRENCY.LIFE_TIME_FILE_STORAGE ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td align="left" width="364" height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para"> Order an animated FLASH logo version</h2>
                        <h2 style="float:left;"><span style="color:#f00;"><del><?= CURRENCY.(ANIMATED_FLASH/0.4); ?></del></span>. Now only <strong><?= CURRENCY.ANIMATED_FLASH; ?></strong> (60% OFF)</h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td width="364" height="30" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Get your logos within 24hrs</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(LOGO_WITHIN_24_HOUR*2); ?></del></span>. Now only <strong><?= CURRENCY.(LOGO_WITHIN_24_HOUR); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="100" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td width="364" height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order black and white file logo version</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(BLACK_N_WHITE_FILE_LOGO*2); ?></del></span>. Now only <strong><?= CURRENCY.(BLACK_N_WHITE_FILE_LOGO); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
			...
			?>
                  <table width="500" height="80" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td width="364" height="30" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Impress with business cards</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(IMPRESS_WITH_BUSINESS_CARD*2); ?></del></span>. Now only <strong><?= CURRENCY.(IMPRESS_WITH_BUSINESS_CARD); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="80" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td width="364" height="30" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order letterhead designs</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(LETTER_HEAD/0.4); ?></del></span>. Now only <strong><?= CURRENCY.(LETTER_HEAD); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="80" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td width="364" height="30" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order envelope designs</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(ENVELOPE_DESIGN*2); ?></del></span>. Now only <strong><?= CURRENCY.(ENVELOPE_DESIGN); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="80" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td width="364" height="30" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order compliment slip designs</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(COMPLIMENT_SLIP*2); ?></del></span>. Now only <strong><?= CURRENCY.(COMPLIMENT_SLIP); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="180" border="0" cellpadding="10" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td width="364" height="30" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order stationary design bundle</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(STATIONARY_DESIGN_BUNDLE/0.4); ?></del></span>. Now only <strong><?= CURRENCY.(STATIONARY_DESIGN_BUNDLE); ?></strong> (60% OFF) </h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <div align="center"> 
                    ...
                    <input type="button" class="newbuttonback" value="Back" onclick="javascript:window.location='<?= site_url('reseller/orderone') ?>'" />
...
<div class="buy-more">
	<div class="save-more">
		<p style="padding:0px;padding-left: 4px;"><img src="<?php //echo base_url()?>/images/buy-more-img.png" /></p>
            ...
            <?php
if(@$_SESSION['firstSelPackage'] == PACKAGE1_RESELLER)
{
...
else if(@$_SESSION['firstSelPackage'] == PACKAGE2_RESELLER)
{
...
else if(@$_SESSION['firstSelPackage'] == PACKAGE3_RESELLER)
{
...
else if(@$_SESSION['firstSelPackage'] == PACKAGE4_RESELLER)
{
...
else if(@$_SESSION['firstSelPackage'] == PACKAGE5_RESELLER)
{
...
else if(@$_SESSION['firstSelPackage'] == PACKAGE6_RESELLER)
{
