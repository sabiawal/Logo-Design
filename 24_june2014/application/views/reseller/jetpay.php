<?php
    ...
    $total_nochex_pound = number_format($total_nochex_pound,"2",".","");    
        ...
        $order_discription .=  $currency.$price2."),";
        if(@$_SESSION['option']!="")
        {
            $order_discription .=  " ".$option_package." (";
            $order_discription .=  $currency.$option2."),";
        }
        if($extra_opt_price != 0)
        {            
            $order_discription .=  " ".$option_package_extra." (";
            $order_discription .=  $currency.$extra_opt_price2."),";
        }
        if($web != "")
        {
            $order_discription .=  " ".$web_package."(";
        $order_discription .=  $currency.$web2."),";            
        }
        if($brouchure!="")
        {
            $order_discription .=  " ".$brouchure_package."(";
            $order_discription .=  $currency.$brouchure2."),";
        }
        if(isset($_SESSION['p_discount']) && $_SESSION['p_discount'] != '')
        {
            $order_discription .=  ' Promotional Discount (';
            $order_discription .=  $currency.number_format(($_SESSION['p_discount']*CONVERSION_MULTIPLYER2),2,".","")."),";   
        }
        if(isset($_SESSION['purchase_discount']) && $_SESSION['purchase_discount'] != '')
        {
            $order_discription .=  ' Purchase Discount (';
            $order_discription .=  $currency.number_format(($_SESSION['purchase_discount']*CONVERSION_MULTIPLYER2),2,".","").")";   
        }
        $order_discription .= '.';		
?>
  ...
  <div class="main-container">
    <div class="main col1-layout">
      ...
      <h1>Almost Done!...</h1>
        ...
        <div class="form-wrap">
            <h2>Billing Information! <span class="required">(* Required)</span></h2>
            <div style="border: 1px solid #ccc;">
                <div class="label-wrap">
                <span class="labeltext"><label><span class="required">*</span>Company Name</label></span>
                <span ><?= @$_SESSION['company_name']; ?></span>
                </div>
                <div class="label-wrap">
                <span class="labeltext"><label><span class="required">*</span>Billing Address</label></span>
                <span ><input type="text" name="address1" value="<?= @$_SESSION['address1']; ?>" /></span>
                </div>
                <div class="label-wrap">
                <span class="labeltext"><label><span class="required">*</span>City</label></span>
                <span ><input type="text" name="city" value="<?= @$_SESSION['city']; ?>" /></span>
                </div>
                <div class="label-wrap">
                <span class="labeltext"><label><span class="required">*</span>State</label></span>
                ...
                <div class="label-wrap">
                <span class="labeltext"><label><span class="required">*</span>Zip Code/Postcode</label></span>
                <span ><input type="text" name="zip" value="<?= @$_SESSION['zip']; ?>" /></span>
                </div>
                <div class="label-wrap">
                <span class="labeltext"><label><span class="required">*</span>Name on Card</label></span>
                <span ><input type="text" name="name" value="<?= @$_SESSION['name']; ?>" /></span>
                </div>
                <div class="label-wrap">
                <span class="labeltext"><label><span class="required">*</span>Card Number</label></span>
        ...
        <img src="<?= base_url(); ?>jetpay/images/cards/invalid.gif" alt="card_logo" name="cardimage" width="36"  height="24" hspace="10" vspace="0" align="middle" /></span>
                ...
                <div class="label-wrap">
                <span class="labeltext"><label><span class="required">*</span>Card Expiry</label></span>
                <span >Mo.
                ...
                <div class="label-wrap">
                <span class="labeltext"><label><span class="required">*</span>CVV Number</label></span>
