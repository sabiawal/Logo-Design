...
<script language="javascript" type="text/javascript" src="<?php echo base_url(); ?>js/image.hover.js"></script>
...
<form method="post" name="packageFrm" id="packageFrm" action="<?php echo site_url('logodesign/ordermid');?>">
...
<p><span class="text-red"><span class="text-bold">Warning:</span> Many logo firms will tempt you with low fees such as &ldquo;<?php echo CURRENCY . Silver_Logo_Package_Price; ?>&rdquo; or &ldquo;<?php echo CURRENCY . Super_Silver_Plus_Logo_Package_Price; ?>&rdquo; but they will only provide 1 or 2 samples for their advertised fee.</span> Do not fall for this! Several logo variations are essential in getting the logo you have in mind!</p>

<p>We have achieved the status of the leading <?php echo ISM; ?> logo design company, because our standard package provides 6 custom-logos for only &pound;25 with a <span class="text-green text-10"><?php echo GUARANTEE_DAY; ?>-Day, 100% money back guarantee.</span></p>
...
<li><span class="text-bold"><?php echo GUARANTEE_DAY; ?>-Day, 100% Money Back Guarantee</span> on all our packages. We provide you with the best guarantee in the industry. Most firms only state 100% money back guarantee as a marketing gimmick. Their policies often apply solely to expensive packages and have lots of small print, subjecting you to incurring administration charges often at <?php echo CURRENCY ." ". Super_Silver_Plus_Logo_Package_Price; ?>.

  </li>

  <p>If you are confused about what to do first, <a href="#">click here</a> to see our 5 easy steps to a great custom logo.</p>
...
<div><img src="<?php echo base_url(); ?>images/silvtitle-<?php echo COUNTRY; ?>.jpg" align="silver-package" title="silver-package"/></div>

<div class="silver-text" align="left">

<img src="<?php echo base_url(); ?>images/sliver-package.jpg" alt="Silver Package" title="Silver Package" />
...
<p><span class="text-orange"><?php echo GUARANTEE_DAY; ?>-Day - 100% No-Risk Money Back Guarantee.</span> No fees, no questions. Immediate refund. Don't be fooled...we refund at any stage of the design process. Our competitors do not! <br />(By far the best guarantee in the industry)</p>
...
<span class="text-blink text-black"><span class="border-bottom">Free offer Must End Midnight, <span class="text-green"><?php echo"$today";?>.</span></span> </span></strong></p>
...
<div class="button-silver" align="center"><span class="text-orange"><strong>Only <?php echo CURRENCY . Silver_Logo_Package_Price; ?></strong></span>

<a href="javascript:void(0);" onclick="submitPackage('<?php echo Silver_Logo_Package;?>','<?php echo Silver_Logo_Package_Price;?>');"><img  src="<?php echo base_url(); ?>images/silver-order.gif" name="silver" id="silver" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('silver','','<?php echo base_url(); ?>images/silver-order-hover.gif',1)" /></a></div>
...
<div align="center"><span class="text-orange-price"><strong>Only <?php echo CURRENCY . Super_Silver_Logo_Package_Price; ?> </strong> </span>

<a href="javascript:void(0);" onclick="submitPackage('<?php echo Super_Silver_Logo_Package;?>','<?php echo Super_Silver_Logo_Package_Price;?>');"><img  src="<?php echo base_url(); ?>images/silver-order.gif" name="super-silver" id="super-silver" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('super-silver','','<?php echo base_url(); ?>images/silver-order-hover.gif',1)" /></a></div>
...
<div align="center"><span class="text-orange-price"><strong>Total only: <?php echo CURRENCY . Super_Silver_Plus_Logo_Package_Price; ?></strong></span>

<a href="javascript:void(0);" onclick="submitPackage('<?php echo Super_Silver_Plus_Logo_Package;?>','<?php echo Super_Silver_Plus_Logo_Package_Price;?>');"><img  src="<?php echo base_url(); ?>images/silver-order.gif" name="super-silver-plus" id="super-silver-plus" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('super-silver-plus','','<?php echo base_url(); ?>images/silver-order-hover.gif',1)" /></a></div>
...
<div><img src="<?php echo base_url(); ?>images/bxfooter.gif" align="#" title="#" /></div>
...
<div><img src="<?php echo base_url(); ?>images/elitetitle-<?php echo COUNTRY; ?>.jpg" align="Elite-package" title="Elite-package" /></div>

<div class="elite-text" align="left">

<img src="<?php echo base_url(); ?>images/elite-package.jpg" alt="Elite Packages" title="Elite Packages" />
...
<p><strong><span class="text-orange"> <?php echo GUARANTEE_DAY; ?>-Day - 100% No-Risk Money Back Guarantee.</span> No fees, no questions. Immediate refund. Don't be fooled...we refund at any stage of the design process. Our competitors do not!<br />
...
<div class="button-silver" align="center"><span class="text-orange"><strong>Only <?php echo CURRENCY . Elite_Logo_Package_Price; ?></strong></span>

<a href="javascript:void(0);" onclick="submitPackage('<?php echo Elite_Logo_Package;?>','<?php echo Elite_Logo_Package_Price;?>');"><img  src="<?php echo base_url(); ?>images/elite-order.gif" name="elite" id="elite" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('elite','','<?php echo base_url(); ?>images/elite-order-hover.gif',1)" /></a></div>
...
<div align="center"><span class="text-orange-price"><strong>Only <?php echo CURRENCY . Super_Elite_Logo_Package_Price; ?></strong></span>

<a href="javascript:void(0);" onclick="submitPackage('<?php echo Super_Elite_Logo_Package;?>','<?php echo Super_Elite_Logo_Package_Price;?>');"><img  src="<?php echo base_url(); ?>images/elite-order.gif" name="super-elite" id="super-elite" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('super-elite','','<?php echo base_url(); ?>images/elite-order-hover.gif',1)" /></a></div>
...
<div align="center"><span class="text-orange-price"><strong>Only <?php echo CURRENCY . Super_Elite_Plus_Logo_Package_Price; ?></strong></span>

<a href="javascript:void(0);" onclick="submitPackage('<?php echo Super_Elite_Plus_Logo_Package;?>','<?php echo Super_Elite_Plus_Logo_Package_Price;?>');"><img  src="<?php echo base_url(); ?>images/elite-order.gif" name="super-elite-plus" id="super-elite-plus" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('super-elite-plus','','<?php echo base_url(); ?>images/elite-order-hover.gif',1)" /></a></div>
...
<img src="<?php echo base_url(); ?>images/purple-banner-<?php echo COUNTRY; ?>.jpg" />

<span class="text-red text-16"><strong><?php echo $today;?></strong></span></div></div>
