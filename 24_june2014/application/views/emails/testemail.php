...
<table width="625" class="aa" style="border:1px solid #cccccc; margin:10px;" >
    <tr>
        ...
        <td>
            ...
            <u>How our reseller services works</u>  <br /><br />
            ...
            <table width="570px" style="padding:5px 0 0 30px;">
                <tr><td width="20"><img src="'.base_url().'images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;padding-right:10px;"/></td><td>Log into your reseller account</td></tr>
                <tr><td><img src="'.base_url().'images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;"/></td><td>Check out our discounted packages within your account.</td></tr>
                <tr><td><img src="'.base_url().'images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;"/></td><td>Place orders using your clients design requests/briefs.</td></tr>
                <tr><td><img src="'.base_url().'images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;"/></td><td>Our designers get to work the same day!</td></tr>
                <tr><td><img src="'.base_url().'images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;"/></td><td>We upload the artwork into your reseller account and <br />notify you by email.</td></tr>
                <tr><td><img src="'.base_url().'images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;"/></td><td>You forward the outputs via email to your clients.</td></tr>
            ...
            Log in to your account now, and check out our services <br />and low prices!<br /> <br />
