...
$_SESSION['payment_link'] = base_url().'payment.php?package='.$package.'&amp;price='.$price.'&amp;option='.$option.'&amp;extprice='.$extPrice.'&amp;p_discount='.@$_SESSION['p_discount'].'&amp;tax_in_total='.@$_SESSION['tax_in_total'].'&amp;net_total='.@$_SESSION['net_total'].'&amp;mainlogowebid='.$mainLogoWebId.'&amp;company_name='.$company_name.'&amp;authentication_code='.@$_SESSION['authentication_code'];
	
echo '<table width="682" border="0" style="margin:0;padding:0;font:normal 13px/18px Arial, Helvetica, sans-serif;color:#333333;">
  <tr>
   <td width="680" height="160" valign="bottom" style=""><img src="http://'.SITE_NAME.'/images/logo-'.COUNTRY.'.gif"><div style="margin-top:-30px;padding-left:15px;font:normal 20px Georgia, \'Times New Roman\', Times, serif;">Order Confirmation</div></td>
  </tr>
  <tr>
    <td><table width="650" border="0" style="margin-left:10px; margin-bottom:0;">
        <tr>
          <td><img src="'.base_url().'images/sale.gif" width="650" height="185" alt="sale" style="margin:0;padding:0;border:none;"/></td>
        </tr>
            ...
            <td><table width="625" class="aa" style="border:1px solid #cccccc; margin:10px;" >
                <tr>
                  ...
                  Dear '.$first_name.',<br />
                    ...
                    <br />
                    <a id="payment_link" href="'.base_url().'payment.php?package='.$package.'&amp;price='.$price.'&amp;option='.$option.'&amp;extprice='.$extPrice.'&amp;p_discount='.@$_SESSION['p_discount'].'&amp;tax_in_total='.@$_SESSION['tax_in_total'].'&amp;net_total='.@$_SESSION['net_total'].'&amp;mainlogowebid='.$mainLogoWebId.'&amp;company_name='.$company_name.'&amp;authentication_code='.@$_SESSION['authentication_code'].'" target="_blank"><img src="'.base_url().'images/payment.gif" width="396" height="94" alt="payment" /></a><br />
                    ...
                    <table width="570px" style="padding:5px 0 0 30px;">
                      <tr>
                        <td><img src="'.base_url().'images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;padding-right:10px;"/>We have <strong>award winning,</strong> professional <i>&ldquo;in-house&rdquo;</i> designers! <br />
                          <img src="'.base_url().'images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;padding-right:10px;"/>Your designs will be fully <strong>100% custom-made!</strong><br />
                          <img src="'.base_url().'images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;padding-right:10px;"/>You will been entitled to <strong>unlimited redraws and revisions!</strong><br />
                          <img src="'.base_url().'images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;padding-right:10px;"/>We have the best guarantee in the industry ><strong>'.GUARANTEE_DAY.'-Day,100% money back-guarantee!</strong> <br />
                          <br /></td>
                      </tr>
                    </table>
Here is the payment link again for you...<br />
<br />
<a href="'.base_url().'payment.php?package='.$package.'&amp;price='.$price.'&amp;option='.$option.'&amp;extprice='.$extPrice.'&amp;p_discount='.@$_SESSION['p_discount'].'&amp;tax_in_total='.@$_SESSION['tax_in_total'].'&amp;net_total='.@$_SESSION['net_total'].'&amp;mainlogowebid='.$mainLogoWebId.'&amp;company_name='.$company_name.'&amp;authentication_code='.@$_SESSION['authentication_code'].'" target="_blank"><img src="http://'.SITE_NAME.'/images/payment.gif" width="396" height="94" alt="payment" /></a><br /><br />
...
<td width="20"></td>
        ...
        <tr>
          ...
          <tr><td></td></tr>
          <tr>
  <td><img src="'.base_url().'images/office.gif" width="653" height="153" alt="Logo design guarantee" style="margin:0;padding:0;border:none;"/></td>
  </tr>
      </table></td>
  </tr>
</table>';
