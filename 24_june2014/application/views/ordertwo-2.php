...
.new-tr {
	...
	-webkit-box-shadow: 2px 2px 3px #888 !important;
                ...
                <td width="520" valign="top"><table width="500" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3">
                  ...
                  <table width="500" height="150" border="0" bordercolor="#ccc" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF" class="new-tr">
                    <tr>
                      ...
                      <td align="left" width="364" height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Add an extra 6 logo concepts to your logo package</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del>&pound;40</del></span>. Now only <strong>&pound;19</strong></h2></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td height="50"><p align="left">
                        ...
                        <p><span class="correctfont">All services are backed by our
                          <?=GUARANTEE_DAY; ?>
                          -Day, 100% Money Back guarantee. </span></p>
                        <p>
                          <?php }?>
                  ...
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    ...
                    <tr>
					  ...
					  ?>
                        <span class="correctfont">You currently have 6 designers assigned  to your project. By adding this service you will have 12 designers working on  your 12 logo concepts. This will massively increase the creativity and options  for you. All services are backed by our
                        <?=GUARANTEE_DAY; ?>
                        -Day, 100% Money Back guarantee.</span>
                        <?php 
                  ...
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td align="left" width="364" height="30" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order lifetime file storage</h2>
                        <h2 style="clear:both; float:left;"><span style="color:#f00;"><del>&pound;30</del></span>. Now only <strong>&pound;15</strong></h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td align="left" width="364" height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para"> Order an animated FLASH logo version</h2>
                        <h2 style="float:left;"><span style="color:#f00;"><del>&pound;99</del></span>. Now only <strong>&pound;39</strong> (60% OFF)</h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td width="364" height="30" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Get your logos within 24hrs</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del>&pound;39</del></span>. Now only <strong>&pound;19</strong></h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="100" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td width="364" height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order black and white file logo version</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del>&pound;30</del></span>. Now only <strong>&pound;15</strong></h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="180" border="0" cellpadding="10" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td width="364" height="30" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order stationary design bundle</h2>
                        <h2 style="clear:both;"><span style="color:#f00;"><del>&pound;99</del></span>. Now only <strong>&pound;39</strong> (60% OFF) </h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    ...
                    <tr height="30">
                      ...
                      <td><h2 style="color:#393;">250 business cards (matt) <u>including</u> free  delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del>&pound;80</del></span> Now only <strong>&pound;49</strong></h2></td>
                    </tr>
                    <tr>
                      ...
                      <td height="56" ><h2 style="color:#393;">500  business cards (matt) <u>including</u> free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del>&pound;100</del></span> Now only <strong>&pound;59</strong></h2></td>
                    </tr>
                  </table>
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                    ...
                    <tr height="30">
                      ...
                      <td ><h2 style="color:#393;">25  letterheads including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del>&pound;40</del></span> Now only <strong>&pound;29</strong></h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                      ...
                      <td height="56" ><h2 style="color:#393;">250 letterheads including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del>&pound;159</del></span> Now only <strong>&pound;69</strong> (60% OFF)</h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                      ...
                      <td height="56"><h2 style="color:#393;">1000  letterheads including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del>&pound;219</del></span> Now only <strong>&pound;119</strong></h2></td>
                    </tr>
                  </table>
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                    ...
                    <tr height="30">
                      ...
                      <td><h2 style="color:#393;"> 100  envelopes including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del>&pound;60</del></span> Now only <strong>&pound;45</strong></h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                      ...
                      <td height="56"><h2 style="color:#393;">250  envelopes including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del>&pound;100</del></span> Now only <strong>&pound;75</strong></h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                      ...
                      <td height="56"><h2 style="color:#393;">1000  envelopes including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del>&pound;200</del></span> Now only <strong>&pound;129</strong></h2></td>
                    </tr>
                  </table>
                  <table width="500" height="150" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                    ...
                    <tr>
                      ...
                      <td height="56"><h2 style="color:#393;">250  compliment slips including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del>&pound;100</del></span> Now only <strong>&pound;65</strong></h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                  ...
                  <table width="500" height="100" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td  align="left" width="364" height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order a Mouse Mat with your personal logo on</h2>
                        <h2 style="clear:both;">(free delivery)! <span style="color:#f00;"><del>&pound;29</del></span>. Now only <strong>&pound;15</strong> Each.</h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                  ...
                  <table width="500" height="100" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" class="new-tr">
                    <tr>
                      ...
                      <td  align="left" width="364" height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order a custom CAP with your personal logo on</h2>
                        <h2 style="clear:both;">(free delivery)! <span style="color:#f00;"><del>&pound;29</del></span>. Now only <strong>&pound;19</strong> Each.</h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
