            ...
            <div class="col-main"> <a href="#" id="portfolio" name="portfolio"></a>
                <div class="portfolio">
                    ...
                    <div class="portfolio-list">
                        <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/responsiblefam.jpg" title="responsiblefam" alt="responsiblefam" /></div>
                    ...
                    <div class="portfolio-list">
                        <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/rocknbaby.jpg" title="rocknbaby" alt="rocknbaby" /></div>
                        <div class="portfolio-text">
                        <h3>Kim Katnik</h3>
                    ...
                    <div class="portfolio-list">
                        <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/scorebb.jpg" title="scorebb" alt="scorebb" /></div>
                        <div class="portfolio-text">
                    ...
                    <div class="portfolio-list">
                        <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/shawway.jpg" title="shawway" alt="shawway" /></div>
                        <div class="portfolio-text">
                        <h3>Helen Shaw</h3>
                    ...
                    <div class="portfolio-list">
                        <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/somethingfishy.jpg" title="somethingfishy" alt="somethingfishy" /></div>
                        <div class="portfolio-text">
                    ...
                    <div class="portfolio-botton" align="center"><a href="javascript:history.go(-1);"><img src="<?= base_url();?>images/prev.gif" /></a><a href="<?= site_url('portfolio102'); ?>#portfolio"><img src="<?= base_url();?>images/next.gif" /></a></div>
                </div>
