  ...
  <div class="main-container">
    <div class="main col1-layout">
      ...
      <h1>Almost Done!...</h1>
        ...
        <a href="javascript:popUp('<?= site_url('cvv2')?>')" style="float: right;">The CVV Number is the last 3 digits found on the back of your debit or credit card. </a></span>
                </div>
                ...
                <div class="label-wrap">
                <input type="button"  onclick="document.location='<?= site_url('cart2'); ?>'" value="Back" class="button-back" />
