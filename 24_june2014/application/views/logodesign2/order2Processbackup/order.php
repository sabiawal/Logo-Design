        ...
        <div class="main col1-layout">
            <div class="col-main">
                <div class="order-page">
                    ...
                    <form class="cmxform" id="commentForm" method="post" action="<?php echo site_url('logodesign2/orderonemid');?>" enctype="multipart/form-data">
                    ...
                    Packages.<br />
                    Valid to <strong><span class="text-red"> Midnight <?php echo $today; ?> </span></strong></td>
                    ...
                    Packages.<br />
                    Valid to <strong><span class="text-red"> Midnight <?php echo $today; ?> </span></strong> </div></td>
                    <td valign="top" class="text-bold"> Select Package:&nbsp;&nbsp;&nbsp;
                    ...
                    ////////////////// -->
                    <tr class="tablebg">
                    <td colspan="2" align="center"><a href="javascript: window.location='<?= site_url('packages2')?>'"><img src="<?php echo base_url()?>images/back.jpg" width="100" height="49" border="0" align="middle" style="display:inline;" /></a>
                    <input name="submit" type="image" src="<?= base_url()?>images/pay_continue.jpg" alt="continue" align="middle" onclick="checkerror()"/></td>
                    </tr>
                    </table>
                    </div>
                    </form>
