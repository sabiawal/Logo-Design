...
var compliment_slip					 = '<?= COMPLIMENT_SLIP; ?>';
var stationary_design_bundle		 = '<?= STATIONARY_DESIGN_BUNDLE; ?>';
          ...
          <form id="form1" name="form1" method="post" action="<?php echo site_url('logodesign2/cartmid');?>">
            ...
            if(@$_SESSION['option']!= BLACK_N_WHITE){ ?>
                  ...
                  <div align="center">
                    ...
                    <a href="javascript: window.location='<?php echo site_url('orderone2')?>'"><img src="<?= base_url(); ?>images/back.jpg" alt="a" width="100" height="49" border="0" align="absmiddle" style="display:inline" /></a>
                        ...
                        <td class="totalpricetxt" colspan="2" align="center" bgcolor="#ffffff"><table width="345" border="0" cellpadding="0" cellspacing="0" class="formtoptext">
                            <tbody>
                              <tr align="right">
                                ...
                                <td colspan="2" align="right"><input name="LblCurrencySign3" id="LblCurrencySign3" style="text-align: right; width: 15px;" class="pricetxt" readonly="readonly" value= '<?php echo CURRENCY; ?>' type="text"/><input name="LblYouPay" id="LblYouPay" class="pricetxt" readonly="readonly" style="width: 63px; text-align: left;" value="<?php echo $total + @$_SESSION["price"] + @$_SESSION["option"] + @$_SESSION['web'] + @$_SESSION['brouchure'];?>" type="text" /></td>
                              </tr>
