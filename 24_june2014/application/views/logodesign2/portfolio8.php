            ...
            <div class="col-main"> <a href="#" id="portfolio" name="portfolio"></a>
                <div class="portfolio">
                    ...
                    <div class="portfolio-list">
                        <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/projectgolf.jpg" title="3x logo" alt="3x logo" /></div>
                    ...
                    <div class="portfolio-list">
                        <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/promised.jpg" title="3x logo" alt="3x logo" /></div>
                        <div class="portfolio-text">
                        <h3>Pamela DuVal</h3>
                    ...
                    <div class="portfolio-list">
                        <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/raindrop.jpg" title="3x logo" alt="3x logo" /></div>
                        <div class="portfolio-text">
                        <h3>Jimmy Abney</h3>
                    ...
                    <div class="portfolio-list">
                        <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/recordclocks.jpg" title="recordclocks" alt="recordclocks" /></div>
                        <div class="portfolio-text">
                    ...
                    <div class="portfolio-list">
                        <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/rescue.jpg" title="rescue" alt="rescue" /></div>
                        <div class="portfolio-text">
                        <h3>Jay Jaffari</h3>
                    ...
                    <div class="portfolio-botton" align="center"><a href="javascript:history.go(-1);"><img src="<?= base_url();?>images/prev.gif" /></a><a href="<?= site_url('portfolio92'); ?>#portfolio"><img src="<?= base_url();?>images/next.gif" /></a></div>
                </div>
