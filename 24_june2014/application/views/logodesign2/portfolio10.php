        ...
        <div class="main col2-right-layout">
            <div class="col-main"> <a href="#" id="portfolio" name="portfolio"></a>
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/tdg.jpg" title="tdg" alt="tdg" /></div>
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/thirdchannel.jpg" title="thirdchannel" alt="thirdchannel" /></div>
                    <div class="portfolio-text">
                    <h3>Peter Ang</h3>
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/twistedmonekey.jpg" title="twistedmonekey" alt="twistedmonekey" /></div>
                    <div class="portfolio-text">
                    <h3>Joseph Morris </h3>
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/unikexpo.jpg" title="unikexpo" alt="unikexpo" /></div>
                    <div class="portfolio-text">
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/urbankaos.jpg" title="urbankaos" alt="urbankaos" /></div>
                    <div class="portfolio-text">
                    <h3>Timothy Oberg </h3>
                ...
                <div class="portfolio-botton" align="center"><a href="javascript:history.go(-1);"><img src="<?= base_url();?>images/prev.gif" /></a></div>
                </div>
