...
<div class="wrapper" style="background: #fff;">
  ...
  <form method="post" name="packageFrm" id="packageFrm" action="<?=site_url('logodesign2/ordermid');?>">
...
&quot;Helvetica&quot;,&quot;sans-serif&quot;">Buy More, Save More&hellip;</span></strong></p>
  ...
  //var_dump($logo_package_rows);
    ...
    {        
        ...
        <div class="package-list <?php if($logo_package_rows[$i]->package_type == "Be the Best"){echo "green-bg";}  ?>" <?php if($div_count % 3 == 0){echo "style='margin-right:0;'"; } ?>> 
            ...
            $description = $logo_package_rows[$i]->package_description;
            if($logo_package_rows[$i]->package_type == "Be the Best"){
            echo '<br />
            ...
            echo $plus;
            echo  $logo_package_rows[$i]->package_description2;
            }
...
<h2 align="center"><img src="<?= base_url()?>images/moneyback.jpg" alt="moneyback" title="moneyback" /></h2>
  ...
  <div class="footer-container">
    <?php include_once("includes/logo-design2/footer2.php"); ?>
  </div>
</div> 
</body>
</html>