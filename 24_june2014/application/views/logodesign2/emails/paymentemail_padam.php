...
echo "<table width=\"100%\" border=\"0\">
  <tr>
	...
	<p>Thank you for your order with Logo Design Guarantee.</p>
		  ...
		  <p align=\"justify\"><a href=\"http://".SITE_NAME."/payment2.php?package=$package&amp;price=$price&amp;web=$web&amp;brouchure=$brouchure&amp;option=$option&amp;extprice=$extPrice&amp;mainlogowebid=$mainLogoWebId\">http://".SITE_NAME."/payment.php</a></p>
