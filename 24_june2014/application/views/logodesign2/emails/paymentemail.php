...
echo '<table width="682" border="0" style="margin:0;padding:0;font:normal 13px/18px Arial, Helvetica, sans-serif;color:#333333;">
  ...
  <tr>
    <td><table width="650" border="0" style="margin-left:10px; margin-bottom:0;">
        <tr>
          <td><img src="http://'.SITE_NAME.'/images/sale.gif" width="650" height="185" alt="sale" style="margin:0;padding:0;border:none;"/></td>
        </tr>
            ...
            <td><table width="625" class="aa" style="border:1px solid #cccccc; margin:10px;" >
                <tr>
                  ...
                  Dear '.$first_name.',<br />
                    ...
                    <br />
                    <a href="http://'.SITE_NAME.'/payment2.php?package='.$package.'&amp;price='.$price.'&amp;web='.$web.'&amp;brouchure='.$brouchure.'&amp;option='.$option.'&amp;extprice='.$extPrice.'&amp;mainlogowebid='.$mainLogoWebId.'&amp;tax_in_total='.$tax_in_total.'&amp;company_name='.$company_name.'" target="_blank"><img src="http://'.SITE_NAME.'/images/payment.gif" width="396" height="94" alt="payment" /></a><br />
                    ...
                    <table width="570px" style="padding:5px 0 0 30px;">
                      <tr>
                        <td><img src="http://'.SITE_NAME.'/images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;padding-right:10px;"/>We have <strong>award winning,</strong> professional <i>&ldquo;in-house&rdquo;</i> designers! <br />
                          <img src="http://'.SITE_NAME.'/images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;padding-right:10px;"/>Your designs will be fully <strong>100% custom-made!</strong><br />
                          <img src="http://'.SITE_NAME.'/images/bullet.gif" width="16" height="15" alt="bullet" style="margin:0;padding:0;border:none;padding-right:10px;"/>We have the best guarantee in the industry ><strong>180-Day,100% money back-guarantee!</strong> <br />
                          <br /></td>
                      </tr>
                    </table>
Here is the payment link again for you...<br />
<br />
<a href="http://'.SITE_NAME.'/payment2.php?package='.$package.'&amp;price='.$price.'&amp;web='.$web.'&amp;brouchure='.$brouchure.'&amp;option='.$option.'&amp;extprice='.$extPrice.'&amp;mainlogowebid='.$mainLogoWebId.'&amp;tax_in_total='.$tax_in_total.'&amp;company_name='.$company_name.'" target="_blank"><img src="http://'.SITE_NAME.'/images/payment.gif" width="396" height="94" alt="payment" /></a><br /><br />
...
<a href="http://'.SITE_NAME.'/web-site-design/webdesigner-limited-sale/index.php" target="_blank" style=" color:#0090ff;">http://'.SITE_NAME.'/web-site-design/webdesigner-limited-sale/index.php</a>
<br /><br />
</td>
<td width="20"></td>
                </tr>
