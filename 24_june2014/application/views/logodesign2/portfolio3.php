        ...
        <div class="main col2-right-layout">
            <div class="col-main"> <a href="#" id="portfolio" name="portfolio"></a>
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/conway.jpg" title="3x logo" alt="3x logo" /></div>
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/csi.jpg" title="3x logo" alt="3x logo" /></div>
                    <div class="portfolio-text">
                    <h3>Joe Carmen</h3>
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/darkknignt.jpg" title="3x logo" alt="3x logo" /></div>
                    <div class="portfolio-text">
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/diversified.jpg" title="3x logo" alt="3x logo" /></div>
                    <div class="portfolio-text">
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/drugtest.jpg" title="3x logo" alt="3x logo" /></div>
                    <div class="portfolio-text">
                    <h3>Angie Hope</h3>
                ...
                <div class="portfolio-botton" align="center"><a href="javascript:history.go(-1);"><img src="<?= base_url();?>images/prev.gif" /></a><a href="<?= site_url('portfolio42'); ?>#portfolio"><img src="<?= base_url();?>images/next.gif" /></a></div>
                </div>
