        ...
        <div class="main col2-right-layout">
            <div class="col-main"> <a href="#" id="portfolio" name="portfolio"></a>
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/avision.jpg" title="3x logo" alt="3x logo" /></div>
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/bullship.jpg" title="3x logo" alt="3x logo" /></div>
                    <div class="portfolio-text">
                    <h3>Timothy Sykes</h3>
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/christopher.jpg" title="3x logo" alt="3x logo" /></div>
                    <div class="portfolio-text">
                ...
                <div class="portfolio-list">
                    <div class="folio-list-img"><img src="<?= base_url();?>images/logo-portfolio/chya.jpg" title="3x logo" alt="3x logo" /></div>
                    <div class="portfolio-text">
                    <h3>Allen Nells</h3>
                ...
                <div class="portfolio-botton" align="center"><a href="javascript:history.go(-1);"><img src="<?php echo base_url();?>images/prev.gif" /></a><a href="<?= site_url('portfolio32'); ?>#portfolio"><img src="<?php echo base_url();?>images/next.gif" /></a></div>
                </div>
