...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <title><?php $s = array('Logo-Design','-'); $r = array(' ',' '); echo str_replace($s,$r,($this->uri->segment(2)));?> - Logo Design Guarantee&trade;</title>
  ...
  <!--script type="text/javascript" src="/jquery-1.4.2.min.js"></script--> 
        <script src="<?php echo base_url()?>scripts/jquery.js" type="text/javascript" language="javascript"></script>
  ...
  $(function() {
        ...
        else if($(".logo-cats li.active").hasClass("lastLi"))
        var nextUri = $(".logo-cats li.active").parent().parent().children().children().children().attr("href");
	else var nextUri = $(".logo-cats li.active").next().children().attr("href");
	//alert(nextUri);
                        ...
                        <div class="logo-cats">
                          <ul id="industry">
                           ...
                           <ul>                           
                            ...
                            <li class="lastLi <?php if($this->uri->segment(2)=="Off-The-Wall-Logo-Design")echo "active";?>"><a href="<?php echo site_url('industry/Off-The-Wall-Logo-Design')?>">Off The Wall</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
