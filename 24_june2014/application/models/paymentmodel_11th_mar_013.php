...
$headers .= 'From: Logo Admin<info@logodesignguarantee.co.uk>' . "\r\n";

$headers1  = 'MIME-Version: 1.0' . "\r\n";
$headers1 .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
//$headers1 .= 'From: LogoDesignGuarantee<enquiries@logodesignguarantee.co.uk>' . "\r\n";	
$headers1 .= 'From: Logo Admin<info@logodesignguarantee.co.uk>' . "\r\n";
...
mail('info@logodesignguarantee.co.uk',$subject,$mailbody,$headers);
//mail('prajapatiextraopt2009@gmail.com',$subject,$mailbody,$headers);
