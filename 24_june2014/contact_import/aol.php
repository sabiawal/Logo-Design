...
<?php //print_r($_GET);?>
<form method="post" action="import.php?email=<?php echo $_GET['email']?>&logoWebId=<?php echo $_GET['logoWebId']?>&all_logos=<?php print_r($_GET['array'])?>" name="csvmassimport" enctype="multipart/form-data">  
...
<td align="center">
<div id="login" style="margin:0; padding:0; ">
<form method="post" action="import.php?email=<?php echo $_GET['email']?>&logoWebId=<?php echo $_GET['logoWebId']?>&all_logos=<?php print_r($_GET['array'])?>" name="massimport">  
<table border="0" cellspacing="0" cellpadding="0" class="tableimport">
<tr> 
...
<?php if($contactimporter_service17=="1") {?><option value="yahoo_api" <?php if((isset($_POST['service']) && $_POST['service']=='yahoo_api') ) {echo("selected");} ?> disabled>@yahoo.com</option><?php } ?>
