...
<?php
        ...
        echo "<p class='logOut' style='margin:0px; padding:0px;'><a href=\"?logout\">Logout</a></p>"; ?>
...
<img width="72" id="show_all1" class="img_org" name="Click to Show Further Contacts" height="72" border="0" src="all_users.png" alt=""/>
</a> 
<a href="#" class="tooltip" name="Click to view further contacts">
<img width="72" id="show_all" class="img_3" name="Click to Show Further Contacts" height="72" border="0" src="all_users1.jpg" alt=""/>
</a>    
</div>    
