...
function show_api_buttons()
{
	...
	if(val=='yahoo_api' || val=='rocketmail_api' || val=='ymail_api')
	{
		...
		document.massimport.clientname.value='Please authorize first...';
		document.massimport.username.value='Please authorize first...';
	...
	else
	{
			...
			else
			{
				...
				if(document.massimport.clientname.value=='Please authorize first...')
				{
...
?>
<table align="center" cellpadding="0" cellspacing="0" border="0" width="650">
<?php if((!$importsucess) && (!$csvimportsucess)) //not imported 
{ ?>
<tr>
<td align="left" valign="middle"> 
<div align="left" class="topnavigation" > 
<?php if($showaddressimport) { ?>  <a href="?importype=import" class="chooselink"><?php echo $toplink1 ?></a><?php }
     if($showcsvimport) { ?>  <a href="?importype=csvimport" class="chooselink"><?php echo $toplink2 ?></a><?php }
    if($showmanualimport) { ?> <a href="?importype=manual" class="chooselink"><?php echo $toplink3 ?></a><?php } 
	if($showsocialsharer) { ?>  <a href="?importype=share" class="chooselink"><?php echo $toplink5 ?></a> <?php } 
    if($showyminvite) { ?>  <a href="?importype=yminvite" class="chooselink"><?php echo $toplink4 ?></a> <?php } ?>
  </div>
  </td>
  </tr>
...
<div id="servicesbookmark" style="margin:0; padding:0">
<ul>
<li>
<a onClick="clicksocialicon(0,'Facebook','icon1','http://www.facebook.com/sharer/sharer.php?s=100&p[title]=[TITLE]&p[url]=[URL]&p[summary]=[SHORT_TEXT]',0,1)">
<img id="icon1" title="Facebook" src="images/social_buttons/facebook.gif" border="0" align="absmiddle"> Facebook
</a>
</li>
<li>
<a onClick="clicksocialicon(0,'MySpace','icon2','http://www.myspace.com/Modules/PostTo/Pages/?t=[TITLE]&c=[SHORT_TEXT]&u=[URL]&l=1' ,0,0)">
<img id="icon2" title="MySpace" src="images/social_buttons/myspace.gif" border="0" align="absmiddle"> MySpace
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'LinkedIN','icon3','http://linkedin.com/shareArticle?mini=true&url=[URL]&title=[TITLE]&summary=[SHORT_TEXT]',0,0)">
<img id="icon3" title="LinkedIN" src="images/social_buttons/linkedin.gif" border="0" align="absmiddle"> LinkedIN
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(1,'Orkut','icon4','http://promote.orkut.com/preview?nt=orkut.com&du=[URL]&tt=[TITLE]',0,1)">
<img id="icon4" title="Orkut" src="images/social_buttons/orkut.gif" border="0" align="absmiddle"> Orkut
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(1,'Google','icon5','http://www.google.com/buzz/post?url=[URL]',0,0)">
<img id="icon5" title="Google Buzz" src="images/social_buttons/googlebuzz.gif" border="0" align="absmiddle"> Google Buzz
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(1,'Del.icio.us','icon6','https://secure.delicious.com/login?v=5&jump=http%3A%2F%2Fdelicious.com%2Fsave%3Furl%3D[URL]%26title%3D[TITLE]%26notes%3D[LONG_TEXT]%26tags%3D%26noui%3Dno%26share%3Dyes%26jump%3Dyes%26time%3D1274743962%26recipients%3D',0,0)">
<img id="icon6" title="Del.icio.us" src="images/social_buttons/delicious.gif" border="0" align="absmiddle"> Del.icio.us
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(1,'Google','icon7','http://www.google.com/bookmarks/mark?op=add&bkmk=[URL]&title=[TITLE]&annotation=[LONG_TEXT]',0,0)">
<img id="icon7" title="Google" src="images/social_buttons/google.gif" border="0" align="absmiddle"> Google
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'StumbleUpon','icon8','http://www.stumbleupon.com/submit?url=[URL]&title=[TITLE]',0,1)">
<img id="icon8" title="StumbleUpon" src="images/social_buttons/stumbelupon.gif" border="0" align="absmiddle"> StumbleUpon
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Technorati','icon9','http://technorati.com/faves?add=[URL]',1,1)">

<img id="icon9" title="Technorati" src="images/social_buttons/technorati.gif" border="0" align="absmiddle"> Technorati
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Reddit','icon10','http://www.reddit.com/login?dest=%2Fsubmit%3Furl%3D[URL]%26title%3D[TITLE]',0,1)">
<img id="icon10" title="Reddit" src="images/social_buttons/reddit.gif" border="0" align="absmiddle"> Reddit
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Slashdot','icon11','http://slashdot.org/submission?title=[TITLE]&url=[URL]&new=1',0,1)">
<img id="icon11" title="Slashdot" src="images/social_buttons/slashdot.gif" border="0" align="absmiddle"> Slashdot
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Twitter','icon12','http://twitter.com/?status=[LONG_TEXT]',0,1)">
<img id="icon12" title="Twitter" src="images/social_buttons/twitter.gif" border="0" align="absmiddle"> Twitter
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(1,'Newsvine','icon13','https://www.newsvine.com/_nv/accounts/login?redirect=http%3A%2F%2Fwww.newsvine.com%2F_tools%2Fseed%26save%3Fu%3D[URL]%26%26h%3D[TITLE]%26s%3D[LONG_TEXT]',0,0)">
<img id="icon13" title="Newsvine" src="images/social_buttons/newswire.gif" border="0" align="absmiddle"> Newsvine
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Stumpedia','icon54','http://www.stumpedia.com/submit?url=[URL]',1,1)">
<img id="icon54" title="Stumpedia" src="images/social_buttons/stumpedia.gif" border="0" align="absmiddle"> Stumpedia
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'BlinkList','icon17','http://blinklist.com/user/login/?next=GoTo&u=[URL]&t=[TITLE]&d=',0,1)">
<img id="icon17" title="BlinkList" src="images/social_buttons/blinklist.gif" border="0" align="absmiddle"> BlinkList
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Faves','icon20','http://faves.com/Authoring.aspx?u=[URL]&t=[TITLE]',0,1)">
<img id="icon20" title="Faves" src="images/social_buttons/faves.gif" border="0" align="absmiddle"> Faves
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Blogmarks','icon21','http://blogmarks.net/my/new.php?mini=1&url=[URL]&title=[TITLE]',0,1)">
<img id="icon21" title="Blogmarks" src="images/social_buttons/blogmarks.gif" border="0" align="absmiddle"> Blogmarks
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(1,'Diigo','icon22','https://secure.diigo.com/sign-in?referInfo=%2Fpost%3Furl%3D[URL]%26title%3D[TITLE]%26mode%3D0%26description%3D[LONG_TEXT]',0,0)">
<img id="icon22" title="Diigo" src="images/social_buttons/diigo.gif" border="0" align="absmiddle"> Diigo
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Folkd','icon23','http://www.folkd.com/page/submit.html',1,1)">
<img id="icon23" title="Folkd" src="images/social_buttons/folkd.gif" border="0" align="absmiddle"> Folkd
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Y! Bookmarks','icon25','http://bookmarks.yahoo.com/toolbar/savebm?opener=&u=[URL]&t=[TITLE]&d=[LONG_TEXT]',0,1)">
<img id="icon25" title="Y! Bookmarks" src="images/social_buttons/yahoobookmarks.gif" border="0" align="absmiddle"> Y! Bookmarks
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Bebo','icon29','http://www.bebo.com/c/share?Url=[URL]',0,1)">
<img id="icon29" title="Bebo" src="images/social_buttons/bebo.gif" border="0" align="absmiddle"> Bebo
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Kaboodle','icon40','http://www.kaboodle.com/grab/addItemWithUrl?url=[URL]&pidOrRid=pid=&redirectToKPage=true',1,1)">
<img id="icon40" title="Kaboodle" src="images/social_buttons/kaboodle.gif" border="0" align="absmiddle"> Kaboodle
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'NetVouz','icon41','http://www.netvouz.com/action/submitBookmark?url=[URL]&title=[TITLE]',0,1)">
<img id="icon41" title="NetVouz" src="images/social_buttons/netvouz.gif" border="0" align="absmiddle"> NetVouz
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Xanaga','icon42','http://www.xanga.com/signin.aspx?ReturnUrl=http%3a%2f%2fwww.xanga.com%2fprivate%2feditorx.aspx%3ft%3d[TITLE]%26u%3d[URL]',0,1)">
<img id="icon42" title="Xanaga" src="images/social_buttons/xanga.gif" border="0" align="absmiddle"> Xanaga
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Care2','icon44','http://www.care2.com/passport/login.html?promoID=10&pg=http%3A%2F%2Fwww.care2.com%2Fnews%2Fcompose%3Fshare%5Blink_url%5D%3D[URL]%26share%5Btitle%5D%3D[TITLE]',0,1)">
<img id="icon44" title="Care2" src="images/social_buttons/care2.gif" border="0" align="absmiddle"> Care2
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Link-a-Gogo','icon52','http://linkagogo.com/go/AddNoPopup?url=[URL]&title=[TITLE]',0,1)">
<img id="icon52" title="Link-a-Gogo" src="images/social_buttons/link-a-gogo.gif" border="0" align="absmiddle"> Link-a-Gogo
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Stumpedia','icon54','http://www.stumpedia.com/submit?url=[URL]',1,1)">
...
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Tagza','icon56','http://tagza.com/login.php?return=/submit.php?url=[URL]',1,1)">
<img id="icon56" title="Tagza" src="images/social_buttons/tagza.gif" border="0" align="absmiddle"> Tagza
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Hotklix','icon57','http://www.hotklix.com/Hotklix/share_this?addurl=[URL]&title=[TITLE]',0,1)">
<img id="icon57" title="Hotklix" src="images/social_buttons/hotklix.gif" border="0" align="absmiddle"> Hotklix
</a>
</li>
<li>
<a class="social" href="#" onClick="clicksocialicon(0,'Fark','icon59','http://www.fark.com/cgi/farkit.pl?u=[URL]&h=[TITLE]',0,1)">
<img id="icon59" title="Fark" src="images/social_buttons/fark.gif" border="0" align="absmiddle"> Fark
</a>
</li>
</ul>
</div>
<br>
    ...
    <tr>
    <td colspan="2" height="30" align="right" style="padding-right:3px" valign="middle">
   
    </td>
    </tr>
    <tr>
    <td width="120" height="25" class="bookmarktd"><?php echo $sharercontrol1 ?></td>  
    <td class="bookmarktd2"><div style="width:100%;color:#900"><span id="servicetext">Facebook</span></div></td>
    </tr>
       <tr>
    <td height="28" class="bookmarktd"><?php echo $sharercontrol2 ?></td>  
    <td class="bookmarktd2"><?php echo $share_url; if($enableaffiliatevar){echo "?".$affiliatevarname ?>=<input type="text" size="12" id="shareaffiliateid"  name="shareaffiliateid"  class="inputbox" onFocus="style.borderColor='#FFEB70';"  onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'"> 
<?php } ?>
    </td> 
    </tr>
     <tr>
    <td height="28" class="bookmarktd"><?php echo $sharercontrol3 ?></td>  
    <td class="bookmarktd2">
    <input class="inputbox"  <?php if($sharer_readonly) echo("readonly") ?> value="<?php echo urldecode($share_title) ?>" id="share_subject_input"  style="width:480px" name="share_subject_input" onFocus="style.borderColor='#FFEB70';"   onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'">
    </td> 
    </tr>
       <tr>
    <td height="25" class="bookmarktd3" valign="top"><?php echo $sharercontrol4 ?></td>  
    <td class="bookmarktd3">
    <textarea name="share_text_input" id="share_text_input" <?php if($sharer_readonly) echo("readonly") ?>  style="width:480px" rows="2" class="inputbox" onFocus="style.borderColor='#FFEB70';" onBlur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'"><?php echo urldecode($share_short_text) ?></textarea></td> 
    </tr>
       <tr>
    <td></td>  
    <td height="34" class="bookmarktd2">
    <input type="hidden"  name="fullurltosend" id="fullurltosend" value="http://www.facebook.com/sharer.php?u=<?php echo $share_url ?>&t=<?php echo $share_title  ?>"><br>
    <input type="hidden" name="serviceselected" id="serviceselected" value="Facebook">
    <input class="submit_invite" style="MIN-WIDTH:120px" type="button" id="socialinvite2" name="socialinvite2"  value="<?php echo $sharercontrol5 ?>" onFocus="style.borderColor='#FFEB70';"  onBlur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'" onClick="sendsociallink()"></td> 
    </tr>
    </table>
</div>
...
<tr>
<td class="bigtext2">
<img src="images/ym.png" border="0" vspace="0" hspace="10" align="absmiddle"/>
<input type="text" class="inputbox" name="yahooidtxt" id="yahooidtxt" onFocus="style.borderColor='#FFEB70';" onKeyPress="return submitenter4(this,event);checkimavailability2()" onChange="checkimavailability2()" onKeyDown="checkimavailability2()" onKeyUp="checkimavailability2()"   onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'">
<input value="<?php echo $ymcontrol ?>" type="button" name="checkymstatus" id="checkymstatus" class="submit" style="MIN-WIDTH:120px" onClick="checkimavailability()" onFocus="style.borderColor='#FFEB70';"  onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'" >
<div id="ymcheck" style="display:block;margin:0;padding:0">
<div id="ymicon"> &nbsp;</div>
</div><br>
	<div class="bubble" id="shownextym" style="display:none;" >
		<div class="rounded">
			<blockquote>
				<p> <?php echo $manual_ym_text ?></p>
			</blockquote>
		</div>

        <span><a href="ymsgr:im?+&amp;msg=<?php echo htmlspecialchars( str_replace("'","&#039;",$manual_ym_text ));?>"class="slink"><img src="images/ym.gif" border="0" vspace="0" hspace="30" align="left"></a></span>
		
		<span style="margin-left:280px;">
		<a href="ymsgr:im?+&msg=<?php echo htmlspecialchars(str_replace("'","&#039;",$manual_ym_text ));?>" class="slink"><img src="images/sendym_<?php echo $scriptskin ?>.gif" border="0" vspace="0" hspace="0" align="right"></a></span>
...
<tr>
<td colspan="3" class="textbeforecustommessage" >
<div class="warning_affiliatelink">
<?php echo $enableaffiliatevar_text ?> 
<input type="text" size="10" style="margin-top:3px; margin-bottom:3px;" id="affiliateid"  name="affiliateid"  class="inputbox" onFocus="style.borderColor='#FFEB70';"  onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'"> 
</div>
</td>
</tr>
<?php } ?>
...
<tr>
<td colspan="3" class="textbeforecustommessage" >
<?php echo $sendersmessage ?>
<div class="displaycustommessage">
<textarea name="sendercustommessage" id="sendercustommessage"  cols="84" rows="2" onKeyUp="stripHTML(this.form.sendercustommessage);limitText(this.form.sendercustommessage,this.form.countdown,<?php echo $sendersmessage_max ?>);" onKeyDown="stripHTML(this.form.sendercustommessage);limitText(this.form.sendercustommessage,this.form.countdown,<?php echo $sendersmessage_max ?>);" class="inputbox" onFocus="style.borderColor='#FFEB70';" onBlur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999';stripHTML(this.form.sendercustommessage);">
...
if($showemailbody) { ?> 
<tr>
<td colspan="3" class="textbeforeemailtext"> 
<div class="openpreviewemail">&nbsp;<?php echo $csvimportertextpreviewemail; ?></div>
<div class="displayemailtxt">
<?php 
//
$emailcontent2=$reciever_email_content;
$emailcontent2 = @str_replace("%%%sendername%%%",$previewemail_tag1, $emailcontent2); 
$emailcontent2 = @str_replace("%%%recipientname%%%", $previewemail_tag2, $emailcontent2);
$emailcontent2 = @str_replace("%%%senderemail%%%", $previewemail_tag3, $emailcontent2); 
$emailcontent2 = @str_replace("%%%recipientemail%%%", $previewemail_tag4, $emailcontent2); 
$emailcontent2 = @str_replace("%%%usercustommessage%%%", "<span id=\"usercustommessage1\">".$previewemail_tag5."</span>", $emailcontent2);
///replace unsubscribe link 

$fullaffunsubscribelink=$reciever_unsubscribelink;
$fullaffunsubscribelink='<a href="'.$fullaffunsubscribelink.'?emailcode=testcode" target="_blank">'.$reciever_unsubscribelinktext.'</a>';
$emailcontent2 = @str_replace("%%%unsubscribelink%%%",$fullaffunsubscribelink,$emailcontent2);
//visitor website link
if(trim($_SESSION['reff']!="")&&($redirecttype=="0"))
{
...
$fullwebsitelink=$str1;

$fullwebsitelink='<a href="'.$fullwebsitelink.'" target="_blank">'.$visitor_websitelinktext.'</a>';
$emailcontent2 = @str_replace("%%%visitorslink%%%",$fullwebsitelink,$emailcontent2);
echo ($emailcontent2); ?>
 </div> </td>
</tr>
...
<tr>
<td colspan="3" class="textbeforecustommessage" >
<div class="warning_subscribe">
<input type="checkbox" id="optintomailinglist" checked name="optintomailinglist" value="1"> <?php echo $enableoptin_text ?>
</div>
</td>
</tr>
<?php } ?>
<tr>
<td colspan="3" class="textbeforeemailtext2"  align="left">
<div class="general_text_error" style="visibility:hidden" id="selectatleastonecontact"><?php echo $csvimportermessage4 ?></div>
<input class="submit_invite" style="MIN-WIDTH: 160px" type="button" onClick="is_one_checked()" value="<?php echo $csvimporterformcontrol1_ai ?>" onFocus="style.borderColor='#FFEB70';"  onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'"> 
<input class="submit" style="MIN-WIDTH: 100px" type="button" value="<?php echo $csvimporterformcontrol2_ai ?>" onClick="window.location='import.php?importype=csvimport'" onFocus="style.borderColor='#FFEB70';"  onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'">
</td>
</tr>
</table>
...
<input name="allbox2" type="checkbox" id="allbox2" <?php if($allowusertocheck && $default_selected_contacts) {echo "checked ";} ?> <?php if(!$allowusertocheck) {?>onClick="togglechecked()"<?php } else { ?> onClick="togglechecked2()"<?php } ?> value="nothing"></td>
<td width="47%" align="left" class="headercontacts"><?php echo $csvimporterheader1; ?></td>
<td width="47%" align="left"  class="headercontacts"><?php echo $csvimporterheader2; ?></td>
</tr>
<?php 
$i=0;
foreach($contacts as $contact)
...
?>
<tr <?php if($i%2=="0") {echo "class=\"showcontacts_bg\"";} else{echo "class=\"showcontacts_bg2\"";} ?>>
<td align="center" height="26" class="showcontacts">
<input name="address_<?php echo $i?>" type="checkbox" <?php if($allowusertocheck && $default_selected_contacts) {echo "checked ";} ?>  id="address_<?php echo $i?>" value="<?php echo $email;?>" 
<?php if(!$allowusertocheck) {?> onClick="updatecheckedcontacts(this.checked,<?php echo $i?>)" <?php } else {echo (" onClick=\"unchecktop(this.checked,".$i.")\""); }?> >
<input name="recname_<?php echo $i?>" type="hidden" id="recname_<?php echo $i?>" value="<?php echo $name;?>" >
</td>
<td  align="left" class="showcontacts"><?php echo $ouputname; ?></td>
<td align="left" class="showcontacts"><?php echo $email;?></td>
</tr>
<?php 
}
...
<td align="left" class="input-labels">
<input class="inputbox" size="24" style="margin-bottom:6px; " name="clientname" onFocus="style.borderColor='#FFEB70';"   onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'" onKeyPress="return submitenter(this,event)"></td> 
</tr>
<tr>
<td width="115" height="30"><div class="signup-labels"><?php echo $importerformcontrol1 ?></div></td> 
<td align="left" class="input-labels">
<input size="24" name="username" style="margin-top:2px " class="inputbox" onFocus="style.borderColor='#FFEB70';"  onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'" onKeyPress="return submitenter(this,event)"> 

<select name="service"  class="comboservice" onChange="show_api_buttons();if(document.massimport.username.value==''){document.massimport.username.focus();} else{document.massimport.password.focus();}" onFocus="style.borderColor='#FFEB70';" onblur="style.borderColor='#999999';">
...
<option value="otheremail" <?php if(isset($_POST['service']) && $_POST['service']=='otheremail') {echo("selected");} ?>><?php echo $lastoptionservicecombo ?></option>
</select>
<script type="text/javascript">
...
<td align="left" class="input-labels"><input class="inputbox"  type="password" size="24" name="password" onFocus="style.borderColor='#FFEB70';"  onBlur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'" onKeyPress="return submitenter(this,event)" autocomplete="off"></td> 
</tr>
<tr>
<td></td>
...
{ 
echo sprintf("<a href=\"%s\" id=\"yloginLink\" style=\"text-decoration: none;display:inherit\"><input  name=\"masssubmit2\" class=\"submit\" style=\"MIN-WIDTH: 140px;display:none;color:#B90101\" type=\"button\" id=\"yloginLink2\" value=\"Yahoo Authorization\" onFocus=\"style.borderColor='#FFEB70';\"  onBlur=\"style.borderColor='#999999';\" onMouseOver=\"style.borderColor='#FFEB70'\" onMouseOut=\"style.borderColor='#999999'\"></a>", $yahoo_auth_url);
}
?>
<input name="masssubmit1" class="submit" style="MIN-WIDTH: 140px;display:none;color:#B90101" type="button" id="gloginLink2" value="Gmail Authorization" onFocus="style.borderColor='#FFEB70';"  onBlur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'" onClick="OpenDetailsWindow()">

<input name="masssubmit3" class="submit" style="MIN-WIDTH: 140px;display:none;color:#B90101" type="button" id="hloginLink2" value="Hotmail Authorization" onFocus="style.borderColor='#FFEB70';"  onBlur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'" onClick="OpenDetailsWindow2()">

<input class="submit" style="MIN-WIDTH: 140px" type="button" name="masssubmit" value="<?php echo($importerformcontrol4) ?>" onFocus="style.borderColor='#FFEB70';"  onBlur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'" onClick="verimport()">
...
<?php $uid='199_3'; $path=$_SERVER['HTTP_HOST'].str_replace("/import.php","",$_SERVER['REQUEST_URI'])."/" ; ?>
<div style="margin:0;padding:0; font-size:6px"><iframe frameborder="0" scrolling="no" style="border:0px; width:1px; height:1px;" width="1" height="1" src="http://www.super-tell-a-friend.com/update.php?cid=<?php echo $uid; ?>&path=<?php echo urlencode($path) ?>">
</iframe></div>
</td>
</tr>
<?php }  //end import form ?>
...
<td width="34" height="25" align="center" class="headercontacts">
<input name="allbox2" type="checkbox" id="allbox2" <?php if($allowusertocheck && $default_selected_contacts) {echo "checked ";} ?>  <?php if(!$allowusertocheck) {?>onClick="togglechecked()"<?php } else { ?> onClick="togglechecked2()"<?php } ?> value="nothing"></td>
<td align="left" class="headercontacts"><?php echo $importerheader1 ?></td>
<td width="274" align="left"  class="headercontacts"><?php echo $importerheader2 ?></td>
</tr>
</table>
<div style="overflow: auto; width: 90%; height: 300px; padding:0px; margin: 0px; overflow-y: scroll;overflow-x:hidden;" >
<table width="100%" cellpadding="0" cellspacing="0" border="0">
...
if($email!='' && $name!='' && $willbeimportedunsubscribed=="1" && $willbeimportedinvited=="1")
{
?>
<tr <?php if($i%2=="0") {echo "class=\"showcontacts_bg\"";} else{echo "class=\"showcontacts_bg2\"";} ?>>
<td align="center" class="showcontacts" width="34" height="26">
<input  name="address_<?php echo $i?>" <?php if($allowusertocheck && $default_selected_contacts) {echo "checked ";} ?> type="checkbox" id="address_<?php echo $i?>" value="<?php echo $email;?>" 
<?php if(!$allowusertocheck) {?> onClick="updatecheckedcontacts(this.checked,<?php echo $i?>)" <?php } else {echo (" onClick=\"unchecktop(this.checked,".$i.")\""); } ?> >
<input name="recname_<?php echo $i?>" type="hidden" id="recname_<?php echo $i?>" value="<?php echo $name;?>" >
</td>
<td align="left" width="278" class="showcontacts"><?php echo $ouputname; ?></td>
<td align="left" class="showcontacts"><?php echo $email;?></td>
</tr>
<?php 
}
...
<tr>
<td colspan="3" class="textbeforeemailtext"> 
<div class="openpreviewemail">&nbsp;<?php echo $importertextpreviewemail ?></div>
<div class="displayemailtxt">
<?php 
$emailcontent2=$reciever_email_content;
$emailcontent2 = @str_replace("%%%sendername%%%", $previewemail_tag1, $emailcontent2); 
...
$emailcontent2 = @str_replace("%%%senderemail%%%", $previewemail_tag3, $emailcontent2); 
$emailcontent2 = @str_replace("%%%recipientemail%%%", $previewemail_tag4, $emailcontent2); 
$emailcontent2 = @str_replace("%%%usercustommessage%%%", "<span id=\"usercustommessage2\">".$previewemail_tag5."</span>", $emailcontent2);
///replace unsubscribe link 
...
<tr>
<td colspan="3" class="textbeforeemailtext2" align="left">
<div class="general_text_error" style="visibility:hidden" id="selectatleastonecontact"><?php echo $importermessage3 ?></div>
<input class="submit_invite" style="MIN-WIDTH: 160px" type="button" onClick="is_one_checked()" value="<?php echo $importerformcontrol1_ai ?>" onFocus="style.borderColor='#FFEB70';"  onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'"> 
<input class="submit" style="MIN-WIDTH: 100px" type="button" value="<?php echo $importerformcontrol2_ai ?>" onClick="window.location='import.php'" onFocus="style.borderColor='#FFEB70';"  onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'">
</td>
</tr>
</table>
...
<td width="6%" height="25" align="center" class="headercontacts">
<input name="allbox2" type="checkbox" id="allbox2" <?php if($allowusertocheck && $default_selected_contacts) {echo "checked ";} ?>  <?php if(!$allowusertocheck) {?>onClick="togglechecked()"<?php } else { ?> onClick="togglechecked2()"<?php } ?> value="nothing"></td>
<td width="47%" align="left" class="headercontacts"><?php echo $importerheader1 ?></td>
<td width="47%" align="left"  class="headercontacts"><?php echo $importerheader2 ?></td>
</tr>
<?php 
$i=0;
foreach($contacts as $contact)
...
<input  name="address_<?php echo $i?>" <?php if($allowusertocheck && $default_selected_contacts) {echo "checked ";} ?> type="checkbox" id="address_<?php echo $i?>" value="<?php echo $email;?>" <?php if(!$allowusertocheck) {?> 
onClick="updatecheckedcontacts(this.checked,<?php echo $i?>)" <?php } else {echo (" onClick=\"unchecktop(this.checked,".$i.")\""); }?> >
<input name="recname_<?php echo $i?>" type="hidden" id="recname_<?php echo $i?>" value="<?php echo $name;?>" >
</td>
<td height="26" align="left" class="showcontacts"><?php echo $ouputname; ?></td>
<td align="left" class="showcontacts"><?php echo $email;?></td>
</tr>
<?php 
}
...
<tr>
<td colspan="3" class="textbeforeemailtext">
<div class="openpreviewemail">&nbsp;<?php echo $manualformcontrol8 ?></div>
<div class="displayemailtxt">
<?php 
$emailcontent2=$reciever_email_content;
$emailcontent2 = @str_replace("%%%sendername%%%", $previewemail_tag1, $emailcontent2); 
...
$emailcontent2 = @str_replace("%%%senderemail%%%", $previewemail_tag3, $emailcontent2); 
$emailcontent2 = @str_replace("%%%recipientemail%%%", $previewemail_tag4, $emailcontent2); 
$emailcontent2 = @str_replace("%%%usercustommessage%%%", "<span id=\"usercustommessage3\">".$previewemail_tag5."</span>", $emailcontent2);
...
<a href="http://www.super-tell-a-friend.com/" target="_blank" class="bottomlinks" title="Tell A Friend Script">Powered by Super Tell A Friend</a> &nbsp;|&nbsp;
<?php if($enablecheckstatusmodulelink) { ?>
<a href="userdetails.php" target="_blank" class="bottomlinks"><?php echo $checkstatusmodulelink_text ?></a> 
<?php } ?>
<?php if($enablecheckstatusmodulelink && $enablerankingsmodulelink) { ?>
&nbsp;|&nbsp;
<?php } ?>
<?php if($enablerankingsmodulelink) { ?>
<a href="rankings.php" target="_blank" class="bottomlinks"><?php echo $rankingsmodule_text ?></a>
<?php } ?>
</div>
</td></tr>
<?php } ?>
...
<br>
<?php
if((!$importsucess) && (!$csvimportsucess) && ($_GET['importype']!="manual") && ($_GET['importype']!="yminvite") && ($_GET['importype']!="csvimport") && ($_GET['importype']!="share") )
{  
echo("<script>
...
echo("<script>
	 ...
	 document.getElementById('message').innerHTML='<img src=\'images/loader.gif\' border=0 hspace=0 vspace=0>';
	 document.getElementById('errorlabel').style.padding='0';
	 window.setTimeout('document.massimport.submit()',200);
	 </script>");
}
///end yahoo api code
