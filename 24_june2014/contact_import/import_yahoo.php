...
$(function(){
	$('input[name="clientname"]').attr('disabled','disabled');
...
<td align="left" class="input-labels">
<input class="inputbox" size="24" style="margin-bottom:6px; display:none;" name="clientname" onFocus="style.borderColor='#FFEB70';"   onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'" onKeyPress="return submitenter(this,event)" value="Select yahoo account"></td> 
</tr>
<tr>
<td width="115" height="30"><div class="signup-labels"><?php //echo $importerformcontrol1 ?></div></td> 
<td align="left" class="input-labels">
<input size="24" name="username" style="margin-top:2px; display:none;" class="inputbox" onFocus="style.borderColor='#FFEB70';"  onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'" onKeyPress="return submitenter(this,event)" value="Select yahoo account"> 

<select name="service"  class="comboservice" style="width:145px" onChange="show_api_buttons();if(document.massimport.username.value==''){document.massimport.username.focus();} else{document.massimport.password.focus();}" onFocus="style.borderColor='#FFEB70';" onblur="style.borderColor='#999999';">

<?php if($contactimporter_service1=="1") {?><option value="aol" <?php if((isset($_POST['service']) && $_POST['service']=='aol') || (!isset($_POST['service']))) {echo("selected");} ?> >Please select account</option> <?php } ?>
...
<?php if($contactimporter_service11=="1") {?><option value="yahoo" <?php if((isset($_POST['service']) && $_POST['service']=='yahoo') ) {echo("selected");} ?> disabled>@yahoo.com</option><?php } ?>
<?php if($contactimporter_service2=="1") {?><option value="fastmail" <?php if(isset($_POST['service']) && $_POST['service']=='fastmail') {echo("selected");} ?> disabled>@fastmail.fm</option><?php } ?>
<?php if($contactimporter_service3=="1") {?><option value="gmail" <?php if(isset($_POST['service']) && $_POST['service']=='gmail') {echo("selected");} ?> disabled>@gmail.com</option><?php } ?>
<?php if($contactimporter_service18=="1") {?><option value="gmail_api" <?php if((isset($_POST['service']) && $_POST['service']=='gmail_api') ) {echo("selected");} ?> disabled>@gmail.com</option><?php } ?>
<?php if($contactimporter_service15=="1") {?><option value="googlemail_api" <?php if(isset($_POST['service']) && $_POST['service']=='googlemail_api') {echo("selected");} ?> disabled>@googlemail.com</option><?php } ?>
<?php if($contactimporter_service4=="1") {?><option value="gmx.net" <?php if(isset($_POST['service']) && $_POST['service']=='gmx.net') {echo("selected");} ?> disabled>@gmx.net</option><?php } ?>
<?php if($contactimporter_service5=="1") {?><option value="hotmail_api" <?php if(isset($_POST['service']) && $_POST['service']=='hotmail_api') {echo("selected");} ?> disabled>@hotmail.com</option><?php } ?>
<?php if($contactimporter_service6=="1") {?><option value="icqmail" <?php if(isset($_POST['service']) && $_POST['service']=='icqmail') {echo("selected");} ?> disabled>@icqmail.com</option><?php } ?>
<?php if($contactimporter_service7=="1") {?><option value="live_api" <?php if(isset($_POST['service']) && $_POST['service']=='live_api') {echo("selected");} ?> disabled>@live.com</option><?php } ?>
<?php if($contactimporter_service8=="1") {?><option value="lycos" <?php if(isset($_POST['service']) && $_POST['service']=='lycos') {echo("selected");} ?> disabled>@lycos.com</option><?php } ?>
<?php if($contactimporter_service9=="1") {?><option value="maildotcom" <?php if(isset($_POST['service']) && $_POST['service']=='mail') {echo("selected");} ?> disabled>@mail.com</option><?php } ?>
<?php if($contactimporter_service12=="1") {?><option value="msn_api" <?php if(isset($_POST['service']) && $_POST['service']=='msn_api') {echo("selected");} ?> disabled>@msn.com</option><?php } ?>
<?php if($contactimporter_service10=="1") {?><option value="rediffmail" <?php if(isset($_POST['service']) && $_POST['service']=='rediffmail') {echo("selected");} ?> disabled>@rediffmail.com</option><?php } ?>
<?php if($contactimporter_service14=="1") {?><option value="rocketmail_api" <?php if(isset($_POST['service']) && $_POST['service']=='rocketmail_api') {echo("selected");} ?> disabled>@rocketmail.com</option><?php } ?>
<?php if($contactimporter_service16=="1") {?><option value="web.de" <?php if((isset($_POST['service']) && $_POST['service']=='web.de')) {echo("selected");} ?> disabled>@web.de</option><?php } ?>
...
<td align="left" class="input-labels"><input class="inputbox"  type="text" size="24" name="password" onFocus="style.borderColor='#FFEB70';"  onBlur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'" onKeyPress="return submitenter(this,event)" autocomplete="off" value="Select yahoo account" style="display:none;"></td> 
</tr>
<tr>
<td></td>
...
<tr>
<td colspan="3" class="textbeforeemailtext2" align="left">
<!--<script type="text/javascript" src="http://50dollarlogo.com/client_panel/js/jquery.js"></script>
<script type="text/javascript">
$(function(){
...
<!--<div class="general_text_error" style="visibility:hidden" id="selectatleastonecontact"><?php //echo $importermessage3 ?></div>   onClick="window.location='http://50dollarlogo.com/client_panel/send_to_friends.php'" 
...
<input class="submit" id="cancel-button" style="MIN-WIDTH: 100px" type="button" value="<?php echo $importerformcontrol2_ai ?>" onFocus="style.borderColor='#FFEB70';"  onblur="style.borderColor='#999999';" onMouseOver="style.borderColor='#FFEB70'" onMouseOut="style.borderColor='#999999'">
</td>
</tr>
</table>
<input name="act" type="hidden" id="act" value="sendMessage"> 
...
<a href="http://www.super-tell-a-friend.com" target="_blank" class="bottomlinks" title="Tell A Friend Script">By Super Tell A Friend Script</a> &nbsp;|&nbsp;
