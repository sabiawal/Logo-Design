...
{
window.location='http://www.logodesignguarantee.co.uk/contact_import/import.php?importype=import&gmail=import';
clearInterval(detailsWindowTimer); //stop the timer
}
}
function OpenDetailsWindow()
{
var url='https://accounts.google.com/o/oauth2/auth?client_id=365554168779-fd6q97hipru07ovpu02h4sadplfa90r1.apps.googleusercontent.com&redirect_uri=http://www.logodesignguarantee.co.uk/contact_import/oauth.php&scope=https://www.google.com/m8/feeds/ https://www.googleapis.com/auth/userinfo.profile&response_type=code&max_auth_age=0';
...
{
window.location='http://www.logodesignguarantee.co.uk/contact_import/import.php?importype=import&hotmail=import';
clearInterval(detailsWindowTimer2); //stop the timer
}
}
function OpenDetailsWindow2()
{
var url='https://login.live.com/oauth20_authorize.srf?client_id=00000000400FCF00&scope=wl.basic,wl.contacts_emails&response_type=code&redirect_uri=http://www.logodesignguarantee.co.uk/contact_import/hotmailoauth.php';
