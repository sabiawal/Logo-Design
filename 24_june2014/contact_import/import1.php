...
window.top.location = "http://logodesignguarantee.com/client_panel/send_to_friends.php";
}
</script>
<tr>
...
/*if($_POST['service']!='aol'){
mysql_query("INSERT INTO sender_details (email, logoWedId) VALUES ('".$_GET['sender_email']."','".$_GET['logoWebId']."') ");
}else{
mysql_query("INSERT INTO sender_details (email, logoWedId) VALUES ('".$_GET['email']."','".$_GET['logoWebId']."') ");   
}*/
...
//echo $display[1];
//print_r($sum1);
if($domain == '@yahoo.com'){ //echo '4';
$select1 = mysql_query("select * from tbl_designers_post_orders where logo_web_id='".$display[1]."' order by submit_date desc");
$logo_samples = mysql_query("SELECT * from tbl_logo_samples where logo_web_id = ".$display[1]."");	
...
if($_POST['service']!='aol' && $domain != '@yahoo.com'){//echo '5';
$select1 = mysql_query("select * from tbl_designers_post_orders where logo_web_id='".$_SESSION['logoWebId']."' order by submit_date desc");
$logo_samples = mysql_query("SELECT * from tbl_logo_samples where logo_web_id = ".$_SESSION['logoWebId']."");	
echo '<input type="hidden" name="sender_email" id="sumans" value="'.$_SESSION['c_email'].'"/>';
echo '<input type="hidden" name="logo_web_id" id="logoWedId" value="'.$_SESSION['logoWebId'].'"/>';
    }if($_POST['service']=='aol' && $domain != '@yahoo.com'){//echo '6';
...
echo '<input type="hidden" name="sender_email" id="sumans" value="'.$_GET['email'].'"/>';
echo '<input type="hidden" name="logo_web_id" id="logoWedId" value="'.$_GET['logoWebId'].'"/>';
    } 
...
<form method="post" name="all_checkbox" id="sendemailsform">
<?php
//echo 'suman'; print_r($_SESSION);
//echo 'maharjan'; print_r($_SESSION);
//echo '<pre>'; print_r($_GET);
if($domain == '@yahoo.com'){ //echo '1';
$select1 = mysql_query("select * from tbl_designers_post_orders where logo_web_id='".$display[1]."' order by submit_date desc");
$logo_samples = mysql_query("SELECT * from tbl_logo_samples where logo_web_id = ".$display[1]."");	
echo '<input type="hidden" name="sender_email" id="sumans" value="'.$sum1[0].'"/>';
echo '<input type="hidden" name="logo_web_id" id="logoWedId" value="'.$display[1].'"/>';	
}
if($_POST['service']!='aol'){//echo '2';
$select1 = mysql_query("select * from tbl_designers_post_orders where logo_web_id='".$_SESSION['logoWebId']."' order by submit_date desc");
$logo_samples = mysql_query("SELECT * from tbl_logo_samples where logo_web_id = ".$_SESSION['logoWebId']."");	
echo '<input type="hidden" name="sender_email" id="sumans" value="'.$_SESSION['c_email'].'"/>';
echo '<input type="hidden" name="logo_web_id" id="logoWedId" value="'.$_SESSION['logoWebId'].'"/>';
    }if($_POST['service']=='aol' && $domain != '@yahoo.com'){//echo '3';
$select1 = mysql_query("select * from tbl_designers_post_orders where logo_web_id='".$_GET['logoWebId']."' order by submit_date desc");
$logo_samples = mysql_query("SELECT * from tbl_logo_samples where logo_web_id = ".$_GET['logoWebId']."");		
echo '<input type="hidden" name="sender_email" id="sumans" value="'.$_GET['email'].'"/>';
echo '<input type="hidden" name="logo_web_id" id="logoWedId" value="'.$_GET['logoWebId'].'"/>';
...
/*$select1 = mysql_query("select * from tbl_designers_post_orders where logo_web_id='".$_GET['logoWedId']."' order by submit_date desc");
$logo_samples = mysql_query("SELECT * from tbl_logo_samples where logo_web_id = ".$_GET['logoWedId']."");*/
