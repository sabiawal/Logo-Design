...
define('OAUTH_CONSUMER_KEY', 'dj0yJmk9dXhjNzFUYUtvZkFZJmQ9WVdrOU1HVmpVbk5OTm5NbWNHbzlNVFF4TlRBM05qSTJNZy0tJnM9Y29uc3VtZXJzZWNyZXQmeD0xZQ--'); //Consumer Key
define('OAUTH_CONSUMER_SECRET', '0663de1db788d275ff3e28a375b967721d1d773c'); //Consumer Secret
define('OAUTH_DOMAIN', 'https://www.logodesignguarantee.co.uk/client_panel/send_to_friends.php'); //App Domain
define('OAUTH_APP_ID', '0ecRsM6s');

//GMAIL API - please see "readme.html file for details and change these values with yours

$client_id='365554168779-fd6q97hipru07ovpu02h4sadplfa90r1.apps.googleusercontent.com'; //Client ID
$client_secret='SfcTUYdBETjmrjeAAtHCpdFN'; //Client secret
$redirect_uri='http://www.logodesignguarantee.co.uk/contact_import/oauth.php'; //Redirect URIs

///HOTMAIL API - please see "readme.html file for details and change these values with yours
$hotmail_client_id='00000000400FCF00';
$hotmail_client_secret='mrM30orTJFoeGICms2tsx4m5rEI9nDnf';
$hotmail_redirect_uri='http://www.logodesignguarantee.co.uk/contact_import/hotmailoauth.php';
