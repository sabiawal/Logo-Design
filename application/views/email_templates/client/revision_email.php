...
$image_link = $base_url.'assets/images/client/revision_email_theme1/';
  ...
  <tr>
    <td valign="top" height="80"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
        <tr>
          ...
          <td  valign="top" width="100"><img src="'.$image_link.'banner-'.strtolower($site_name).'.png" width="342" height="67" alt="Call Us" title="Call Us"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td><td>&nbsp;</td>
        </tr>
