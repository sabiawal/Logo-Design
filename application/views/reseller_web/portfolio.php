			...
			<section class="slogan">
				<div class="container">
					<h1 style="color: #00b050" class="text-center">
						Our Web Portfolio: December 2013
					</h1>
				</div>
			</section>
			...
			<section id="web-portfolio-body" class="normal-gray-box normal-desc-box">
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-8">
							<h3>Its true...We are so much better: "It's all in the detail..."</h3>
							...
							<p>
								These fine details are critical to get the right response from your customers. Fine details can increase sales or phone conversions by over 50%. It�s all about results right?
							</p>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
						<div class="clearfix">
							...
							<a href="javascript:void(0);" target="_blank"><img src="assets/images/web-portfolio-thumb/10.jpg" alt="web portfolio" /></a>
						</div>
						<div class="bottom clearfix">
							<ul class="info-widget">
								<li>100% Custom Made</li>
								<li>US In House Design Team</li>
								<li>Designed for All Industries</li>
							</ul>
							<div class="web-port-btn">
								<a href="<?php echo base_url('reseller_web') ?>" class="orange-btn">
								...
								<div class="container">
									<div class="row">
										<div class="col-sm-8">
											...
											<p>Most design companies will offer you just 9-5 support. It says little of their commitment to customer service. They just want to keep their costs low. Don�t settle for it!</p>
											<p>We offer in-house phone support 24/7/365. There may be natural glitches to a website, and having 24/7/365 phone support allows you to get the help you deserve. Also, it�s very useful if you want to get your project going fast.</p>
										</div>
										<div class="col-sm-4 text-center no-border-pic-section">
								...
								<div class="container">
									<div class="row">
										<div class="col-sm-8">
											...
											<p>With their new website, not only do they have more time to grow their business but have doubled their client base! The website�s flash animation features have also given them a more professional and well established presence.</p>
										</div>
								...
								<div class="container">
									<div class="row">
										...
										<div class="col-sm-8">
											...
											<p>She was also working a full time job and needed to be able to discuss her design needs when it was convenient for her. Logo Design Guarantee�s 24/7 customer support, affordability and free extra services made her dream become a reality.</p>
										</div>
									</div>
								</div>
							</div>
