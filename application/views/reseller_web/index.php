            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="trapzoid-box guarantee-box">
                        <?php /* ?><h3 style="padding: 46px 0;" class="text-center trapzoid-extent1"><a href="<?php echo base_url('reseller_web/guarantee') ?>">Learn About Our Guarantee</a><?php */ ?>
                        <h3 style="padding: 46px 0;" class="text-center trapzoid-extent1"><a href="<?php echo base_url('reseller_web/howitworks') ?>">Learn How it <br/> Works</a>
                        </h3>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 stack text-center">
                    ...
                    <p>Complete Search Engine <?php
                        $s = 'Optimization';
                        if (COUNTRY == 'UK'): $s = str_replace('z', 's', $s);
                        endif;
                        echo $s;
                        ?> (SEO) is provided with every package. Most design firms will charge extra for this!</p>
