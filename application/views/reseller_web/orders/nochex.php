...
<input type="hidden" name="logo" value="http://<?php echo SITE_NAME; ?>/assets/images/logo.png" />
<input type="hidden" name="returnurl" value="<?php echo base_url().'reseller_web_orders/thankyou?p='.$net_total ?>" />
