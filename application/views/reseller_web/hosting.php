		...
		<section class="content clearfix">
				...
				<div class="container">
					<div class="row">
						<div class="green-vertical-divider clearfix">
							<div class="col-sm-6">
								<p>Web hosting is a type of internet service that allows your business to have content on the internet. This means we provide space on the internet foryou to store the files and content of your website.</p>
							...
							<div class="col-sm-6">
								...
								<p>No web design or hosting company offers hosting services for free. Hosting services typically range from $19 - $59 per month. Other companies will only offer you a limited number of email addresses and will charge you for anyextra you need.</p>
								<p>Most hosting services have a minimum of a 12 month contract which you cannot get out of without paying expensive cancellation fees. We try and keep things simple by roviding <strong> no contracts.</strong></p>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="slogan">
				<div class="container">
					...
					<div class="text-center slogan-tagline">Here are all the details of our hosting plan so you can judge it yourself.</div>
				</div>
			</section>	
			...
			<section id="hosting-details">
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
                                                    <?php $this->load->view('includes/web/hosting-details'); ?>
						</div>
						<div class="col-sm-6">
                                                    <?php $this->load->view('includes/web/website-guaranteed'); ?>						
						</div>
					</div>
				</div>
			</section>
