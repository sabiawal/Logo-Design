...
<div class="elite-head"><h2><?php echo $upgrade_details->package?>  </h2></div>
<div class="silver-text" align="left"> <div class="elite-price">

<span class="old-price">12 custom made logos</span>

<span class="new-elite-price"> <?php echo CURRENCY.$upgrade_details->price?></span>
</div>
...
<div class="silver" align="left" style="margin-left:67px;">
<div class="elite"><h6>Elite package with business card designs</h6></div>
...
<td width="165">
<img src="<?=base_url()?>assets/images/arrow.jpg">
</td>	
<td width="101">
<div align="center">
...
<label><?php echo CURRENCY.$elite_price?></label>
</div>
</div>
</td>
</tr>
...
<td><?=CURRENCY . $upgrade_details->price; ?><input type="hidden" name="current_package_amount" value="<?=$upgrade_details->price; ?>" /></td>
<?php $diff_2 = $elite_plus_price-$upgrade_details->price;?>
<td class="current-last-price"><?=CURRENCY . ($diff_2); ?><input type="hidden" name="upgraded_amount" value="<?=$diff_2?>" />
