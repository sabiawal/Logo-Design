...
$('.newbuttoncontinue').on('click',function(){
...
function extraService(id,sesName1,sesValue1,sesName2,sesValue2) {
	...
	if(extra.checked && !extra.value)
	{
		...
		//alert(totalprice);alert($('#select1').val()); return false;
...
function calculatePrice() {
	...
	$(document).ready(function(){		
		...
		$('.freshbasketEdit').on('click',function(){
			var mainThis = $(this);
			$( "#dialog-confirm" ).dialog({
				resizable: false,
				height:140,
		...
		$('.basketEdit_reselect').on('click',function(){
			//$('.basketEdit').hide();
			//$('.freshbasketEdit').hide();
			...
			{
				$('#tblFloat').append('<tr id="b'+values[1]+'"><td class="basketdesc" align="left" valign="top">'+values[4]+'</td><td class="basketdesc" align="right" valign="top"><img src="<?php echo base_url()?>assets/images/basket-image/remove.gif" class="basketEdit" id="'+values[0]+'___'+values[1]+'___'+values[2]+'___'+values[3]+'___'+values[4]+'"/></td><td class="basketdesc" align="right" valign="top">$'+values[2]+'<input type="hidden" name="priceValue[]" class="pricewala" value="'+values[2]+'"/></td></tr>');
...
<!--<img src="<?php echo base_url()?>assets/images/client/discount.jpg" style="margin-bottom:20px;" />-->
<!--<img src="<?php echo base_url()?>assets/images/50print.jpg" />-->
...
<div class="pages newprints  ">
   <table cellpadding="0" cellspacing="0" border="0" class="table">
              <tbody><tr>
                ...
                <table cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" border="0">
                    <tbody><tr>
                    </tr>
                  </tbody></table>


                  <table class="table" style="margin-top:20px; padding-top:40px;" cellpadding="5" cellspacing="0" align="center" bgcolor="#F8FCE3" border="0" height="50">
                    <tbody><tr>
<!--                      <td class="get-print" width="70">&nbsp;</td>-->
                      <td class="get-print" height="50"  >Get your prints now to enjoy the additional <span style="color:#DB1A77">15% discount!</span></td>
                    </tr>
                  </tbody></table>
                  <table  class="new-tr table" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" border="0" height="150">
                    <tbody><tr>
                      <td align="center" width="70"><img src="<?php echo base_url();?>assets/images/order-process/logo-package-icon12.png" style="padding-top:5px;"></td>
                      <td style="font-size:18px; font-weight:bold; color:#FF0000; " height="25"  ><h1 style="clear:both; color:#03235C; padding:5px; margin:0px;">Order business card prints now</h1></td>
                    </tr>
                    <tr>
                    ...
                    <tr height="30">
                      <td><div align="center">
                          <input id="opt12" name="opta12" type="radio" value="<?php if(@$_SESSION['opt12']==BUSINESS_CARD_PRINT_250_P) echo BUSINESS_CARD_PRINT_250_P;?>" onclick="extraService('opt12','opt12','<?php echo BUSINESS_CARD_PRINT_250_P?>','extraopt12','250 business cards (matt) including free delivery')" <?php if(@$_SESSION['extraopt12']=='250 business cards (matt) including free delivery')?>/>
                          <br>
                      ...
                      <td><h2 style="color:#393;">250 business cards (matt) <u>including</u> free  delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(BUSINESS_CARD_PRINT_250_P*2); ?></del></span> Now only <strong><?= CURRENCY.(BUSINESS_CARD_PRINT_250_P); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                          <input id="opt121" name="opta12" type="radio" value="<?php if(@$_SESSION['opt12']==BUSINESS_CARD_PRINT_500_P) echo BUSINESS_CARD_PRINT_500_P;?>" onclick="extraService('opt121','opt12','<?php echo BUSINESS_CARD_PRINT_500_P?>','extraopt12','500 business cards (matt) including free delivery')" <?php if(@$_SESSION['extraopt12']=='500 business cards (matt) including free delivery') ?>/>
                          <br />
                      ...
                      <td height="56" ><h2 style="color:#393;">500  business cards (matt) <u>including</u> free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(BUSINESS_CARD_PRINT_500_P*2); ?></del></span> Now only <strong><?= CURRENCY.(BUSINESS_CARD_PRINT_500_P); ?></strong></h2></td>
                    </tr>
                  </tbody></table>
                  <table  class="new-tr table" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" border="0" height="150">

                    <tbody><tr>
                      <td align="center" width="70"><img src="<?php echo base_url();?>assets/images/order-process/logo-package-icon13.png" style="padding-top:5px;"></td>
                      <td style="font-size:18px; font-weight:bold; color:#0033CC" height="25"  ><h1 style="clear:both; color:#03235C; padding:5px; margin:0px;">Order letterhead prints now</h1></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                    <tr height="30">
                      <td ><div align="center">
                          <input id="opt131" name="opta13" type="radio" value="<?php if(@$_SESSION['opt13']==LETTER_HEAD_PRINT_25_P) echo LETTER_HEAD_PRINT_25_P;?>" onclick="extraService('opt131','opt13','<?php echo LETTER_HEAD_PRINT_25_P?>','extraopt13','25 letterheads including free delivery')" <?php if(@$_SESSION['extraopt13']=='25 letterheads including free delivery') ?>/>
                          <br />
                      ...
                      <td ><h2 style="color:#393;">25  letterheads including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(LETTER_HEAD_PRINT_25_P*2); ?></del></span> Now only <strong><?= CURRENCY.(LETTER_HEAD_PRINT_25_P); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                          <input id="opt132" name="opta13" type="radio" value="<?php if(@$_SESSION['opt13']==LETTER_HEAD_PRINT_250_P) echo LETTER_HEAD_PRINT_250_P;?>" onclick="extraService('opt132','opt13','<?php echo LETTER_HEAD_PRINT_250_P?>','extraopt13','250 letterheads including free delivery')" <?php if(@$_SESSION['extraopt13']=='250 letterheads including free delivery') ?>/>
                          <br />
                      ...
                      <td height="56" ><h2 style="color:#393;">250 letterheads including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(LETTER_HEAD_PRINT_250_P*2); ?></del></span> Now only <strong><?= CURRENCY.(LETTER_HEAD_PRINT_250_P); ?></strong> (60% OFF)</h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                          <input id="opt133" name="opta13" type="radio" value="<?php if(@$_SESSION['opt13']==LETTER_HEAD_PRINT_1000_P) echo LETTER_HEAD_PRINT_1000_P;?>" onclick="extraService('opt133','opt13','<?php echo LETTER_HEAD_PRINT_1000_P?>','extraopt13','1000  letterheads including free delivery')" <?php if(@$_SESSION['extraopt13']=='1000  letterheads including free delivery') ?>/>
                          <br />
                      ...
                      <td height="56"><h2 style="color:#393;">1000  letterheads including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(LETTER_HEAD_PRINT_1000_P*2); ?></del></span> Now only <strong><?= CURRENCY.(LETTER_HEAD_PRINT_1000_P); ?></strong></h2></td>
                    </tr>
                  </tbody></table>
                  <table  class="new-tr table" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" border="0" height="150">
                    <tbody><tr>
                      <td align="center" width="70"><img src="<?php echo base_url();?>assets/images/order-process/logo-package-icon14.png" style="padding-top:5px;"></td>
                      <td style="font-size:18px; font-weight:bold; color:#0033CC" height="25"  ><h1 style="clear:both; color:#03235C; padding:5px; margin:0px;">Order envelope design prints now</h1></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                    <tr height="30">
                      <td><div align="center">
                          <input id="opt141" name="opta14" type="radio" value="<?php if(@$_SESSION['opt14']==ENVELOPE_DESIGN_PRINT_100) echo ENVELOPE_DESIGN_PRINT_100;?>" onclick="extraService('opt141','opt14','<?php echo ENVELOPE_DESIGN_PRINT_100_P?>','extraopt14','100 envelopes including free delivery')" <?php if(@$_SESSION['extraopt14']=='100 envelopes including free delivery') ?>/>
                          <br />
                      ...
                      <td><h2 style="color:#393;"> 100  envelopes including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(ENVELOPE_DESIGN_PRINT_100_P*2); ?></del></span> Now only <strong><?= CURRENCY.(ENVELOPE_DESIGN_PRINT_100_P); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                          <input id="opt142" name="opta14" type="radio" value="<?php if(@$_SESSION['opt14']==ENVELOPE_DESIGN_PRINT_250_P) echo ENVELOPE_DESIGN_PRINT_250_P;?>" onclick="extraService('opt142','opt14','<?php echo ENVELOPE_DESIGN_PRINT_250_P?>','extraopt14','250  envelopes including free delivery')" <?php if(@$_SESSION['extraopt14']=='250  envelopes including free delivery') ?>/>
                          <br />
                      ...
                      <td height="56"><h2 style="color:#393;">250  envelopes including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(ENVELOPE_DESIGN_PRINT_250_P*2); ?></del></span> Now only <strong><?= CURRENCY.(ENVELOPE_DESIGN_PRINT_250_P); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                          <input id="opt143" name="opta14" type="radio" value="<?php if(@$_SESSION['opt14']==ENVELOPE_DESIGN_PRINT_1000_P) echo ENVELOPE_DESIGN_PRINT_1000_P;?>" onclick="extraService('opt143','opt14','<?php echo ENVELOPE_DESIGN_PRINT_1000_P?>','extraopt14','1000 envelopes including free delivery')" <?php if(@$_SESSION['extraopt14']=='1000 envelopes including free delivery') ?>/>
                          <br />
                      ...
                      <td height="56"><h2 style="color:#393;">1000  envelopes including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(ENVELOPE_DESIGN_PRINT_1000_P*2); ?></del></span> Now only <strong><?= CURRENCY.(ENVELOPE_DESIGN_PRINT_1000_P); ?></strong></h2></td>
                    </tr>
                  </tbody></table>
                  <table  class="new-tr table" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" border="0" height="150">
                    <tbody><tr>
                      <td align="center" width="70"><img src="<?php echo base_url();?>assets/images/order-process/logo-package-icon15.png" style="padding-top:5px;"></td>
                      <td style="font-size:18px; font-weight:bold; color:#0033CC" height="25"  ><h1 style="clear:both; color:#03235C; padding:5px; margin:0px;">Order compliment slip prints now</h1></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                    <tr height="30">
                      <td><div align="center">
                          <input id="opt151" name="opta15" type="radio" value="<?php if(@$_SESSION['opt15']==COMPLIMENT_SLIP_PRINT_100_P) echo COMPLIMENT_SLIP_PRINT_100_P;?>" onclick="extraService('opt151','opt15','<?php echo COMPLIMENT_SLIP_PRINT_100_P?>','extraopt15','100 compliment slips including free delivery')" <?php if(@$_SESSION['extraopt15']=='100 compliment slips including free delivery') ?>/>
                          <br />
                      ...
                      <td><h2 style="color:#393;">100  compliment slips including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(COMPLIMENT_SLIP_PRINT_100_P*2); ?></del></span> Now only <strong><?= CURRENCY.(COMPLIMENT_SLIP_PRINT_100_P); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                          <input id="opt152" name="opta15" type="radio" value="<?php if(@$_SESSION['opt15']==COMPLIMENT_SLIP_PRINT_250_P) echo COMPLIMENT_SLIP_PRINT_250_P;?>" onclick="extraService('opt152','opt15','<?php echo COMPLIMENT_SLIP_PRINT_250_P?>','extraopt15','250 compliment slips including free delivery')" <?php if(@$_SESSION['extraopt15']=='250 compliment slips including free delivery') ?>/>
                          <br />
                      ...
                      <td height="56"><h2 style="color:#393;">250  compliment slips including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(COMPLIMENT_SLIP_PRINT_250_P*2); ?></del></span> Now only <strong><?= CURRENCY.(COMPLIMENT_SLIP_PRINT_250_P); ?></strong></h2></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                          <input id="opt153" name="opta15" type="radio" value="<?php if(@$_SESSION['opt15']==COMPLIMENT_SLIP_PRINT_1000_P) echo COMPLIMENT_SLIP_PRINT_1000_P;?>" onclick="extraService('opt153','opt15','<?php echo COMPLIMENT_SLIP_PRINT_1000_P?>','extraopt15','1000 compliment slips including free delivery')" <?php if(@$_SESSION['extraopt15']=='1000 compliment slips including free delivery') ?>/>
                          <br />
                      ...
                      <td height="56"><h2 style="color:#393;">1000  compliment slips including free delivery</h2>
                        <h2  style="clear:both;"><span style="color:#f00;"><del><?= CURRENCY.(COMPLIMENT_SLIP_PRINT_1000_P*2); ?></del></span> Now only <strong><?= CURRENCY.(COMPLIMENT_SLIP_PRINT_1000_P); ?></strong></h2></td>
                    </tr>
                  </tbody></table>
                  <table  class="new-tr table" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" border="0" height="100">
                    <tbody><tr>
                      <td align="center" width="70"><img src="<?php echo base_url();?>assets/images/order-process/logo-package-icon16.png" style="padding-top:5px;"></td>
                      <td  align="left"   height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order a Mouse Mat with your personal logo on</h2>
                        <h2 style="clear:both;">(free delivery)! <span style="color:#f00;"><del><?= CURRENCY.(MOUSE_MAT_WITH_LOGO_P*2); ?></del></span>. Now only <strong><?= CURRENCY.(MOUSE_MAT_WITH_LOGO_P); ?></strong> Each.</h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                    <tr height="15">
                      <td rowspan="2"><div align="center">
                          <input id="opt16" name="opta16" type="radio" value="<?php if(@$_SESSION['opt16']==MOUSE_MAT_WITH_LOGO_P) echo MOUSE_MAT_WITH_LOGO_P;?>" onclick="extraService('opt16','opt16','<?php echo MOUSE_MAT_WITH_LOGO_P?>','extraopt16','Order a Mouse Mat with your personal logo on (free delivery)!')" <?php if(@$_SESSION['extraopt16']=='Order a Mouse Mat with your personal logo on (free delivery)!') ?>/>
                          <br />
                    ...
                    <tr>
                      <td height="30" ><table cellpadding="0" cellspacing="0" border="0">
                          <tr>
                            ...
                            <td width="68"><p>
                                <select name="select1" id="select1" onchange="javascript:$('#opt16').click().click();">
                  ...
                  <table  class="new-tr table" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3" border="0" height="100">
                    <tbody><tr>
                      <td align="center" width="70"><img src="<?php echo base_url();?>assets/images/order-process/logo-package-icon17.png" style="padding-top:5px;"></td>
                      <td  align="left"   height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order a custom CAP with your personal logo on</h2>
                        <h2 style="clear:both;">(free delivery)! <span style="color:#f00;"><del><?= CURRENCY.(CAP_WITH_LOGO_P*2); ?></del></span>. Now only <strong><?= CURRENCY.(CAP_WITH_LOGO_P); ?></strong> Each.</h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                    <tr height="15">
                      <td rowspan="2"><div align="center">
                          <input id="opt17" name="opta17" type="radio" value="<?php if(@$_SESSION['opt17']==CAP_WITH_LOGO_P) echo CAP_WITH_LOGO_P;?>" onclick="extraService('opt17','opt17','<?php echo CAP_WITH_LOGO_P?>','extraopt17','Order a <u>custom CAP</u> with your personal logo on (free delivery)!')" <?php if(@$_SESSION['extraopt17']=='Order a <u>custom CAP</u> with your personal logo on (free delivery)!') ?>/>
                          <br />
                  ...
                  <table height="100" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3"  class="new-tr table">
                    <tr>
                      <td width="70" align="center"><img src="<?php echo base_url(); ?>assets/images/order-process/pen-offer.png" style="padding-top:5px;"/></td>
                      <td  align="left"   height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order pens with your personal logo on</h2>
                        <h2 style="clear:both;">(free delivery)! <span style="color:#f00;"><del><?= CURRENCY.(PEN_WITH_LOGO_P*2); ?></del></span>. Now only <strong><?= CURRENCY.(PEN_WITH_LOGO_P); ?></strong> Each.</h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                    <tr>
                      <td><div align="center">
                          <input id="opt18" name="opta18" type="radio" value="<?php if(@$_SESSION['opt18']==PEN_WITH_LOGO_P) echo PEN_WITH_LOGO_P;?>" onclick="extraService('opt18','opt18','<?php echo PEN_WITH_LOGO_P?>','extraopt18','Order <u>pens </u>with  your personal logo on (free delivery)!')" <?php if(@$_SESSION['extraopt18']=='Order <u>pens </u>with  your personal logo on (free delivery)!') ?>/>
                          <br />
                  ...
                  <table height="100" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3"  class="new-tr table">
                    <tr>
                      <td width="70" align="center"><img src="<?php echo base_url(); ?>assets/images/order-process/bag-offer.png" style="padding-top:5px;"/></td>
                      <td  align="left"   height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order a cotton carrier bag with your personal logo on</h2>
                        <h2 style="clear:both;">(free delivery)! <span style="color:#f00;"><del><?= CURRENCY.(BAG_WITH_LOGO_P*2); ?></del></span>. Now only <strong><?= CURRENCY.(BAG_WITH_LOGO_P); ?></strong> Each.</h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                    <tr height="30">
                      <td><div align="center">
                          <input id="opt19" name="opta19" type="radio" value="<?php if(@$_SESSION['opt19']==BAG_WITH_LOGO_P) echo BAG_WITH_LOGO_P;?>" onclick="extraService('opt19','opt19','<?php echo BAG_WITH_LOGO_P?>','extraopt19','Order a <u>cotton  carrier bag </u>with your personal logo on (free delivery)!')" <?php if(@$_SESSION['extraopt19']=='Order a <u>cotton  carrier bag </u>with your personal logo on (free delivery)!') ?>/>
                          <br />
                  ...
                  <table height="100" border="0" cellpadding="5" cellspacing="0" bgcolor="#F8FCE3"  class="new-tr table">
                    <tr>
                      <td width="70" align="center"><img src="<?php echo base_url(); ?>assets/images/order-process/tshirt-offer.png" style="padding-top:5px;"/></td>
                      <td  align="left"   height="38" bgcolor="#FFFFFF" class="heading" style="font-size:18px; font-weight:bold;"><h2 class="para">Order a T-shirt with your personal logo on</h2>
                        <h2 style="clear:both;">(free delivery)! <span style="color:#f00;"><del><?= CURRENCY.(TSHIRT_WITH_LOGO_P*2); ?></del></span>. Now only <strong><?= CURRENCY.(TSHIRT_WITH_LOGO_P); ?></strong> Each.</h2></td>
                    </tr>
                    <tr>
                      <td colspan="2"><div class="hr"></div></td>
                    </tr>
                    <tr height="30">
                      <td rowspan="2"><div align="center">
                          <input id="opt20" name="opta20" type="radio" value="<?php if(@$_SESSION['opt20']==TSHIRT_WITH_LOGO_P) echo TSHIRT_WITH_LOGO_P;?>" onclick="extraService('opt20','opt20','<?php echo TSHIRT_WITH_LOGO_P?>','extraopt20','Order  a <u>T-shirt</u> with your personal logo on  (free delivery)!')" <?php if(@$_SESSION['extraopt20']=='Order  a <u>T-shirt</u> with your personal logo on  (free delivery)!') ?>/>
                          <br />
	...
	border-top: none;
            ...
            <!-- <table summary="ShoppingBasket" border="0" cellpadding="0" cellspacing="0" width="365">
              <tbody>
                ...
                <tr>
                  <td colspan="3" class="basketbg2" align="center"><div style="border:1px solid #990000;padding-left:20px;margin:0 0 10px 0;">

<h4>A PHP Error was encountered</h4>

<p>Severity: Notice</p>
<p>Message:  Undefined variable: total</p>
<p>Filename: printings/printing.php</p>
<p>Line Number: 804</p>
...
<p>Severity: Notice</p>
<p>Message:  Undefined variable: discountVal1</p>
<p>Filename: printings/printing.php</p>
<p>Line Number: 805</p>

</div>                    <table border="0" cellpadding="0" cellspacing="0" width="330">
                      <tbody>
                        <tr>
                        ...
                        <tr>
                          <td class="totalpricetxt" colspan="2" align="center" bgcolor="#ffffff"><table width="345" border="0" cellpadding="0" cellspacing="0" class="formtoptext">
                              <tbody>
                                <tr id="subtotal" class="packageDiscount" style="display:none">
                                  ...
                                  <td valign="top" align="right" style="padding-right:10px;" class="basketdesc" colspan="2"><strong>$<span id="subtotalamount">0.00</span></strong></td>
                                </tr>                                
                              </tbody>
                            </table></td>
                        </tr>
                        <tr>
                          <td align="center" colspan="2"><img src="<?php echo base_url()?>assets/images/basket-image/textboxbtm.gif" width="343" height="8"></td>
                        </tr>
                      </tbody>
                    </table></td>
                </tr>
                <tr>
                  <td colspan="3" ><p><img src="<?php echo base_url()?>assets/images/basket-image/basket2.gif" alt="basket-bottom1" width="365" height="17"/></p></td>
                </tr>
              </tbody>
            </table> -->
          </div>
...
<span class="images">
<img src="<?php echo base_url()?>assets/images/webdesign/lst-UK.gif " alt="UK Live Support" title="USA Live Support">
</span>
<p>0800 279 6215</p>
