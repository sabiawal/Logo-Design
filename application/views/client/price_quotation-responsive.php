...
$('.fancybox').fancybox();
  ...
  $('#attachment_image').click(function(){
    $('#attached_files').trigger('click');
  });

$('#attached_files').change(function(){
   $('.image-upload label p').remove();
     var files=$("#attached_files")[0].files;
...
<p class="mbottom">Request a price quotation for additional/new services. </p>
<p> Please type the service/s you wish to be quoted, in the box below.</p>
<p>Remember, we're here 24/7 via phone for sales/support: <strong>0800 279 6215</strong></p>



<textarea class="client_message form-control" name="textarea"></textarea>
...
<div class="image-upload">
    <label for="attached_files" style="cursor: pointer;">
        <img id="attachment_image" src="<?php echo base_url()?>assets/uploadify_old/attachment_image.gif"/>
    </label>

    <input id="attached_files" class="attached_files mbottom" type="file"name="image[]" multiple="miltiple"/>
</div>



<!-- <input type="file" id="attached_files" class="attached_files mbottom" name="image[]" multiple="multiple"/> -->




<a class="fancybox btn btn-success mbottom submitstyle  quo_submit" href="#show_div" >Submit your request now</a>



<div style="display:none;" id="show_div" >
<p style="text-align:center !important;">Your request has been sent. <br/> A representative will contact you <br/> within 24 hours.<br/> Thank you.
</p>
