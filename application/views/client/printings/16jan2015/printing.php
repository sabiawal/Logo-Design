...
function calculatePrice() {
	...
	$(document).ready(function(){		
		...
		$('.basketEdit_reselect').live('click',function(){
			...
			{
				$('#tblFloat').append('<tr id="b'+values[1]+'"><td class="basketdesc" align="left" valign="top">'+values[4]+'</td><td class="basketdesc" align="right" valign="top"><img src="<?php echo base_url()?>assets/images/basket-image/remove.gif" class="basketEdit" id="'+values[0]+'___'+values[1]+'___'+values[2]+'___'+values[3]+'___'+values[4]+'"/></td><td class="basketdesc" align="right" valign="top"><?php echo CURRENCY; ?>'+values[2]+'<input type="hidden" name="priceValue[]" class="pricewala" value="'+values[2]+'"/></td></tr>');
