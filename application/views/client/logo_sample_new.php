...
<h1>Your logo samples </h1>
<img src="../assets/images/submit.png" id="imp-submit" style="display:inline-block"/>&nbsp;&nbsp;&nbsp;&nbsp;<img src="../assets/images/submit_questions.png" id="question-submit" style="display:inline-block"/>
        <br />
        ...
        <form method="post" name="form1" action="<?php echo base_url()?>client_panel/revision" class="sample" id="rate-designeer" onsubmit="return checkForm()">
            ...
            <div>
            <input type="submit" name="submit_revision" id="submit_revision" value="Submit Your Score and Revision Request Now!" />
...
{		
    ...
    <div class="feedbacks">   
        ...
        <div class="feedback_msg">        
            <div class="comment_header">
                <h3 class="">            
                    <strong><?php echo $date = date('D d M Y H:i', strtotime($get_client_message[0]['submit_date'])-(5*60*60)-(45*60));?></strong>
                </h3>
            </div>
...
//if(!empty($samples) or isset($_GET['fortest'])) {	?>
        ...
        <!--<img src="<?php echo base_url(); ?>assets/images/client/submit2.png" id="imp-submit" style="display:inline-block"/>&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url(); ?>assets/images/client/submit_questions.png" id="question-submit" style="display:inline-block"/>
        <br />
        <div style="width:350px; color:#990000; font-size:12px; ">"Attach any documents if desired (optional)"</div><br />
        <div class="feedback-containner" style="margin:10px 0;display:none;" id="feedback-containner">
        <form method="post" name="form1" action="<?php echo base_url()?>client_panel/revision" class="sample" id="rate-designeer" onsubmit="return checkForm()">
