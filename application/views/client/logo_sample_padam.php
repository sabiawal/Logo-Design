  ...
  <div class="main-container">
    <div class="main col2-right-layout">
      <div class="col-main client-panel">
        ...
        <div style="color:#f00;border:1px solid #f00;background-color:#FF6;padding:10px;margin-bottom:20px;"><?php echo $this->session->flashdata('success_message'); ?></div>
<?php } ?>
              ...
              <td><?php
					...
					{					
						...
						if (@fopen(PATH_SAMPLE.'thumb_'.$row['file_one'], "r")) {	 											
                            $path_thumb = PATH_SAMPLE.'thumb_'.$row['file_one']; 
							?>
                            <a class="zoom" rel="group" href="<?php echo PATH_SAMPLE.$row['file_one']; ?>"> <img src="<?php echo $path_thumb ?>" style="border:1px solid #006600; padding:3px;" /></a>
                            <?php
						}
                        else { 
							$path_thumb = PATH_SAMPLE.$row['file_one'];                         
							?>
                            <a class="zoom" rel="group" href="<?php echo PATH_SAMPLE.$row['file_one']; ?>"> <img src="<?php echo $path_thumb ?>" width="180" height="200" style="border:1px solid #006600; padding:3px;" /></a>
                            <?php
						}                 
                    ...
                    {                        
                       //if (@getimagesize(PATH_SAMPLE.'thumb_'.$row['file_one']))
						if (@fopen(PATH_SAMPLE.'thumb_'.$row['file_two'], "r")) {	 											
                            $path_thumb = PATH_SAMPLE.'thumb_'.$row['file_two']; 
							?>
                            <a class="zoom" rel="group" href="<?php echo PATH_SAMPLE.$row['file_two']; ?>"> <img src="<?php echo $path_thumb ?>" style="border:1px solid #006600; padding:3px;" /></a>
                            <?php
						}
                        else { 
							$path_thumb = PATH_SAMPLE.$row['file_two'];                         
							?>
                            <a class="zoom" rel="group" href="<?php echo PATH_SAMPLE.$row['file_two']; ?>"> <img src="<?php echo $path_thumb ?>" width="180" height="200" style="border:1px solid #006600; padding:3px;" /></a>
                            <?php
						}      
                    }
                    ...
                    {                        
						...
						if (@fopen(PATH_SAMPLE.'thumb_'.$row['file_three'], "r")) {	 											
                            $path_thumb = PATH_SAMPLE.'thumb_'.$row['file_three']; 
							?>
                            <a class="zoom" rel="group" href="<?php echo PATH_SAMPLE.$row['file_three']; ?>"> <img src="<?php echo $path_thumb ?>" style="border:1px solid #006600; padding:3px;" /></a>
                            <?php
						}
                        else { 
							$path_thumb = PATH_SAMPLE.$row['file_three'];                         
							?>
                            <a class="zoom" rel="group" href="<?php echo PATH_SAMPLE.$row['file_three']; ?>"> <img src="<?php echo $path_thumb ?>" width="180" height="200" style="border:1px solid #006600; padding:3px;" /></a>
                            <?php
						}      
                    }
                    ...
                    {                        
						...
						if (@fopen(PATH_SAMPLE.'thumb_'.$row['file_four'], "r")) {	 											
                            $path_thumb = PATH_SAMPLE.'thumb_'.$row['file_four']; 
							?>
                            <a class="zoom" rel="group" href="<?php echo PATH_SAMPLE.$row['file_four']; ?>"> <img src="<?php echo $path_thumb ?>" style="border:1px solid #006600; padding:3px;" /></a>
                            <?php
						}
                        else { 
							$path_thumb = PATH_SAMPLE.$row['file_four'];                         
							?>
                            <a class="zoom" rel="group" href="<?php echo PATH_SAMPLE.$row['file_four']; ?>"> <img src="<?php echo $path_thumb ?>" width="180" height="200" style="border:1px solid #006600; padding:3px;" /></a>
                            <?php
						}      
                    }                    
                    ?></td>
...
<script language="javascript">
  ...
  <div class="footer-container">
    <div class="footer">
      <?php $this->load->view('includes/client/footer.php') ?>
    </div>
  </div>
</div>
</body>
