...
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/js/fancybox/jquery.fancybox-1.2.6.css" media="screen" />
<script type="text/javascript" src="<?php echo base_url()?>assets/js/fancybox/jquery.fancybox-1.2.6.pack.js"></script>
...
<div class=" col-md-12" id="reload-page">   
<div class="showcase-text">
<p class="big-text"><span><?php if($this->session->flashdata('success_message')){echo $this->session->flashdata('success_message');}?>Showcase</span> your logo samples to your<br /> friends and contacts!</p>
...
<!-- <div class="main-container container border-new-down client-panel" > -->
...
<div class="col-md-4 side-bar">
 ...
 <form class="check_this6" action="<?php echo base_url()?>client_panel/logo_send_mail" name="check_this6" method="post">   
<p class="text_area" ><textarea id="contents" class="newhh" name="contents" style="width: 100%; height: 400px !important;" rows="30"><p>Dear Friends,</p><p><i>Hopefully you can help...</i></p><p>The images below are my logo samples for my new business.</p><p>I would appreciate any feedback you may wish to give me.</p><p>You can vote for your best one!<br /></p><p>You can also score each logo sample out of 10.</p><p>This will help me to get my perfect logo.</p><p>Thank you kindly,</p></textarea></p>
<div class="bd" id="text-hide">
    <ul id="receiver_dtl" class="std reciver">
<p class="text_area">
<textarea class="form-control" rows="10" id="business_aim" name="business_aim" placeholder="<p>Business aims (what image your logo is trying to project) >Inform your friends what you are trying to achieve so they can help with their feedback.</p><p>Optional* You can leave this part blank and this whole area will not be shown to your friends.</p>"></textarea>
</p>      
    </ul>
  </div>
</form>
...
CKEDITOR.plugins.addExternal( 'confighelper', '<?php echo base_url()?>assets/js/plugin.js' );
...
<div class="save-message" id="">Save Message</div><br>
...
<?php 
//print_r($_SESSION);
$my_Datas_1 = $this->db->query("select * from tbl_logo_samples where sent_to = 'client' and sample_type='logo' and logo_web_id=".$_SESSION['logoWebId']." ORDER BY id ASC")->result();
// echo "<pre>";print_r($my_Datas_1);
...
// $my_Datas_1 = $my_Datas_1;
if(count($my_Datas_1)>0){ 
foreach($my_Datas_1 as $qry)
{ 
if(!empty($qry->sample_name))  {  
?>
<li id="logo_select" value="<?php echo rawurlencode($qry->sample_name)?>">
<img src="http://50dollarlogo.com/admin_panel/sample/thumb_<?php echo rawurlencode($qry->sample_name);?>" title="<?php echo rawurlencode($qry->sample_name);?>" height="140px" width="140px" class="select-this" />
...
<form action="<?php echo base_url()?>client_panel/logo_send_mail" method="post" name="check_this3" class="check_this3" id="cardsendfrm">
...
<iframe id="contacts-imp" src="<?php echo base_url();?>contact_import/iframe_load.php?user_email=<?php echo $user_email;?>&logoWebId=<?php echo $_SESSION['logoWebId'];?>" width="100%" height="180" scrolling="auto" frameborder="0" style="border:0px #FFFFFF;overflow-x: hidden; overflow-y: auto;" name="Gmail Frame" marginheight="0" onload='javascript:resizeIframe(this);'>

<!-- <iframe  id="contacts-imp" src="<?php echo base_url()?>contact_import/iframe_load.php?user_email=reena.designoffshore@gmail.com&logoWebId=83689&array%5B0%5D=p1a8lg6p1s3om1gsckid1pqfmo37.png&array%5B1%5D=p1a8ljb86sdkv6em1b7q1v7k1nmr7.jpg&array%5B2%5D=p1a8nutcivasks2qd8ne6a1tuk7.jpg&array%5B3%5D=p1a9hra8r61ni31mgrmrjrt9h867.jpg&array%5B4%5D=p1a9hra8r6127tgoh14v81s7r1m4v8.png&array%5B5%5D=p1a9hrar3l2voi5htqn1f792j1b.jpg&array%5B6%5D=p1a9hrar3m1ret4ea124e124b6jec.png&array%5B7%5D=p1a9hs8ds0od74butat1tqp11f0i.jpg&array%5B8%5D=p1a9hs8ds01of5533s4ukmq1qkbj.jpg&array%5B9%5D=p1a9hs8ds0lq7169qvl5ieg1vqvk.jpg&array%5B10%5D=p1a9hs8ds017ko6n116vr1m081hokl.jpg&array%5B11%5D=p1a9hs8ds0tpbrop12fa163140fm.jpg&array%5B12%5D=p1a9hs8ds0a96n751lqba2athln.jpg&array%5B13%5D=p1a9hs8ds01gl11uu11h4n164hgbo.jpg&array%5B14%5D=p1a9hs8388nnh1fhc1uqflmv18fv7.jpg&array%5B15%5D=p1a9hs8388hbu105r1jjb96i1vv8.jpg&array%5B16%5D=p1a9hs8388nkj6jn1slc5ncj4f9.jpg&array%5B17%5D=p1a9hs8389a70rie1tui4191lcta.jpg&array%5B18%5D=p1a9hs8389vsb2dd4u710k010drb.jpg&array%5B19%5D=p1a9hs8389d63vum1ktf1l9517ufc.jpg&array%5B20%5D=p1a9hs8389q8dcckif9cq11vrud.jpg" frameborder="0" style="border:0px #FFFFFF; overflow-x:scroll;" width="100%" name="Gmail Frame" marginheight="0" onload='javascript:resizeIframe(this);'> -->
</iframe>
</div>
...
<li><input name="addemail[]" id="addemail1" class="add_email" placeholder="Add Receiver Email Address" type="text" value=""  style="margin:5px 9px 5px 35px; height:22px; width:230px;"></li>
...
<form action="<?php echo base_url()?>client_panel/logo_send_mail.php" method="post" name="check_this4" class="check_this4" id="cardsendfrm"  onsubmit="merge(); return true;">
