...
<style type="text/css">
body{
	background:#BABCBD url(<?= base_url(); ?>assets/images/client/bg-body.gif) repeat-x;	
	}
	.client-login{
        background: #0492BA;
		...
		.client-login p label{
			...
			.buttom{
				background:url(<?= base_url(); ?>assets/images/client/log_in.png) no-repeat;
				border:none;
				cursor:pointer;
				margin:0 50px 0 0;
				padding:10px 25px;
                ...
                input.buttom:hover{
				background:url(<?= base_url(); ?>assets/images/client/log_in.png) 0 -36px no-repeat;
				border:none;
				cursor:pointer;
				margin:0 50px 0 0;
				padding:10px 25px;
