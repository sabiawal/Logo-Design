      ...
      <h1>Almost Done!...</h1>
        ...
        <div class="form-wrap">
            ...
            <div style="border: 1px solid #ccc; margin-bottom: 5px;">
                ...
                <span ><?= (isset($fullName) && $fullName != "") ? $fullName : "-"; ?></span>
                </div>
                <div class="label-wrap">
                <span class="labeltext"><label>Organization Name</label></span>
                <span ><?= (isset($orgName) && $orgName != "") ? $orgName : "-"; ?></span>
                </div>
            ...
            <div style="border: 1px solid #ccc; margin-bottom: 5px;">
                ...
                <span ><?= (isset($street) && $street != "" ) ? $street : "-"; ?></span>
                </div>
                
                <div class="label-wrap">
                <span class="labeltext"><label>City</label></span>
                <span ><?= (isset($city) && $city != "" ) ? $city : "-"; ?></span>
                </div>
                
                <div class="label-wrap">
                <span class="labeltext"><label>State</label></span>
                <span ><?= (isset($state) && $state != "") ? $state : "-"; ?></span>
                </div>
                
                <div class="label-wrap">
                <span class="labeltext"><label>Zip Code/Postcode</label></span>
                <span ><?= (isset($zipOrPostCode) && $zipOrPostCode != "" ) ? $zipOrPostCode : "-"; ?></span>
                </div>
                
                <div class="label-wrap">
                <span class="labeltext"><label>Country </label></span>
                <span ><?= (isset($country) && $country != "") ? $country : "-"; ?></span>
                </div>
                <div class="label-wrap">
                <span class="labeltext"><label>Citizenship </label></span>
                <span ><?= (isset($citizenship) && $citizenship != "") ? $citizenship : "-"; ?></span>
                </div>
                
                <div class="label-wrap">
                <span class="labeltext"><label>Domicile </label></span>
                <span ><?= (isset($domicile) && $domicile != "") ? $domicile : "-"; ?></span>
                </div>
            </div>
        ...
        <a href="javascript:popUp('<?= site_url('cvv')?>')" style="float: right;">The CVV Number is the last 3 digits found on the back of your debit or credit card. </a></span>
                ...
                <div class="label-wrap">
                <span class="text-red text-11"><strong>Note:</strong> Please re-check your Mailing Detail Before Proceed To Pyament. <br /> Thank You!</span>
                </div>                
                <div class="label-wrap">
