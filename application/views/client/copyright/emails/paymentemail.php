            ...
            <td><table width="625" class="aa" style="border:1px solid #cccccc; margin:10px;" >
                <tr>
                  ...
                  Dear '.$name.',<br />
                    ...
                    <br />
                    <a href="http://'.SITE_NAME.'/client_panel/'.$payment_path.'.php?copyright_id='.$_SESSION['copyright_id'].'&amp;authentication_code='.$_SESSION['authentication_code'].'" target="_blank"><img src="http://'.SITE_NAME.'/images/payment.gif" width="396" height="94" alt="payment" /></a><br />
...
<br />
<a href="http://www.'.SITE_NAME.'/client_panel/'.$payment_path.'.php?copyright_id='.$_SESSION['copyright_id'].'&amp;authentication_code='.$_SESSION['authentication_code'].'" target="_blank"><img src="http://'.SITE_NAME.'/images/payment.gif" width="396" height="94" alt="payment" /></a><br /><br />
