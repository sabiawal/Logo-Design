...
<script src="<?php echo base_url()?>assets/widgEditor/scripts/widgEditor.js"></script>
...
<style type="text/css" media="all">
	@import "<?php echo base_url()?>assets/widgEditor/css/main.css";
	@import "<?php echo base_url()?>assets/widgEditor/css/widgEditor.css";
</style>
...
.success_message {
    ...
    background-repeat: no-repeat;
    background-image: url(assets/images/social_icons/success.png);
    color: #4F8A10;
	border: 1px solid;
    cursor: pointer;
...
?>
<?php $this->load->view("includes/reseller/analytics.php"); ?>
<!--[if lt IE 8]>
...
<?php $this->load->view("includes/logovote/header.php"); ?>
</div>
...
<img src="<?= base_url(); ?>assets/images/logovote/thank-you.jpg" alt="" title="" />
...
if(!empty($sample_files) || !empty($select1)){
for($i=0;$i<$ssss;$i++)
{
...
<input type="image" src="<?= base_url(); ?>assets/images/logovote/vote.png" class="send-vote" id="submit-rating" name="send-vote">
<br /><br />
...
<br/>
<input type="image" src="<?= base_url(); ?>assets/images/logovote/feedback.png" class="send-feedback" id="sumbit-feedback" name="send-feedback"/>
<br /><br /><br /><br />
