...
<?php //include_once("includes/logo-design/analytics.php"); 
 $this->load->view('includes/logo-design/analytics');
?>
<!--[if lt IE 8]>
...
<div class="wrapper">
    <div class="header-container">
        <?php 
        //include_once("includes/new44/header-common.php");
 $this->load->view('includes/new44/header-common');
 ?>
    </div>
    <div class="top-container">
        <div class="top">
        <?php @include_once("includes/new44/menu-banner.php"); 
// @$this->load->view('includes/new44/menu-banner');
        ?>
        </div>
    </div>
...
// $this->load->view('includes/new44/small-slider.php');
?>
...
if(isset($c_id) && $c_id!="")//checking for client panel login
{
    ...
    $this->load->view('includes/client/sidebar-1');
	?>
    ...
    $this->load->view('includes/client/sidebar-2');
}
else
{ 
...
<?php  if(isset($c_id) && $c_id !=""): ?>
    ...
    $this->load->view('includes/client/copyright');?>
<?php endif; ?>
...
$this->load->view('includes/logo-design/seal-top.php');
?>
</div>
</div>
...
$this->load->view('includes/new44/footer.php');
