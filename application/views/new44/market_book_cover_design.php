		...
		<section class="content">
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">
						Turn the most vicious of Non-readers into your most avid
						<br />
						<span class="theme-red">Bookworms!</span>
					</h1>
				</div>
			</section>
			...
			<section class="normal-desc-box normal-top-gray-border no-pad-bottom">
				<div class="container">
					<h5 class="bf-med-title text-center">
						If you're making a book, and you want it to look appealing to your targets, look no further.
						<br />
						We can assist you in making that Book Cover that everyone will be scampering to get.
					</h5>
				</div>
			</section>
			...
			<section class="normal-desc-box no-pad-bottom">
				<div class="container">
					<div class="row">
						<div class="col-sm-8">
							<p>Kids these days only play computer games. They aren't much into outdoor games anymore. Young adults mostly focus on their social lives. Parties, all that stuff. They almost don't read anymore.</p>
							<p>And the numbers of readers are dwindling.</p>
							<p>Yes, it's a tough market. In order to be successful, like other markets, you need <strong>great presentation.</strong></p>
							<p>And that's precisely what we can give you, at very affordable prices.</p>
							<p>Get started by calling us <span style="text-decoration: underline;">today.</span></p>
							<div class="row">
								<ul id="featured-logo-coll" class="clearfix">
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/book-cover1.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/book-cover2.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/book-cover3.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/book-cover4.jpg" alt="" /></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-orange">Silver</h2>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-blue">Gold</h2>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-green">Platinum</h2>
