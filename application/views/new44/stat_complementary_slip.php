		...
		<section class="content">
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">
						Express your ideas in a <span class="theme-red">short</span> yet
						<br />
						<span class="theme-red">hard-hitting</span> way.
					</h1>
				</div>
			</section>
			...
			<section class="normal-desc-box normal-top-gray-border no-pad-bottom">
				<div class="container">
					<h5 class="bf-med-title text-center">
						All you need is to have your compliment slips!
					</h5>
				</div>
			</section>
			...
			<section class="normal-desc-box no-pad-bottom">
				<div class="container">
					<div class="row">
						<div class="col-sm-8">
							<p>Compliment slips are stationeries used to communicate with customers with a smaller format. It has all logo imagery and contact details that represent your company.</p>
							<p>All you need is to <span style="font-style: italic;">scribble</span> some few words and it will be ready for sending.</p>
							<p>But with a well-designed compliment slip, those few <span style="font-style: italic;">scribbles</span> will look moreimpressive, and respectable, even.</p>
							<p>Grab one <span style="text-decoration: underline;">now</span> for an easier yet moreeffective way to communicate!</p>
							<div class="row">
								<ul id="featured-logo-coll" class="clearfix">
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/complementary-slip1.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/complementary-slip2.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/complementary-slip3.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/complementary-slip4.jpg" alt="" /></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-orange triple">Basic Complimentary Slip Size (210mm x 99mm)</h2>
							<div class="body orange clearfix">
								...
								<ul class="detail">
									...
									<li>For personal <strong>or</strong> business use.</li>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-blue triple">Standard Complimentary Slip Size (210mm x 99mm)</h2>
							<div class="body blue clearfix">
								...
								<ul class="detail">
									<li><strong>6</strong> design samples.</li>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-green triple">Pro Complimentary Slip (Any Custom Size)</h2>
							<div class="body green clearfix">
								...
								<ul class="detail">
									<li><strong>12</strong> design samples.</li>
