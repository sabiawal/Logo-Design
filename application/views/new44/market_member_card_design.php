		...
		<section class="content">
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">
						Send a big influx of revenue with more people applying for
						<br />
						membership cards!
					</h1>
				</div>
			...
			<section class="normal-desc-box normal-top-gray-border no-pad-bottom">
				<div class="container">
					<h5 class="bf-med-title text-center">
						If you have a great Membership Plan, you can make joining up for membership more appealing with
						<br />
						the bonus of having an attractive Membership Card.
					</h5>
				</div>
			</section>
			...
			<section class="normal-desc-box no-pad-bottom">
				<div class="container">
					<div class="row">
						<div class="col-sm-8">
							<p>Even the best membership plans can be so unattractive, and the worst ones so appealing.</p>
							<p>The secret lies in the design of your membership cards.</p>
							<p>No matter how good your membership benefits are, your membership card must be something your customer could show off to his friends.</p>
							<p style="font-style: italic;">Along with the benefits, the looks of the card can attract more people.</p>
							<p>Even if you don't have many benefits for your members, if your card looks cool, people will be attracted to membership in your company.</p>
							<p>We'll give you membership card designs that can do just that.</p>
							<p>Call us <span style="text-decoration: underline;">today.</span></p>
							<div class="row">
								<ul id="featured-logo-coll" class="clearfix">
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/membership-card1.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/membership-card2.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/membership-card3.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/membership-card4.jpg" alt="" /></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-orange double">One sided Matte Membership Card</h2>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-blue double">Two sided Matte Membership Card</h2>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-green double">Two sided Glossy Membership card</h2>
