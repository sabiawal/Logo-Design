		...
		<section class="content">
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">
						Transform your mag from not...
						<br />
						To <span class="theme-red">hot.</span>
					</h1>
				</div>
			</section>
			...
			<section class="normal-desc-box normal-top-gray-border no-pad-bottom">
				<div class="container">
					<h5 class="bf-med-title text-center">
						If your magazine lacks that 'appeal,' or you're looking to publish a new magazine...
						<br />
						Get our award-winning team to make you your totally rad, new Magazine Cover designs.
					</h5>
				</div>
			</section>
			...
			<section class="normal-desc-box no-pad-bottom">
				<div class="container">
					<div class="row">
						<div class="col-sm-8">
							<p>Unlike books, which primarily focus on text, magazines bank on the balance between visuals and text.</p>
							<p>Needless to say, visuals are <strong>important.</strong> And, the cover's visuals have the job of grabbing the attention of your potential readers.</p>
							<p>Be on equal footing with the big names in magazine publication with the help of our designers, available 24/7.</p>
							<p>Just give us a <span style="text-decoration: underline;">call</span>, and we'll help you get to the top.</p>
							<div class="row">
								<ul id="featured-logo-coll" class="clearfix">
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/mag-cover1.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/mag-cover2.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/mag-cover3.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/mag-cover4.jpg" alt="" /></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-orange">Bronze</h2>
							<div style="min-height: 460px;" class="body orange clearfix">
								...
								<ul class="detail">
									...
									<li><strong>Unlimited</strong> pictures.</li>
									<li><strong>Unlimited</strong> revisions.</li>
									<li>Designs are totally in house creativity by <strong>highly</strong> professional designers.</li>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-blue">Silver</h2>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-green">Gold</h2>
