		...
		<section class="content">
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">
						Get the <span class="theme-red">most</span> out of your advertisement!
					</h1>
				</div>
			</section>
			...
			<section class="normal-desc-box normal-top-gray-border no-pad-bottom">
				<div class="container">
					<h5 class="bf-med-title text-center">
						If you want the <span class="theme-red">right medium</span> of advertisement to achieve that desired return of investment...
					</h5>
				</div>
			</section>
			...
			<section class="normal-desc-box no-pad-bottom">
				<div class="container">
					<div class="row">
						<div class="col-sm-8">
							<p>If you think that putting up posters is not an effective marketing strategy, well, you might want to think again.</p>
							<p style="font-style: italic;">Posters are easy to digest; people process images much faster than they process words.</p>
							<p>A good poster in a good position can generate enormous profits.</p>
							<p>Call us now, and our team of award-winning designers will attend to your poster needs.</p>
							<div class="row">
								<ul id="featured-logo-coll" class="clearfix">
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/poster-d1.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/poster-d2.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/poster-d3.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/poster-d4.jpg" alt="" /></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-orange">Silver Poster</h2>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-blue">Gold Poster</h2>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-green">Platinum Poster</h2>
