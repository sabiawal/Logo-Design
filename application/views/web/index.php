        ...
        <section class="content">
			<div id="banner-bottom-slogan">
				<div class="container">
					<div class="row">
						<div class="col-sm-8">
							<h3>All Packages Include | Aswin has entered</h3>
							<div class="we-care-about-you clearfix">
								
								<ul>
									<li>UK in-house designers</li>
						...
						<div class="col-sm-4">
							<div class="trapzoid-box guarantee-box">
								<h3 style="padding: 46px 0;" class="text-center trapzoid-extent1"><a href="<?php echo base_url()?>web-site-design/webdesigner-limited-sale">See Our Packages</a>
								</h3>
							</div>
						</div>
					</div>
			...
			<?php /*?><section id="websites-packages">
				<div class="container">
					<div class="row">
						<div class="col-lg-9">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-6 stack text-center">
							...
							<p>We also offer unlimited, 9am-9pm phone support, for life.</p>
							<div class="text-center">
