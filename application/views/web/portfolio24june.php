...
websites for you for any industry.</p>
			...
			<section id="web-portfolio-thumb">
				<div class="container">
					<div class="row">
						<div class="clearfix">
							<a href="http://arsvitrum.co.uk" target="_blank"><img src="assets/images/web-portfolio-thumb/1.jpg" alt="web portfolio" /></a>
							<a href="http://bermudezhenson.com" target="_blank"><img src="assets/images/web-portfolio-thumb/2.jpg" alt="web portfolio" /></a>
							<a href="http://odinnetmarketingandsales.com" target="_blank"><img src="assets/images/web-portfolio-thumb/3.jpg" alt="web portfolio" /></a>
							<a href="http://totalcomputerrepair.net" target="_blank"><img src="assets/images/web-portfolio-thumb/4.jpg" alt="web portfolio" /></a>
							<a href="http://costcontrolsystems.com" target="_blank"><img src="assets/images/web-portfolio-thumb/5.jpg" alt="web portfolio" /></a>
							<a href="http://tlotm-aof.org" target="_blank"><img src="assets/images/web-portfolio-thumb/6.jpg" alt="web portfolio" /></a>
							<a href="http://sellthiscar.co.uk" target="_blank"><img src="assets/images/web-portfolio-thumb/7.jpg" alt="web portfolio" /></a>
							<a href="http://creativeneurorehab.com" target="_blank"><img src="assets/images/web-portfolio-thumb/8.jpg" alt="web portfolio" /></a>
							<a href="http://paulalvltd.co.uk" target="_blank"><img src="assets/images/web-portfolio-thumb/9.jpg" alt="web portfolio" /></a>
							<a href="http://rivage.co.uk" target="_blank"><img src="assets/images/web-portfolio-thumb/10.jpg" alt="web portfolio" /></a>
						</div>
				...
				<div id="web-portfolio-tab-inner">
					...
					<div class="container">
						<div class="row">
							<ul class="nav nav-tabs col-sm-offset-3" id="package-tab">
								<li class="active"><a href="#cutomer-question" data-toggle="tab">Customer Questions</a></li>
					...
					<div class="tab-content clearfix">
						<div class="tab-pane fade in active" id="cutomer-question">
								...
								<div class="container">
									<div class="row">
										<div class="col-sm-8">
											...
											<strong style="font-size: 16px; margin: 0 0 15px; display: block;">A. Here are the top 3 things we offer you that other companies don't.</strong>
							...
							<?php /*?><div class="normal-gray-box normal-desc-box clearfix">
								<div class="container">
									<div class="row">
										<div class="col-sm-4 text-center no-border-pic-section">
							...
							<div class="normal-desc-box clearfix">
								<div class="container">
									...
									<div class="col-sm-4 text-center no-border-pic-section">
                                        ...
                                        <div class="col-sm-8">
											<h2 class="two">Yes, we have a large and well established team so we can offer you 24/7/365 phone support!</h2>
							...
							<div class="normal-gray-box normal-desc-box clearfix">
								<div class="container">
									<div class="row">
                                    <div class="col-sm-8">
											<h2 class="three">You can speak to the following specialists on the phone... your web designer(s), programmer, logo designer and SEO/Marketing specialist.</h2>
