		...
		<section class="content clearfix">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="trapzoid-box about-box">
                                ...
                                <h3 class="text-center"><a href="<?php echo base_url('web-site-design/webdesigner-limited-sale/howitworks') ?>">Learn more about How it Works</a></h3>
							</div>
						</div>
					</div>
				</div>
			...
			<section id="hosting-details">
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<?php $this->load->view('includes/web/hosting-details.php'); ?>
						</div>
						<div class="col-sm-6">
							<?php $this->load->view('includes/web/website-guaranteed.php'); ?>
						</div>
					</div>
				</div>
			</section>
