...
<?php $this->load->view('includes/web/header-common'); ?>
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						...
						<form id="web-order-process" action="<?php echo site_url('web-site-design/webdesigner-limited-sale/orders/extramid'); ?>" method="post" name="web_order_process">
							...
							<ul>
								<li>
									...
									<div class="field-box right">
										...
										<span class="note notetwo">No text or images is needed at this stage. We will be in touch with you with more detailed information in this regard.</span>
									</div>
								</li>
								<li>
									<div class="field-box left">
						...
						<div class="text-center iphonefix">
							<p>For more information about the logo packages we offer, then <strong><a href="<?php echo base_url('packages#package-pg-body'); ?>">click here.</a></strong></p>
						...
						<div class="normal-desc-box text-center">
							<a class="green-btn order-back-btn" href="<?php echo base_url('web-site-design/webdesigner-limited-sale') ?>">
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/uploadify.css">
             <style>
        .delImg {
			background:url(assets/images/delete1.png);
			border-radius: 6px;
    float: left;
    height: 16px; 
	 cursor: pointer;
	 ...
	 border-radius: 10px;}
        ...
        <script type="text/javascript">
    		...
    		$(function() {
    			...
    			$('#attachment').uploadify({
                    ...
                    onUploadSuccess : function(file, data, response) {	
                        //alert('File: '+file + " data: "+data+' response:'+response);
							$('.notetwo').empty().append('<div  ><p class="filekoname" >'+data+' - Uploaded </p><span class="delImg" data-id="'+data+'"></span></div>');			
				...
				var _img = $(this).attr('data-id');
				//alert(_img);
				$.post("<?php echo site_url('web-site-design/webdesigner-limited-sale/orders/delete_website_design_image') ?>",{imgName:_img},
				function(data){
					alert(data);
					 $('.filekoname').hide();
					 $('#fileList').removeAttr('value');
					  $('.notetwo').text('No text or images is needed at this stage. We will be in touch with you with more detailed information in this regard.');
			});	
			});	
    		});
    	</script>
