								...
								<form id="jetpay-form" method="post" action="">
									...
									<ul>
										<li>
											...
											<input type="text" name="company_name" value="<?php echo @$_SESSION['company_name']; ?>" class="required" />
										</li>
										<li>
										...
										<li>
											...
											<span><?php echo $net_total; ?></span>
										</li>
									</ul>
                                    <div class="normal-desc-box text-center">
    									<a href="<?php echo base_url('web-site-design/webdesigner-limited-sale/orders/review'); ?>" class="green-btn order-back-btn">
