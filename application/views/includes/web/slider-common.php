			<?php             
            if($this->router->fetch_class() == 'web'):  // checking controller name            
						...
						<li>
							...
							<div class="res-caption">
				              ...
				              <div class="res-desc">
								  ...
								  <a href="<?php echo base_url('web-site-design/webdesigner-limited-sale/') ?>#websites-packages" class="button">Get Started</a>
							  </div>
				             </div>
						</li>
					    <li>
								...
								<div style="top: 10px;" class="banner-caption process-ban-caption">
									...
									<div class="banner-desc">
										...
										<p>
											...
											<br />
											involvement in the design process as you wish.
										</p>
										<p>
						...
						<div class="col-xs-12">
							<div class="inner-banner">
								...
								<div class="banner-caption process-ban-caption">
									...
									<div class="banner-desc why-choose-us-ban-desc mobipdd">
										<p>The strongest guarantee in the industry</p>
										<p>The most features for the lowest price</p>
										<p>Free, 24/7 lifetime support</p>
<a class="button " href="<?php echo base_url('web-site-design/webdesigner-limited-sale/') ?>#websites-packages">Get Started</a>
									</div>
							...
							<div class="inner-banner">
								...
								<div style="top: 7px;" class="banner-caption process-ban-caption">
									...
									<div class="banner-desc">
										...
										<a class="button" href="<?php echo base_url('web-site-design/webdesigner-limited-sale/') ?>#websites-packages">See Packages</a>
									</div>
								</div>
							</div>
						</div>
					    ...
					    <li>
							...
							<div class="res-caption">
				              ...
				              <div class="res-desc">
				                  ...
				                  <a href="<?php echo base_url('web-site-design/webdesigner-limited-sale/') ?>#websites-packages" class="button">See Packages</a> 
							  </div>
				             </div>
						</li>
						<li>
