...
<html lang="en" class="no-js">
  <head>
    ...
    <title><?php echo (isset($page_title))?$page_title." :: ":""; ?>Logo Designs Guarantee</title>
  ...
  <body>    
    ...
    top: 32px;""  >
     <li id="login">
                    ...
                    <nav id="web-nav" class="navbar navbar-default" role="navigation">
                    	...
                    	<div class="collapse navbar-collapse" id="main-nav">
                    		<ul class="nav navbar-nav">
                    			<li><a data-hover="Web Packages" href="<?php echo base_url('web-site-design/webdesigner-limited-sale'); ?>" <?php echo ($fc == 'web' && $rm == 'index')?"class = active":""; ?> >Web Packages</a></li>
                    			<li><a data-hover="Web Portfolio" href="<?php echo base_url('web-site-design/webdesigner-limited-sale/portfolio'); ?>" <?php echo ($fc == 'web' && $rm == 'portfolio')?"class = active":""; ?> >Web Portfolio</a></li>
                                
                    			<?php /*?><li><a data-hover="Guarantee" href="<?php echo base_url('web-site-design/webdesigner-limited-sale/guarantee'); ?>" <?php echo ($fc == 'web' && $rm == 'guarantee')?"class = active":""; ?> >Guarantee</a></li><?php */?>
                                
                    			<li><a data-hover="How It Works" href="<?php echo base_url('web-site-design/webdesigner-limited-sale/howitworks'); ?>" <?php echo ($fc == 'web' && $rm == 'howitworks')?"class = active":""; ?> >How It Works</a></li>
                    			<li><a data-hover="Why Choose Us" href="<?php echo base_url('web-site-design/webdesigner-limited-sale/whyus'); ?>" <?php echo ($fc == 'web' && $rm == 'whyus')?"class = active":""; ?> >Why Choose Us</a></li>
                    			<li><a data-hover="Hosting" href="<?php echo base_url('web-site-design/webdesigner-limited-sale/hosting'); ?>" <?php echo ($fc == 'web' && $rm == 'hosting')?"class = active":""; ?> >Hosting</a></li>
                    			<li><a data-hover="SEO" href="<?php echo base_url('web-site-design/webdesigner-limited-sale/seo'); ?>" <?php echo ($fc == 'web' && $rm == 'seo')?"class = active":""; ?> >SEO</a></li>
                    			<li><a data-hover="About Us" href="<?php echo base_url('web-site-design/webdesigner-limited-sale/about'); ?>" <?php echo ($fc == 'web' && $rm == 'about')?"class = active":""; ?> >About Us</a></li>
                    			<li><a data-hover="Logo Design" href="<?php echo base_url(); ?>"  >Logo Design</a></li>
                    		</ul>
                    	</div>
                    </nav>
				</div>
            ...
            <?php endif; ?>
            <?php $this->load->view('includes/web/slider-common'); ?>
