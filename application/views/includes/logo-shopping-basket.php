...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.reselect_package').live('click', function () {
            ...
            if (values[0] == 'options11') {
                if ($("input[name='" + values[0] + "']:checked")) {
                    $("input[name='options10']:checked,input[name='options8']:checked,input[name='options7']:checked").next().trigger('click');
                }
            }

            if (((values[0] == 'options10') || (values[0] == 'options8') || (values[0] == 'options7')) && $("input[name='options11']:checked")) {
    ...
    <div id="yellow-box-float" class="yellow-box">
        ...
        <div class="stack clearfix">
            <div class="calc-box  cart">
                ...
                <?php if (isset($_SESSION['poptions_pack' . $_SESSION['pack_id']])) { ?>
                    <div class="inner-border-box options row"> 
                        <span class="col-sm-8"><?php echo $_SESSION['poptions_pack' . $_SESSION['pack_id']] ?></span>
                        <span class="col-sm-2">
                            <a href='javascript:void(0)' class='remove_package' data-id="24hr" id="options___<?php echo $_SESSION['poptions_pack' . $_SESSION['pack_id']] ?>___options_price___<?php echo @$_SESSION['poptions_price' . $_SESSION['pack_id']] ?>" >
