                            ...
                            <script type="text/javascript">
                                ...
                                $(document).ready(function(){
                                    ...
                                    $('.remove_package').live('click',function(){                                        
                                        ...
                                        else{$(".re_calc-box").append("<div class='inner-border-box re_"+values[0]+" row' />");}
                                    ...
                                    //$('.reselect_package').click(function(){
                                        ...
                                        if($('.'+values[0]).length){}
                                        else{$(".calc-box.cart").append("<div class='inner-border-box "+values[0]+" row' />");}
                            ...
                            <style>
                            .inner-border-box.row,.inner-border-box.row .col-sm-8,.inner-border-box.row .col-sm-2{margin: 0; padding: 0;}
                            .inner-border-box.row .col-sm-2.pull-right{text-align: right;}
                            </style>
                            <div id="floated">
								...
								<div id="yellow-box-float" class="yellow-box">
									...
									<div class="stack clearfix">
										<div class="calc-box  cart">
                                            ...
                                            <div class="inner-border-box row web_package">
    											<span class="col-sm-8"><?php echo $_SESSION['web_package'] ?></span>
                                                <span class="col-sm-2"><a href='javascript:void(0)' class='remove_package' id="web_package___<?php echo $_SESSION['web_package'] ?>___web___<?php echo @$_SESSION['web'] ?>" ><img src='<?php echo base_url().'assets/images/remove.gif'; ?>' /></a></span>
    											<span class="col-sm-2 pull-right"><?php echo CURRENCY; ?><span class="package_price"><?php echo @$_SESSION['web'] ?></span></span>
    										</div>
                                            <?php endif; ?>
                                            <?php if(isset($_SESSION['brouchure_package'])): ?>
                                            <div class="inner-border-box row brouchure_package">
    											<span class="col-sm-8" ><?php echo $_SESSION['brouchure_package'] ?></span>
                                                <span class="col-sm-2" ><a href='javascript:void(0)' class='remove_package'  id="brouchure_package___<?php echo $_SESSION['brouchure_package'] ?>___brouchure___<?php echo @$_SESSION['brouchure'] ?>"><img src='<?php echo base_url().'assets/images/remove.gif'; ?>' /></a></span>
    											<span class="col-sm-2 pull-right"><?php echo CURRENCY; ?><span class="package_price"><?php echo $_SESSION['brouchure'] ?></span></span>
    										</div>
                                            <?php endif; ?>
                                            <?php if(isset($_SESSION['options'])): ?>
                                            <div class="inner-border-box options row">
    											<span class="col-sm-8"><?php echo $_SESSION['options'] ?></span>
                                                <span class="col-sm-2"><a href='javascript:void(0)' class='remove_package' id="options___<?php echo $_SESSION['options'] ?>___options_price___<?php echo @$_SESSION['options_price'] ?>" ><img src='<?php echo base_url().'assets/images/remove.gif'; ?>' /></a></span>
                                            ...
                                            for($i=1;$i<=20;$i++){
                                                if(isset($_SESSION['options'.$i]) && $_SESSION['options'.$i] !=''): ?>
                                                    <div class="inner-border-box <?php echo 'options'.$i; ?> row">
                                                        ...
                                                        <span class="col-sm-2"><a href='javascript:void(0)' class='remove_package' id="options<?php echo $i ?>___<?php echo $_SESSION['options'.$i] ?>___options<?php echo $i ?>_price___<?php echo @$_SESSION['options'.$i.'_price'] ?>"><img src='<?php echo base_url().'assets/images/remove.gif'; ?>' /></a></span>
            											<span class="col-sm-2 pull-right"><?php echo CURRENCY; ?><span class="package_price"><?php echo $_SESSION['options'.$i.'_price'] ?></span></span>
            										</div>  
                                            <?php
                                                endif;
                                            }
										...
										<div class="calc-box total">
                                            ...
                                            <div class="inner-border-box tax_box">
                                                <span>Tax <?php echo ($this->logodesignmodel->get_tax_rate(SITE_ID)*100); ?>%</span>
                                                <span class="pull-right"><?php echo CURRENCY; ?><span class="tax_amount">0</span></span>
                                            </div>
                                            <?php endif; ?>                                        
											<strong>Total</strong>
                                    ...
                                    ?>
                                    <div class="inner-border-box row <?php echo 're_'.$services_value[0] ?>" >
										<span class="col-sm-8" ><?php echo $services_value[1] ?></span>
                                        <span class="col-sm-2"><a href='javascript:void(0)' class='reselect_package'  id="<?php echo $services ?>"><img src='<?php echo base_url().'assets/images/reselect.gif'; ?>' style="margin-bottom: 3px;" /></a></span>
										<span class="col-sm-2 pull-right"><?php echo CURRENCY; ?><span class="re_package_price"><?php echo $services_value[3]; ?></span></span>
									</div>
