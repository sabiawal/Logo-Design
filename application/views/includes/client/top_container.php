...
<li class="<?php if($this->router->method == 'more_services')echo 'selected'; ?>"><a href="<?= site_url('new44/more_services');?>" >More Services</a></li>
...
-->
<li class="<?php if($this->router->method == 'price_quotaion_request')echo 'selected'; ?>"><a href="<?= site_url('client_panel/price_quotaion_request'); ?>" id="logo_feedback">Price Quotation Request</a></li>
<li class="<?php if($this->router->method == 'report_problem')echo 'selected'; ?>"><a href="<?= site_url('client_panel/report_problem'); ?>" id="logo_feedback">Report A Problem</a></li>
...
<a href="<?= site_url('web-site-design/webdesigner-limited-sale/index');?>" ><img src="<?= base_url().'assets/images/client/limited-offer.jpg'?>" width="972" alt="Limited Offer, 50% off" title="Limited Offer, 50% off" /></a>

</div>
<?php } ?>    

<?php if($this->router->method != 'price_quotaion_request' && $this->router->method != 'report_problem' && $this->router->method != 'finalStationary' && $this->router->method != 'finalfiles' && $this->router->method != 'send_to_friends' && $this->router->method != 'logo_vote_feedback'){ ?>
<!--<div class="menu">
<ul>
...
?>"><img src="<?=base_url()?>assets/images/webdesign/price_banner-<?= COUNTRY; ?>.jpg" /></a></div>
<div id="rotator">
<img src="<?=base_url()?>assets/images/webdesign/slide_show/1.jpg" />
<img src="<?=base_url()?>assets/images/webdesign/slide_show/2.jpg" />
<img src="<?=base_url()?>assets/images/webdesign/slide_show/3.jpg" />
<img src="<?=base_url()?>assets/images/webdesign/slide_show/4.jpg" />
<img src="<?=base_url()?>assets/images/webdesign/slide_show/5.jpg" />
<img src="<?=base_url()?>assets/images/webdesign/slide_show/6.jpg" />
<img src="<?=base_url()?>assets/images/webdesign/slide_show/7.jpg" />
<img src="<?=base_url()?>assets/images/webdesign/slide_show/8.jpg" />
<img src="<?=base_url()?>assets/images/webdesign/slide_show/9.jpg" />
<img src="<?=base_url()?>assets/images/webdesign/slide_show/10.jpg" />
<img src="<?=base_url()?>assets/images/webdesign/slide_show/11.jpg" />    
</div>
<div class="clear"></div>
