...
<div class="header">
<div class="logo">
<h1><img src="<?php echo base_url()?>assets/images/logo.png" alt="LogoDesign Guarantee" title="logodesign guarantee" width="380" height="132" /></h1>
</div>
<div class="tag" align="center"> 
<div class="limited-sale">
<img src="<?php echo base_url(); ?>assets/images/webdesign/top_offer/webdesign_sale.jpg" alt="Limited offer Sale" title="Limited offer Sale" />
</div>
...
<div class="offer">
<img src="<?= base_url()."assets/images/webdesign/top_offer/index-".COUNTRY.".jpg"; ?>" alt="Special Offer" title="Special Offer" />
<?php
