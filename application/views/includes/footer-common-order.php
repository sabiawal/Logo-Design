        ...
        <div class="container">
            <div class="privacy">
                ...
                <p>Copyright 2003-<?php echo date('Y'); ?>. Designated trademarks and brands are the property of their respective owners. The content on the Logo Design Guarantee website is protected under copyright, trademark, patent and other intellectual property rights belonging to Logo Design Guarantee and any unauthorized use of such content may violate such laws.
                    <br />
                    <?php echo SITE_NAME; ?> is Committed to Producing High Quality Logos!</p>
            </div>
...
<?php if ($this->router->method == 'thankyou'): ?>
    ...
    <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt="" src="https://www.googleadservices.com/pagead/conversion/<?php echo GOOGLE_CONVERSION_ID; ?>/?label=<?php echo GOOGLE_CONVERSION_LABEL; ?>&amp;guid=ON&amp;script=0"alt="img"/>
    </div>
    </noscript>
<?php endif; ?>
