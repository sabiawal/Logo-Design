...
<head>
    ...
    <style type="text/css">
        ...
        @media (min-width: 768px) {
            .top-right-button {
                display: none; /* Hide the button on medium and larger screens */
            }
        }
        ...
        <header id="header">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-4">
                            ...
                            <h1 id="logo"><a title="LOGO DESIGN GUARANTEE" href="index.php"><img class="img-responsive" src="assets/images/logo.jpg" alt="logo design guarantee" style="height: 95px !important; width: 240px !important; object-fit:contain;" /></a></h1>
                        ...
                        <div class="col-xs-4">
                            ...
                            <div class="pull-right r-cont">
                                ...
                                <h2 style="font-size: 20px; font-weight: 700; color: #000; margin-bottom:2px;"><img src="assets/images/phone.png" height="20px" width="20px" alt=""><span class="call-support">24/7 <em style="color: #00af50; font: weight 600px;" class="color"> Devoted </em> Support</span><span class="trademark">™</span></h2>
            ...
            <section class="mobile-nav" style="padding:15px 0px;">
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <h1 id="logo"><a title="LOGO DESIGN GUARANTEE" href="index.php"><img class="img-responsive" src="assets/images/logo.jpg" alt="logo design guarantee" style="height: 80px !important; width: 100% !important;" /></a></h1>
                    </div>
                    <div class="col-xs-3">
                        <a style="font-weight: 600;color:#000; font-size:1.5rem;" class="phone-text" href="https://web.archive.org/web/20181123100553/tel:0845 869 8793"><img src="assets/images/phone.png" height="30px" width="30px" alt=""><br>Call 24/7</a>
                    </div>
                </div>
            </section>
                ...
                <li style="position: absolute; top: 0; right: 0rem; padding: 1rem; z-index: 1000; display: none !important;" id="closeButtonContainer">
                    <button type="button" style="background-color: transparent;" class="close-menu" onclick="closeMobileNavbar()">
