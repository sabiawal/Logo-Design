        <footer id="footer">
				...
				<div class="container">
					<div class="row">
						...
						<div style="margin: 5px 0 0;" class="lag-icon col-xs-3">
							<i class="mail-icon"></i><span><a href="<?php echo site_url('reseller/contact'); ?>">Email Us</a></span>
						</div>
					</div>
				</div>
			</section>
			...
			<section id="black-bar-footer">
				<div class="container">
					<div class="row">
						<ul class="col-xs-3">
							<li><a data-hover="Management team" href="<?php echo site_url('reseller/management'); ?>">Management team</a></li>
							<li><a data-hover="Quality control" href="<?php echo site_url('reseller/quality'); ?>">Quality control</a></li>
							<li><a data-hover="Partnership programs" href="<?php echo site_url('reseller/partnership'); ?>">Partnership programs</a></li>
							<li><a data-hover="Terms and conditions" href="<?php echo site_url('reseller/terms'); ?>">Terms and conditions</a></li>
							<li><a data-hover="View our portfolio" href="<?php echo site_url('reseller/portfolio'); ?>">View our portfolio</a></li>
							<li><a data-hover="Start my logo" href="<?php echo site_url('reseller/packages'); ?>">Start my logo</a></li>
						</ul>
						<ul class="col-xs-3">
							<li><a data-hover="Guarantee" href="<?php echo site_url('reseller/guarantee'); ?>">Guarantee</a></li>
							<li><a data-hover="Privacy policy" href="<?php echo site_url('reseller/privacy'); ?>">Privacy policy</a></li>
							<li><a data-hover="Sample project" href="<?php echo site_url('reseller/sampleproject'); ?>">Sample project</a></li>
							<li><a data-hover="FAQ" href="<?php echo site_url('reseller/faq'); ?>">FAQ</a></li>
							<li><a data-hover="See our packages" href="<?php echo site_url('reseller/packages'); ?>">See our packages</a></li>
							<li><a data-hover="Our charitable work" href="<?php echo site_url('reseller/charity'); ?>">Our charitable work</a></li>
						</ul>
						<ul class="col-xs-3">
							<li><a data-hover="Contact Us" href="<?php echo site_url('reseller/contact'); ?>">Contact us</a></li>
							<li><a data-hover="Compare prices" href="<?php echo site_url('reseller/compare'); ?>">Compare prices</a></li>
							<li><a data-hover="Case study" href="<?php echo site_url('reseller/casestudy'); ?>">Case study</a></li>
							<li><a data-hover="More Services" href="<?php echo site_url('new44/more_services'); ?>" target="_blank">More Services</a></li>
						</ul>
    ...
    <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->	    
        ...
        <img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/1059042374/?label=bRCYCI6kURDG6P74Aw&amp;guid=ON&amp;script=0"alt="img"/>
        </div>
        </noscript>
        <?php endif; ?>
    <script>
