<?php $this->load->view('includes/header-common'); ?>
        ...
        <section class="content">
				...
				<div class="row">
					<div class="logo-in-portfolio col-xs-12">
						<section class="port-gray-border-round-box port-gray-border-round-box-alter clearfix">
							<h2>International Logo Design</h2>
							<div class="fotorama" data-width="1000" data-ratio="1000/252" data-max-width="100%" data-autoplay="5000" data-transition="crossfade" data-loop="true" data-nav="thumbs" data-thumbwidth="250" data-thumbheight="67">
								<img  src="assets/images/logo-in-portfolio/International1.jpg" alt="International1"/>
								<img  src="assets/images/logo-in-portfolio/International2.jpg" alt="International1"/>
								<img  src="assets/images/logo-in-portfolio/International3.jpg" alt="International1"/>
							</div>
							<a href="<?php echo site_url('industry/logo_portfolio_internet'); ?>" class="green-btn-port">Next Industry</a>
						</section>
			...
			<section class="normal-desc-box">
				<div class="container">
					<h5 class="bf-med-title text-center">Getting the right logo is a small but critical step to inspire confidence and trust in prospective clients. With years of experience in creating professional designs for accountancy firms, large and small, you are guaranteed a unique logo that will meet and exceed the needs of your firm.</h5>
					<div class="green-vertical-divider clearfix">
						<div class="col-sm-6">
							<p>The key to designing an excellent accounting logo is to convey that your organization is <strong> ethical, trustworthy, professional and experienced.</strong> In addition to this however, you need to stand out from the crowd.</p>
							<p>Many accountancy logos tend to look quite boring with dull and muted colors. They all seem to just blend together and become forgettable.</p>
							<p>Our <strong> in-house UK designers</strong> have years of experience in finding the right balance between professionalism and unique creative design. This will gain more prospective clients and <strong> increase referrals </strong> for your firm.</p>
							<p>We pride ourselves on our award winning design team who has designed thousands of logos for accountancy firms around the world.</p>
						...
						<div class="col-sm-6">
							<h4 class="green-divider-title">Additional services for accountants:</h4>
							<ul class="dot">
							...
							<br />
							<br />
							<h4 class="green-divider-title theme-green-style2-conly">Additional services for accountants:</h4>
