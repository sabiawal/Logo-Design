...
<section class="content">
                ...
                <div class="row mrtb ">
                    <div class="col-md-4  ">
                        <div class="three-pack mtp">
                            ...
                            <div class="pack-list">
                                <ul>
                                    <li> <strong>6</strong> Logo Design Concepts</li>
                    ...
                    <div class="col-md-4  ">
                        <div class="three-pack mtp">
                            ...
                            <div class="pack-list">
                                <ul>
                                    <li> <strong>12</strong> Logo Design Concepts</li>
                                    <li><strong>Unlimited</strong> Revisions</li>
                                    <li><strong>Unlimited</strong> Logo Concepts</li>
                                    <li><strong>Unlimited</strong> Redraws</li>
    ...
    <section class="widget1 normal-whitebox clearfix">
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                    <h2>Perfectly Crafted Logos</h2>
                    <ul class="width-half tick">
                        <li>Designs tailored for your needs!</li>
    ...
    $(document).ready(function () {
        $(".add3").on("click", function () {
            ...
            if (check_val == "Remove") {
                ...
                $(this).parents('.delivery').find('.service').removeClass('hourd');
                val = 0;
                $(this).html('Add');
            }
            else {
                ...
                $(this).parents('.delivery').find('.service').addClass('hourd');
            }
