<?php 
   ...
   if($p_index == 11 || $p_index == 16){ $_SESSION['web_package'] = BUDGET_WP; $_SESSION['web_price'] = BUDGET_WP_P;}
      else if($p_index == 12 || $p_index == 15 || $p_index == 17){$_SESSION['web_package'] = GOLD_WP;$_SESSION['web_price'] = GOLD_WP_P;}
        else if($p_index == 13 || $p_index == 14 || $p_index == 18){$_SESSION['web_package'] = ELITE_WP;$_SESSION['web_price'] = ELITE_WP_P;}
...
if($_SESSION['p_index'] == 11 || $_SESSION['p_index'] == 16){$logoprice = BUDGET_WP_P;}
         ...
         $logoprice = 0;
                ...
                echo $_SESSION['logo_package'].' '.CURRENCY; echo $_SESSION['logo_price'] + $logoprice; ?>
                                ...
                                <br />Total: 
								<?php  if(isset($_SESSION['poptions_pack'.$p_index])){echo CURRENCY; echo ($_SESSION['poptions_price'.$p_index]+$_SESSION['logo_price'] + $logoprice);}
						else{
							echo CURRENCY; echo $_SESSION['logo_price'] + $logoprice;
							}
							?>
							</h3>
          </div>
