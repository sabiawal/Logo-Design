<div id="floated">
    <div class="order-details">
        ...
        ?>
        <h3> <?php echo CURRENCY; ?><span class="main_price"><?php echo $logoprice; ?></span> </h3>
        <p class="save-pack"> <span class="save-cross"><?php echo CURRENCY . 2 * $logoprice; ?></span> SAVE 50%</p>
...
<?php if (isset($_SESSION['poptions_pack' . $_SESSION['p_index']])) { ?>
    ...
    <?php }
        ...
        <div class="order-list">
            <ul>
                <?php
                //if($_SESSION['p_index'] == '1' || $_SESSION['p_index'] == '2' || $_SESSION['p_index'] == '3'){ $num = 6;}
                ...
                $services = $this->db->order_by("service_order", "asc")->get_where('tbl_services', array('package_id' => $_SESSION['p_index']))->result();
                //echo "<pre>";print_r($services);
                ?>

<?php foreach ($services as $s) { ?>
                    <li><span style="font-weight:700 !important;"><?php echo ucfirst($s->service_name); ?></span></li>
<?php } ?>
