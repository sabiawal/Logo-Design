...
<div id="" class="yellow-box">  <!-- add id="yellow-box-unfloat" to hide on scoll -->
    ...
    <div class="stack clearfix">
        <div class="calc-box  cart">
            ...
            <div class="inner-border-box row logo_package" >
                ...
                <?php 
if($_SESSION['p_index'] == 11 || $_SESSION['p_index'] == 16){$logoprice = BUDGET_WP_P;}
      else if($_SESSION['p_index'] == 12 || $_SESSION['p_index'] == 15 || $_SESSION['p_index'] == 17){$logoprice = GOLD_WP_P;}
        else if($_SESSION['p_index'] == 13 || $_SESSION['p_index'] == 14 || $_SESSION['p_index'] == 18){$logoprice = ELITE_WP_P;}
        else{
         $logoprice = 0;
        }
        ...
        ?>
                <span class="col-sm-2 pull-right"><?php echo CURRENCY; ?><span class="package_price"><?php echo $_SESSION['logo_price']+$logoprice; ?></span></span> 
            </div>
            ...
            <?php if (@$_SESSION['poptions_pack'.$_SESSION['p_index']]) { ?>
                ...
                if (isset($_SESSION['options' . $i]) && $_SESSION['options' . $i] != ''):
                    ...
                    <div class="inner-border-box <?php echo 'options' . $i; ?> row">
                        ...
                        <span class="col-sm-2 pull-right">
                            <?php echo CURRENCY; ?><span class="package_price"><?php echo $_SESSION['options' . $i . '_price'] ?>
                            </span>
                        </span>
                    </div>
                    <?php
        ...
        <div class="calc-box total">
            ...
            <?php endif; ?>
            <strong style="font-size:16px">Total</strong> <strong class="pull-right theme-red" style="font-size:16px; color: #7db701;"><?php echo CURRENCY; ?><span id="basket_total_price">0</span></strong> </div>
...
<?php } ?>
 ...
 if(net_price % 1 != 0){net_price = net_price.toFixed(2);}
