					...
					<div class="col-xs-12">
						<div class="clearfix order-stack">
							<h3 class="order-blue">
								...
								<?php  if(isset($_SESSION['options'])){echo '<br />'.$_SESSION['options']." ".CURRENCY.$_SESSION['options_price'];} ?>
                                
                                <br />Total: 
								<?php  if(isset($_SESSION['options'])){echo CURRENCY.($_SESSION['options_price']+$_SESSION['logo_price']);}
						else{
