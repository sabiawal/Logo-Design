                        ...
                        <div class="white-shade-box">
                         ...
                         <div class="white-shade-box">
                            ...
                            <p> You currently have <?php
                                if ($_SESSION['p_index'] == '22' || $_SESSION['p_index'] == '4' || $_SESSION['p_index'] == '5' || $_SESSION['p_index'] == '7' || $_SESSION['p_index'] == '18') {
                                    echo "6";
                                } else {
                                    echo "3";
                                }
...
<?php endfor; ?>
                ...
                <a href="<?php echo base_url() ?>orders/special" style="color:#666666;font-size:18px; float:left;"><i class="fa fa-chevron-left" aria-hidden="true"></i><span style="padding-left:17px;">Back </span></a>
                            <a style="float:right;" class="green-btn order-submit-btn" href="<?php echo base_url() ?>orders/review?uk=review">
