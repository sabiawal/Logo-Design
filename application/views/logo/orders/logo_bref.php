...
?>
                ...
                <form action="orders/special/" method="post" name="order_detail" id="order_detail" enctype="multipart/form-data">
...
<?php //unset($_SESSION['fileList']) ?>
                                <div class="multi-items">
                                    <div class="file-choose">
                                        ...
                                        <input type="hidden" id="fileList" name="fileList" value ="<?php if (isset($_SESSION['fileList'])) {echo $_SESSION['fileList'];} ?>"  />
                                        <div class="fileList" >
