      ...
      <section class="green-vertical-divider2 clearfix">
        <div class="col-sm-7">
          <div class="leftcol">
            ...
            <form id="package-select" action="orders/specialoffers/" method="post">
              <div class="white-box">
                ...
                <div class="cus-input-shell-cover text-center clearfix">
                  ...
                  <div class="custom-input-shell">
                    <input type="checkbox" <?php if(@$_SESSION['options'] == '24 hours delivery'){ echo 'checked="checked"';}?> class="custom-input" name="options" value="1">
                    <span class="unchk <?php if(@$_SESSION['options'] == '24 hours delivery'){ echo 'chk';}?>"></span> </div>
                </div>
              </div>
              ...
              <div class="white-box">
                ...
                <div class="cus-input-shell-cover text-center clearfix">
                  <div class="select-txt">Select here</div>
                  <div class="custom-input-shell">
                    <input type="checkbox"<?php if(@$_SESSION['options'] == 'Black and white additional logo design file'){ echo 'checked="checked"';}?> class="custom-input" name="options" value="2">
                    <span class="unchk <?php if(@$_SESSION['options'] == 'Black and white additional logo design file'){ echo 'chk';}?>" ></span> </div>
                </div>
              </div>
              <div class="double-shadow1"></div>
              <div class="white-box">
                ...
                <div class="cus-input-shell-cover text-center clearfix">
                  <div class="select-txt">Select here</div>
                  <div class="custom-input-shell">
                    <input type="checkbox" <?php if(@$_SESSION['options'] == '24 Hour Delivery and Black and White file'){ echo 'checked="checked"';}?> class="custom-input" name="options" value="3">
                    <span class="unchk <?php if(@$_SESSION['options'] == '24 Hour Delivery and Black and White file'){ echo 'chk';}?>" ></span> </div>
                </div>
              </div>
              <div class="double-shadow1"></div>
              <div class="clearfix">
                ...
                <div class="inner-lvl clearfix">
                  ...
                  <div class="desc-testo">
                    ...
                    <p>"It was very exciting to get all my logos within 
                      24 hours. The black and white file provided full 
...
<script type="text/javascript"> 
         $(document).ready(function(){			
			$(".custom-input-shell").find(".unchk").on("click", function(){
                ...
                $.post("<?php echo base_url()?>orders/save_options.php",'options='+val,function(data){
                    var opt = eval('('+data+')');                    
                    if(opt.options){
                        if($('.options').length){}
                        else{$(".calc-box.cart").append("<div class='inner-border-box options row' />");}
