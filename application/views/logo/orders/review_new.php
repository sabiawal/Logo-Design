						...
						<div class="col-sm-7">
							<div class="leftcol">
								...
								<div class="stack">
									...
									<p>Our clients are happy and only 3% ask for a refund. We will start working on your designs as soon as payment is received. We will email all your logo samples within 6 hours.</p>
...
<?php include("floated-special.php"); ?>
					...
					<div class="normal-desc-box text-center">
						<!-- <a href="<?php echo base_url(); ?>orders/specialoffers" class="green-btn order-back-btn">
							<span data-hover="Back">Back</span>
						</a> -->
						<a href="<?php echo base_url() ?>orders/specialoffers" style="color:#666666;font-size:18px; float:left;"><i class="fa fa-chevron-left" aria-hidden="true"></i><span style="padding-left:17px;">Back </span></a>
                        
                        <a class="green-btn order-submit-btn" href="<?php echo base_url(); ?>orders/payment_process?uk=payment_process">
                        	<span data-hover="Continue">Continue to our secure payment page <i class="fa fa-chevron-right" aria-hidden="true"></i></span>
                        </a>
