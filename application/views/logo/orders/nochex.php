...
<p>Please Wait...</p>
<!--Start Nochex payment Start http://www.logodesignguarantee.co.uk/assets/images/logo.png  -->	
...
<input type="hidden" name="returnurl" value="<?php echo base_url().'orders/thankyou?p='.$net_total ?>" />
