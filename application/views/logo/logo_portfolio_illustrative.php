        ...
        <section class="content">
			...
			<section class="normal-desc-box">
				...
				<div class="green-vertical-divider clearfix">
					<div class="col-sm-6">
						<p>Our <strong>UK award-winning designers</strong> can help you create a logo that would suit your tastes, and give the feel of total professionalism; mixed with the elegance and skill and art that others must see.</p>
