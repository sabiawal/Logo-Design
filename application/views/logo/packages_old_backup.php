	...
	<section class="content">
				...
				<div class="row">
					<div class="color-box clearfix">
						<div style="margin: 0 0 50px;" class="clearfix">
							<?php $this->load->view('includes/package-red');?>
								<?php $this->
									load->view('includes/package-blue'); ?>
									<?php $this->
										load->view('includes/package-green'); ?>
										<?php $this->
											load->view('includes/support-pic'); ?>
						</div>
								...
								<div class="top">
									<p>
										<b style="text-decoration: line-through;">
											<?php echo CURRENCY.LOGO_COPYRIGHT_P; ?>
										</b>
										<span>
											FREE
										</span>
										Copyright Legal Certificate
									</p>
									<p>
										<b style="text-decoration: line-through;">
											<?php echo CURRENCY.LOGO_ALTERNATION_P; ?>
										</b>
										<span>
											FREE
										</span>
										Lifetime Alterations to your Logo
									</p>
								</div>
								<span class="include">
									Included in All Logo Packages
								</span>
							</div>
							<div class="right">
								<p class="red">
		...
		<section class="slogan">
			<div class="container">
				...
				<div class="text-center slogan-tagline">
					Here are some advantages you won't find with our competitors
				</div>
			</div>
		</section>
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div style="padding: 0 0 0 36px;" class="clearfix">
							<h2>
								The Most Logo Samples for the Lowest Price
							</h2>
							<ul class="width-half">
								<li>
									A Minimum of
								...
								<li>
									...
									Professional Designers work on your Logo
								</li>
							</ul>
							<ul class="width-half">
								<li>
									Others Offer Just 1 or 2
								</li>
								<li>
									Others Outsource Your Designs
								</li>
								<li>
									Others Offer Just 1
								</li>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8">
						...
						<ul class="width-half">
							<li>
								Others Use Templates and Clip Art
							</li>
							<li>
								Others Only Offer this with High Prices
							</li>
							<li>
								Others Do Not Offer This
							</li>
						</ul>
					</div>
					<div class="col-sm-4">
				...
				<div class="row">
					...
					<div class="col-sm-8">
						...
						<ul class="width-half">
							...
							<li>
								Your Revisions Will Be Completed in Just
								<span>
									24 Hours
								</span>
							</li>
						...
						<ul class="width-half">
							<li>
								Others Usually Offer Support Weekday 9-5
							</li>
							<li>
								Others Do Not Offer This
							</li>
							<li>
								Others Take Several Days or Weeks
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-8">
						...
						<ul class="width-half thin-arrow">
							...
							<li>
								Other Will Surprise You After Placing an Order
							</li>
							<li>
								Other Will Debate Whether You Deserve a Refund
							</li>
						</ul>
					</div>
