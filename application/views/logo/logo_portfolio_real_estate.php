				...
				<div class="container">
					...
					<div class="green-vertical-divider clearfix">
						<div class="col-sm-6">
							...
							<p>We can make the logo the way you want it to be. <span style="font-style: italic;">You're the boss.</span> Imagine... <strong>UK-Award Winning designers</strong> are going to treat a real estate client as the boss. Isn't it awesome?</p>
