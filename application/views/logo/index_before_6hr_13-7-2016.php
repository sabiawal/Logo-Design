<?php $this->load->view('includes/header-common'); ?>
						...
						<div class="tab-pane fade in active" id="logos">
							...
							<div class="col-md-3 devoted-support">
								...
								<div class="gurantee-box">
									<?php /*?><a href="<?php echo site_url('guarantee') ?>"><?php echo GUARANTEE_DAYS; ?> DAY, 100% MONEY BACK GUARANTEE</a><?php */?>
						...
						<div class="tab-pane fade" id="websites">
							...
							<div class="col-lg-3 devoted-support">
								...
								<div class="gurantee-box">
                                    ...
                                    <a style="cursor:pointer">Phone contact with your designers.</a>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<ul class="clearfix text-center">
						<li>
							...
							<h4>Personal process</h4>
							<p>Our team provides designs that suit your business needs.</p>
						</li>
						<li>
		...
		<!--<section id="sief-design-process" class="sief-design-device">
			<div class="container">
				<div class="row">
					<div class="title">
						<div class="col-lg-4"><img src="assets/images/process-arrow-down.png" alt="process arrow" /></div>
