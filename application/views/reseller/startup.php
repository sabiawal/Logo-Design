<?php
$this->load->view('includes/reseller/header-common');
?>
<style>
    @font-face {
                                    ...
                                    <div class="hori">
                                        <ul>
                                            ...
                                            <li><strong>3</strong> Designers<a data-toggle="tooltip" title="Your project will have not one but 3 designers, who will all contribute to provide you with the perfect designs based on your specifications.
                                                                               "  data-placement='top' > <img src="assets/images/added/silver-info.jpg"> </a></li>
                                            <li><strong>6-Hour Logo Design Turnaround</strong> <a data-toggle="tooltip" title="Get your logos within 6 hours. You won't find a faster logo service anywhere else! Best of all, this service is available 24/7, so you can order anytime and never worry about missing a cut-off. This 6-hour service only applies to LOGO services on all packages. "  data-placement='top' > <img src="assets/images/added/silver-info.jpg"> </a></li>
                        ...
                        <div class="row mrtb starup-casefix ">
                            ...
                            <div class="col-md-4 col-sm-6  ">
                                <div class="three-pack mtp">
                                    ...
                                    <div style="position:relative">
                                        <a id="order8" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/8" >Order now</a>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-6  ">
                                <div class="three-pack mtp">
                                    ...
                                    <div style="position:relative">
                                        <a id="order9" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/9" >Order now</a>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-6  ">
                               <!--  <span class="best-value">Best Value</span> -->
                                <div class="three-pack mtp fmtp">
                                    ...
                                    <div style="position:relative">
                                        <a id="order10" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/10/" >Order now</a>
                                    </div>
                    ...
                    <div class="row mrtb starup-casefix ">
                        <div class="col-md-4 col-sm-6  ">
                            <div class="three-pack mtp">
                                ...
                                <div style="position:relative">
                                    <a id="order11" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/11" >Order now</a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6  ">
                            <div class="three-pack mtp">
                                ...
                                <div style="position:relative">
                                    <a id="order12" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/12" >Order now</a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6  ">
                            <div class="three-pack mtp">
                                ...
                                <div style="position:relative">
                                    <a id="order13" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/13" >Order now</a>
                                </div>
                    ...
                    <div class="row mrtb starup-casefix ">
                        <div class="col-md-4 col-sm-6  ">
                            ...
                            <div class="three-pack mtp">
                                ...
                                <div style="position:relative">
                                    <a id="order14" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/14" >Order now</a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6  ">  <span class="best-value">Best Seller</span>
                            <div class="three-pack mtp">
                                ...
                                <div style="position:relative">
                                    <a id="order15" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/15" >Order now</a>
                                </div>
                        ...
                        <div class="row mrtb ">
                            <div class="col-md-4 col-sm-6  ">
                                <div class="three-pack mtp">
                                    ...
                                    <div style="position:relative">
                                        <a id="order16" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/16" >Order now</a>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-6  ">
                                <div class="three-pack mtp">
                                    ...
                                    <div style="position:relative">
                                        <a id="order17" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/17" >Order now</a>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-6  ">
                               <!--  <span class="best-value">Best Value</span> -->
                                <div class="three-pack mtp fmtp">
                                    ...
                                    <div style="position:relative">
                                        <a id="order18" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/18/" >Order now</a>
                                    </div>
                        ...
                        <div class="row mrtb starup-casefix ">
                            <div class="col-md-4 col-sm-6  ">
                                <div class="three-pack mtp">
                                    ...
                                    <div style="position:relative">
                                        <a id="order19" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/19" >Order now</a>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-6  ">
                                <div class="three-pack mtp">
                                    ...
                                    <div style="position:relative">
                                        <a id="order20" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/20" >Order now</a>
                                    </div>
...
<a  class="add3 <?php echo isset($_SESSION['poptions_pack21']) ? "removecolor" : 'addcolor' ?>" href="javascript:void(0)" ><?php echo (isset($_SESSION['poptions_pack21'])) ? "Remove" : "Add"; ?></a></li>
                                    ...
                                    <div style="position:relative">
                                        <a id="order21" class="order-pack" href="<?php echo base_url() ?>reseller_orders/index/21/" >Order now</a>
                                    </div>
