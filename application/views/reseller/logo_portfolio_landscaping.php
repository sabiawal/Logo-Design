				...
				<div class="row">
					<div class="logo-in-portfolio col-xs-12">
						<section class="port-gray-border-round-box port-gray-border-round-box-alter clearfix">
							...
							<a href="<?php echo site_url('reseller/industry/logo_portfolio_medical'); ?>" class="green-btn-port">Next Industry</a>
						</section>
				...
				<div class="container">
					...
					<div class="green-vertical-divider clearfix">
						<div class="col-sm-6">
							...
							<p>With our USA-award winning designers who are <strong>well-known for creating aesthetically pleasing logos</strong> for landscaping companies around the US, UK and many places all over the world.</p>
