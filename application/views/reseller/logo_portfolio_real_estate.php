				...
				<div class="row">
					<div class="logo-in-portfolio col-xs-12">
						<section class="port-gray-border-round-box port-gray-border-round-box-alter clearfix">
							...
							<a href="<?php echo site_url('reseller/industry/logo_portfolio_realtor'); ?>" class="green-btn-port">Next Industry</a>
						</section>
				...
				<div class="container">
					...
					<div class="green-vertical-divider clearfix">
						<div class="col-sm-6">
							...
							<p>We can make the logo the way you want it to be. <span style="font-style: italic;">You're the boss.</span> Imagine... <strong>USA-Award Winning designers</strong> are going to treat a real estate client as the boss. Isn't it awesome?</p>
