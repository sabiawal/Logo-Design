				...
				<div class="row">
					<div class="logo-in-portfolio col-xs-12">
						<section class="port-gray-border-round-box port-gray-border-round-box-alter clearfix">
							...
							<a href="<?php echo site_url('reseller/industry/logo_portfolio_entertainment'); ?>" class="green-btn-port">Next Industry</a>
						</section>
				...
				<div class="container">
					...
					<div class="green-vertical-divider clearfix">
						<div class="col-sm-6">
							...
							<p>With our <strong>experienced USA-award winning designers</strong> who have done education logos for universities and colleges around the US and UK, we will see to it that your finished logo will definitely be superb.</p>
