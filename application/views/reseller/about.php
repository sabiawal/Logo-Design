					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="trapzoid-box about-box">
                                                            <h3 class="text-center"><a href="<?php echo site_url('reseller/guarantee'); ?>">Learn more about our Guarantee...</a></h3>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-sm-5 col-sm-offset-1 lineH26">
								...
								<p>We intend to be the number one destination when anyone needs a quality logo. In addition, we provide an industry shattering <?php GUARANTEE_DAYS; ?>-Day, 100% money-back guarantee to underscore our commitment to customer service.</p>
							</div>
						</div>
					</div>
				</section>
