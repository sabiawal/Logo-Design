				...
				<div class="row">
					<div class="logo-in-portfolio col-xs-12">
						<section class="port-gray-border-round-box port-gray-border-round-box-alter clearfix">
							...
							<a href="<?php echo site_url('reseller/industry/logo_portfolio_construction'); ?>" class="green-btn-port">Next Industry</a>
						</section>
				...
				<div class="container">
					...
					<div class="green-vertical-divider clearfix">
						<div class="col-sm-6">
							...
							<p>In terms of skill, there's no room for doubt! Our <strong>USA award-winning designers</strong> at LogoDesignGuarantee.co.uk are willing to work with you...24 hours a day, 7 days a week!</p>
