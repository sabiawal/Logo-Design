				...
				<div class="container">
					<div class="row">
						<div class="col-sm-5 leftcol">
							...
							<ul>
								<li>
									We will beat any competitor'sprice.
									<br />
									Guaranteed.
								</li>
								<li>
							...
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tbody>
									<tr>
										...
										<td><?php echo CURRENCY.START_LP_P ?></td>
									</tr>
									<tr>
							...
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tbody>
									<tr>
										...
										<td>Unlimited</td>
										<td>6</td>
										<td><span> <del><?php echo CURRENCY.START_LP_P_R ?></del> </span><span class="red"> <?php echo CURRENCY.START_LP_P ?> </span></td>
									</tr>
									<tr>
										<td><a href="javascript:void(0);">Logotree.com</a></td>
										<td>2</td>
			...
			<section id="house-expert-designers" class="clearfix">
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-7">
							<h3 class="title30">3 In House Expert Designers</h3>
							<ul class="dot-bullet">
