                ...
                <div class="clearfix order-stack">
                    <h3 class="order-blue">
                        ...
                        if (isset($_SESSION['poptions_pack' . $p_index])) {
                            $rush_price = $_SESSION['poptions_price' . $p_index];
                            echo '<br />' . $_SESSION['poptions_pack' . $p_index] . " " . CURRENCY . $rush_price;
                        }
                        ?>
                        <?php
                        if (isset($_SESSION['reseller_id'])) {
                            $reseller_discount_price = (0.10 * ($_SESSION['logo_price'] + $rush_price));
                            echo '<br />' . "Reseller 10% OFF:" . " " . CURRENCY . $reseller_discount_price;
                            ?>
                            <br />Total: 
                            <?php
                            if (isset($_SESSION['poptions_pack' . $p_index])) {
                                echo CURRENCY . ($_SESSION['poptions_price' . $p_index] + $_SESSION['logo_price'] - $reseller_discount_price);
                            } else {
                                echo CURRENCY . ($_SESSION['logo_price'] - $reseller_discount_price);
                            }
                            ?>
                            <?php
                        } else {
...
<!--                                        <input type="hidden" name="fileList" value="<?php echo (isset($_SESSION['fileList'])) ? $_SESSION['fileList'] : '' ?>" id="fileList" />-->
                                        <input type="hidden" name="fileList" value="<?php
