...
//     window.history.pushState('forward', null, 'reseller_orders/special/');
...
<section id="order-process" class="content">
      ...
      <section class="green-vertical-divider2 clearfix">
        <div class="col-sm-7">
          <div class="leftcol">
            ...
            <form id="package-select" action="reseller_orders/specialoffers?uk=specialoffers" method="post">
             <!--  <div class="white-box">
 ...
 <input type="checkbox" class="custom-input"  name="options6" value="1" <?php echo (isset($_SESSION['options6'])) ? 'checked="checked"' : ''; ?>>
              ...
              <a href="<?php echo base_url() ?>reseller_orders/logobrief" style="color:#666666;font-size:18px; float:left;"><i class="fa fa-chevron-left" aria-hidden="true"></i><span style="padding-left:17px;">Back </span></a>
...
<script type="text/javascript"> 
   ...
   //              $.post("<?php //echo base_url()?>reseller_orders/save_options.php",'options='+val,function(data){
   //                  var opt = eval('('+data+')');                    
   //                  if(opt.options){
   //                      if($('.options').length){}
