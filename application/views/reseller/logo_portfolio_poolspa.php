				...
				<div class="row">
					<div class="logo-in-portfolio col-xs-12">
						<section class="port-gray-border-round-box port-gray-border-round-box-alter clearfix">
							...
							<a href="<?php echo site_url('reseller/industry/logo_portfolio_real_estate'); ?>" class="green-btn-port">Next Industry</a>
						</section>
				...
				<div class="container">
					...
					<div class="green-vertical-divider clearfix">
						<div class="col-sm-6">
							...
							<p>Our USA award-winning designers can do just that! With years of experience in dealing with different types of pool or spa owners, we are armed and capable of delivering <strong>what you want and need!</strong></p>
							<p>
