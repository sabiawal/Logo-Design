			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						...
						<form action="<?php echo site_url('reseller_orders/extramid'); ?>" method="post" name="order_detail" id="order_detail">
						...
						<div class="clearfix order-stack">
								...
								<li>
									...
									<div class="multi-items">
										...
										<select class="select1" name="web_package">
											...
											<option value="<?php echo BUDGET_WP ?>" <?php echo (@$_SESSION['web'] == BUDGET_WP_P)?'selected="selected"':'' ?>>Budget Website 1 page - Now $299 Was $599</option>
											<option value="<?php echo GOLD_WP ?>" <?php echo (@$_SESSION['web'] == GOLD_WP_P)?'selected="selected"':'' ?>>Gold Website up to 6 pages - Now $499 Was $999</option>
											<option value="<?php echo ELITE_WP ?>" <?php echo (@$_SESSION['web'] == ELITE_WP_P)?'selected="selected"':'' ?>>Elite Website  up to 12 Pages - Now $899 Was $1799</option>
										</select>
									</div>
								</li>
							</ul>
							<div class="small-txt-note">
								<p class="text-center">
									For more information on the Web design packages we offer, click <a class="theme-blue" href="javascript:void(0);">here</a>. 
									<br />
								...
								<li>
									...
									<div class="multi-items">
										...
										<select class="select1" name="brouchure_package">
											<option value="">See package options</option>
											<option value="<?php echo TRI_FOLD_BP ?>" <?php echo (@$_SESSION['brouchure'] == TRI_FOLD_BP_P)?'selected="selected"':'' ?> >Tri-fold Double-Sided - Now $399 Was $799</option>
											<option value="<?php echo FOUR_PAGE_EXEC_BP ?>" <?php echo (@$_SESSION['brouchure'] == FOUR_PAGE_EXEC_BP_P)?'selected="selected"':'' ?> >4 Page Exec - Now $499 Was $999</option>
											<option value="<?php echo EIGHT_PAGE_EXEC_BP ?>" <?php echo (@$_SESSION['brouchure'] == EIGHT_PAGE_EXEC_BP_P)?'selected="selected"':'' ?> >8 Page Exec - Now $699 Was $1399</option>
										</select>
									</div>
								</li>
							</ul>
