...
<section class="content">
                ...
                <div class="row mrtb ">
                    <div class="col-md-4  ">
                        <div class="three-pack mtp">
                            ...
                            <h4><?php echo CURRENCY; ?><span class="main_price"><?php echo number_format(((isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == START_LP && isset($_SESSION['options_price'])) ? START_LP_P_RES + $_SESSION['options_price'] : START_LP_P_RES),'2','.',''); ?></span></h4>
                            <?php if(SHOW_REGULAR_PRICE): ?>
                            <p class="save-pack"> <span class="save-cross"><?php echo CURRENCY . START_LP_P ?></span> SAVE 10%</p>
                            <?php endif; ?>
                            <div class="delivery dropdown">                        
                                ...
                                <ul class="dropdown-menu"  >
                                    <li class="old-pack"><a  href=""> <span class="pack1">24 hour delivery</span><span class="pack2"><?php echo CURRENCY . EXPRESS_DELIVERY_P ?> <?php if(SHOW_REGULAR_PRICE): ?><span class="old-d"><?php echo CURRENCY . EXPRESS_DELIVERY_P_R ?></span><?php endif; ?></span><span class="pack3">  ON SALE  <?php if(SHOW_REGULAR_PRICE): ?><br>SAVE 50% <?php endif; ?></span></a></li>
                                    <div class="add1">
                                        <li> <A class="add3 " ><?php echo (isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == START_LP && isset($_SESSION['options_price'])) ? "Remove" : "Add"; ?></A></li>
                                    </div>	
                                </ul>                       
                            </div>
                            <a class="order-pack" href="<?php echo base_url('reseller_orders/index/1#order-process'); ?>">Order now</a>
                            <div class="pack-list">
                                <ul>
                    ...
                    <div class="col-md-4  ">
                        <div class="three-pack mtp">
                            ...
                            <h4><?php echo CURRENCY; ?><span class="main_price"><?php echo number_format(((isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == SURGE_LP && isset($_SESSION['options_price'])) ? SURGE_LP_P_RES + $_SESSION['options_price'] : SURGE_LP_P_RES),'2','.',''); ?></span></h4>
                            <?php if(SHOW_REGULAR_PRICE): ?>
                            <p class="save-pack"> <span class="save-cross"><?php echo CURRENCY . SURGE_LP_P ?></span> SAVE 10%</p>
                            <?php endif; ?>
                            <div class="delivery dropdown">
                                ...
                                <ul class="dropdown-menu"  >
                                    <li class="old-pack"><a  href=""> <span class="pack1">24 hour delivery</span><span class="pack2"><?php echo CURRENCY . EXPRESS_DELIVERY_P ?> <?php if(SHOW_REGULAR_PRICE): ?><span class="old-d"><?php echo CURRENCY . EXPRESS_DELIVERY_P_R ?></span><?php endif; ?></span><span class="pack3">  ON SALE <?php if(SHOW_REGULAR_PRICE): ?><br>SAVE 50%<?php endif; ?></span></a></li>
                                    <div class="add1">
                                        <li> <A class="add3 " ><?php echo (isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == SURGE_LP && isset($_SESSION['options_price'])) ? "Remove" : "Add"; ?></A></li>
                                    </div>
                                    </li>	
                                </ul>
                            </div>                                
                            <a class="order-pack" href="<?php echo base_url('reseller_orders/index/4#order-process'); ?>">Order now</a>
                            <div class="pack-list">
                                <ul>
                    ...
                    <div class="col-md-4  ">
                        ...
                        <div class="three-pack mtp fmtp">
                            ...
                            <h4><?php echo CURRENCY; ?><span class="main_price"><?php echo number_format(((isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == EXCEL_LP && isset($_SESSION['options_price'])) ? EXCEL_LP_P_RES + $_SESSION['options_price'] : EXCEL_LP_P_RES),'2','.',''); ?></span></h4>
                            <?php if(SHOW_REGULAR_PRICE): ?>
                            <p class="save-pack"> <span class="save-cross"><?php echo CURRENCY . EXCEL_LP_P ?></span> SAVE 10%</p>
                            <?php endif; ?>
                            <div class="delivery dropdown">
                                <a  data-toggle="dropdown" href="#"> <span class="pack1">24 hour delivery</span><span class="pack2"> <?php echo CURRENCY . EXPRESS_DELIVERY_P ?> </span>
                                    <span class="pack3">  ON SALE</span><span class="caret"></span></a>
                                <ul class="dropdown-menu"  >
                                    <li class="old-pack"><a  href=""> <span class="pack1">24 hour delivery </span><span class="pack2"> <?php echo CURRENCY . EXPRESS_DELIVERY_P ?> <?php if(SHOW_REGULAR_PRICE): ?><span class="old-d"><?php echo CURRENCY . EXPRESS_DELIVERY_P_R ?></span><?php endif; ?></span><span class="pack3">  ON SALE<?php if(SHOW_REGULAR_PRICE): ?><br>SAVE 50%<?php endif; ?></span></a></li>
                                    <div class="add1">
                                        <li> <A class="add3 " ><?php echo (isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == EXCEL_LP && isset($_SESSION['options_price'])) ? "Remove" : "Add"; ?></A></li>
                                    </div>
                                    </li>	
                                </ul>
                            </div>
                            <a class="order-pack" href="<?php echo base_url('reseller_orders/index/7#order-process'); ?>">Order now</a>
                            <div class="pack-list">
                                <ul>
            ...
            <div class="row">
                <div class="col-md-4  ">
                    ...
                    <div class="three-pack smt">
                        ...
                        <p>Ideal for personal related logos</p>
                        <h4><?php echo CURRENCY; ?><span class="main_price"><?php echo number_format(((isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == START_PLUS_LP && isset($_SESSION['options_price'])) ? START_PLUS_LP_P_RES + $_SESSION['options_price'] : START_PLUS_LP_P_RES),'2','.',''); ?></span></h4>
                        <?php if(SHOW_REGULAR_PRICE): ?>
                        <p class="save-pack"> <span class="save-cross"><?php echo CURRENCY . START_PLUS_LP_P ?>	</span> SAVE 10%</p>
                        <?php endif; ?>
                        <div class="delivery dropdown">
                            <a  data-toggle="dropdown" href="#"> <span class="pack1">24 hour delivery</span><span class="pack2"><?php echo CURRENCY . EXPRESS_DELIVERY_P ?></span>
                                <span class="pack3">  ON SALE</span><span class="caret"></span></a>
                            <ul class="dropdown-menu"  >
                                <li class="old-pack"><a  href=""> <span class="pack1">24 hour delivery
                                ...
                                <div class="add1">
                                    <li> <A class="add3 " ><?php echo (isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == START_PLUS_LP && isset($_SESSION['options_price'])) ? "Remove" : "Add"; ?></A>
                                    </li>
                                </div>
                                </li>	
                            </ul>
                        </div>
                        <a class="order-pack" href="<?php echo base_url('reseller_orders/index/2#order-process'); ?>">
                            Order now
                        </a>
                        <div class="pack-list">
                            <ul>
                ...
                <div class="col-md-4  ">
                    ...
                    <div class="three-pack smt">
                        ...
                        <h4><?php echo CURRENCY; ?><span class="main_price"><?php echo number_format(((isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == SURGE_PLUS_LP && isset($_SESSION['options_price'])) ? SURGE_PLUS_LP_P_RES + $_SESSION['options_price'] : SURGE_PLUS_LP_P_RES),'2','.',''); ?></span></h4>
                        <?php if(SHOW_REGULAR_PRICE): ?>
                        <p class="save-pack"> <span class="save-cross"><?php echo CURRENCY . SURGE_PLUS_LP_P ?>	</span> SAVE 10%</p>
                        <?php endif; ?>
                        <div class="delivery dropdown">
                            <a  data-toggle="dropdown" href="#"> <span class="pack1">24 hour delivery</span><span class="pack2">          <?php echo CURRENCY . EXPRESS_DELIVERY_P ?>        </span>
                                <span class="pack3">  ON SALE</span><span class="caret"></span></a>
                            <ul class="dropdown-menu"  >
                                <li class="old-pack"><a  href=""> <span class="pack1">24 hour delivery
                                        ...
                                        <span class="pack3">  ON SALE<?php if(SHOW_REGULAR_PRICE): ?><br>
                                            SAVE 50%<?php endif; ?></span></a></li>
                                <div class="add1">
                                    <li> <A class="add3 " ><?php echo (isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == SURGE_PLUS_LP && isset($_SESSION['options_price'])) ? "Remove" : "Add"; ?></A>
                                    </li>
                                </div>
                                </li>	
                            </ul>
                        </div>
                        <a class="order-pack" href="<?php echo base_url('reseller_orders/index/5#order-process'); ?>">
                            Order now
                        </a>
                        <div class="pack-list">
                            <ul>
            ...
            <div class="row">
                <div class="col-md-4  ">
                    <div class="three-pack smt mtp1">
                        ...
                        <p>Ideal for personal related logos</p>
                        <h4><?php echo CURRENCY; ?><span class="main_price"><?php echo number_format(((isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == SUPER_START_PLUS_LP && isset($_SESSION['options_price'])) ? SUPER_START_PLUS_LP_P_RES + $_SESSION['options_price'] : SUPER_START_PLUS_LP_P_RES),'2','.',''); ?></span></h4>
                        <?php if(SHOW_REGULAR_PRICE): ?>
                        <p class="save-pack"> <span class="save-cross"><?php echo CURRENCY . SUPER_START_PLUS_LP_P ?>	</span> SAVE 50%</p>
                        <?php endif; ?>
                        <div class="delivery dropdown">
                            <a  data-toggle="dropdown" href="#"> <span class="pack1">24 hour delivery</span><span class="pack2"> <?php echo CURRENCY . EXPRESS_DELIVERY_P ?> </span>
                                <span class="pack3">  ON SALE</span><span class="caret"></span></a>
                            <ul class="dropdown-menu"  >
                                <li class="old-pack"><a  href=""> <span class="pack1">24 hour delivery
                                        ...
                                        <span class="pack3">  ON SALE<?php if(SHOW_REGULAR_PRICE): ?><br>
                                            SAVE 50% <?php endif; ?></span></a></li>
                                <div class="add1">
                                    <li> <A class="add3 " ><?php echo (isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == SUPER_START_PLUS_LP && isset($_SESSION['options_price'])) ? "Remove" : "Add"; ?></A>
                                    </li>
                                </div>
                                </li>	
                            </ul>
                        </div>
                        <a class="order-pack" href="<?php echo base_url('reseller_orders/index/3#order-process'); ?>">
                            Order now
                        </a>
                        <div class="pack-list">
                            <ul>
    ...
    <?php $this->load->view('includes/reseller/offer-banner'); ?>
    <div class="slogan">
        <div class="container">
    ...
    $(document).ready(function() {
        $(".add3").on("click", function() {
            ...
            $.post("<?php echo site_url('orders/save_options') ?>", 'options=' + val, function(data) {
                var current_price = parseFloat(price.html());
                //alert(data);                    
                var opt = eval('(' + data + ')');
                ...
                //alert(optPrice);
                if (val == 0) {
                    price.html((current_price - extPrice).toFixed(2));
                }
                else {
                    price.html((current_price + extPrice).toFixed(2));
                }
