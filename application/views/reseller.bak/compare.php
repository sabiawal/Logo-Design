							...
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tbody>
									<tr>
										...
										<td><?php echo CURRENCY.number_format(START_LP_P_RES,'2','.',''); ?></td>
									</tr>
									<tr>
							...
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tbody>
									<tr>
										...
										<td>Unlimited</td>
										<td>6</td>
										<td><span> <del><?php echo CURRENCY.START_LP_P ?></del> </span><span class="red"> <?php echo CURRENCY.number_format(START_LP_P_RES,'2','.','') ?> </span></td>
									</tr>
									<tr>
										<td><a href="javascript:void(0);">Logotree.com</a></td>
										<td>2</td>
