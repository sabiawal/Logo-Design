					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="trapzoid-box guarantee-box">
								<h3 style="padding: 46px 0;" class="text-center trapzoid-extent1"><a href="<?php echo base_url('reseller_web/guarantee') ?>">Learn About Our Guarantee</a>
								</h3>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-3 devoted-support">
							...
							<div class="gurantee-box">
								<a href="<?php echo base_url('reseller_web/guarantee'); ?>"><?php echo GUARANTEE_DAYS; ?> DAY, 100% MONEY BACK GUARANTEE</a>
