			...
			<div class="container">
				<div class="row">
					...
					<div class="normal-desc-box text-center">
						<a href="<?php echo base_url('reseller_web_order/index/');?>" class="green-btn order-back-btn">
                        ...
                        <a class="green-btn order-submit-btn" href="<?php echo base_url('reseller_web_order/payment'); ?>">
