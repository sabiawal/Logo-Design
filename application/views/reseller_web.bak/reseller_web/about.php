<?php $this->load->view('includes/reseller_web/header-common'); ?>
        <section class="content clearfix">
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">Hello, there. Let us introduce ourselves...</h1>
				</div>
			</section>
					...
					<div class="row">
						<div class="clearfix">
							...
							<div class="col-sm-6 gray-border1">
								<img class="img-responsive" src="assets/images/introduce-ourselves.jpg" alt="introduce ourselves" />
							</div>
						</div>
						<div class="clearfix text-center col-sm-offset-2 col-xs-8">
			...
			<section id="our-mission">
				...
				<section id="our-mission-body">
					<div class="container">
						<div class="row">
							<div class="col-sm-6 gray-border1">
								<img class="img-responsive" src="assets/images/our-mission-pic.jpg" alt="our mission" />
							</div>
							<div class="col-sm-5 col-sm-offset-1 lineH26">
								...
								<p>We intend to be the number one destination when anyone needs a quality logo. In addition, we provide an industry shattering <?php echo GUARANTEE_DAYS ?>-Day, 100% money-back guarantee to underscore our commitment to customer service.</p>
							</div>
						</div>
					</div>
				</section>
			...
			<section id="we-stand-for" class="clearfix">
				...
				<div class="text-center col-sm-offset-2 col-xs-8 lineH26">
					<p>No-one should pay $200 plus for their set of logos. Our business model is built on the principle of lower price and more satisfied customers. Large staffing allows ample time to be spent on each logo order, so as to ensure full customer satisfaction.</p>
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">Get In Touch With Us. We'd Love to Hear from You!</h1>
				</div>
			</section>
					...
					<div class="row">
						...
						<div class="members-detail-list">
							<div class="col-md-3">
								<ul>
									<li>
										<a href="javascript:void(0);">jacob@logodesignguarantee.com</a>
										<h5>Jacob Smith</h5>
										<dfn>Director of Business Development</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">emma@logodesignguarantee.com</a>
										<h5>Emma Moore</h5>
										<dfn>Creative Department Manager</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">daniel@logodesignguarantee.com</a>
										<h5>Daniel Jones</h5>
										<dfn>Account Manager/Designer</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">will@logodesignguarantee.com</a>
										<h5>Will Johnson</h5>
										<dfn>Account Manager/ Designer</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">ethan@logodesignguarantee.com</a>
										<h5>Ethan Brown</h5>
							...
							<div class="col-md-3">
								<ul>
									<li>
										<a href="javascript:void(0);">joshua@logodesignguarantee.com</a>
										<h5>Joshua Davis</h5>
										<dfn>Designer /Graphic Artist</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">brad@logodesignguarantee.com</a>
										<h5>Brad Miller</h5>
										<dfn>Designer /Graphic Artist</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">christina@logodesignguarantee.com</a>
										<h5>Christina Wilson</h5>
										<dfn>Designer /Graphic Artist</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">anthony@logodesignguarantee.com</a>
										<h5>Anthony Taylor</h5>
										<dfn>Designer /Graphic Artist</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">william@logodesignguarantee.com</a>
							...
							<div class="col-md-3">
								<ul>
									<li>
										<a href="javascript:void(0);">george@logodesignguarantee.com</a>
										<h5>George Thomas</h5>
										<dfn>Designer /Graphic Artist</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">sophia@logodesignguarantee.com</a>
										<h5>Sophia Harris</h5>
										<dfn>Designer /Graphic Artist</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">matthew@logodesignguarantee.com</a>
										<h5>Matthew Clark</h5>
										<dfn>Designer /Graphic Artist</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">micheal@logodesignguarantee.com</a>
										<h5>Michael Lee</h5>
										<dfn>Designer /Graphic Artist</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">olivia@logodesignguarantee.com</a>
										<h5>Olivia Jolie</h5>
										<dfn>Designer</dfn>
									</li>
								</ul>
							...
							<div class="col-md-3">
								<ul>
									<li>
										<a href="javascript:void(0);">kevin@logodesignguarantee.com</a>
										<h5>Kevin Robinson</h5>
										<dfn>Designer</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">hillary@logodesignguarantee.com</a>
										<h5>Hillary Jones</h5>
										<dfn>Designer</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">david@logodesignguarantee.com</a>
										<h5>David Walker</h5>
										<dfn>Designer</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">elizabeth@logodesignguarantee.com</a>
										<h5>Elizabeth Collins</h5>
										<dfn>Designer</dfn>
									</li>
									<li>
										<a href="javascript:void(0);">emily@logodesignguarantee.com</a>
										<h5>Emily Watson</h5>
										<dfn>Designer</dfn>
									</li>
								</ul>
