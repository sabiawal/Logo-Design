    ...
    <div class="container">
        <div class="row">
            <section class="green-vertical-divider2 clearfix">
                    ...
                    <div class="leftcol">
                        <div class="stack">
                            ...
                            <div class="greeny-yellow-box clearfix">
                                <ul>
                                    ...
                                    <li><span class="num">2. </span> <span class="desc"> We provide certified in-house USA designers. All our designers are degreed. We hire "Quality" to produce "Quality". Nearly all competitors outsource to India.</span></li>
                                    <li><span class="num">3. </span> <span class="desc"> Free Content Management System (CMS) with every package. This allows you to easily edit your text at any stage in the future. Other firms charge up to $300 for CMS.</span></li>
                                    <li><span class="num">4. </span> <span class="desc"> Free flash head banner. This means you have an animated design to your site. This requires more advanced designing. Most firms also charge up to $200 for Flash.</span></li>
                        ...
                        <div class="stack">
                            <div class="greeny-yellow-box yellow-borderd clearfix">
                                <p>We offer a 365-Day, 100% Money Back Guarantee on all your order.</p>
                                <p>If you don't think your web site is worth at least $2000 to your business we will refund you in full.</p>
                                <ul style="width: 73%;">
                        ...
                        <div class="stack">
                            ...
                            <p>We have tried to provide peace of mind via our 365 -Day, 100% Money Back Guarantee Policy.</p>
                ...
                <div class="col-sm-5">
                    <?php $this->load->view('includes/reseller_web/shopping-basket'); ?>
                </div>
            </section>

            <div class="normal-desc-box text-center">
                <a href="web-order-process1.php" class="green-btn order-back-btn">
                ...
                <a class="green-btn order-submit-btn" href="<?php echo base_url('reseller_web_orders/payment'); ?>">
