				...
				<div class="row">
					<div class="col-xs-12">
						<div class="clearfix order-stack">
							<h3 class="order-blue">
                                                            Reseller 10% OFF will be applied on payment page (on all services).<br/>
						...
						<div class="text-center">
							<p>For more information about the logo packages we offer, then <strong><a href="https://www.logodesignguarantee.com/index.php/reseller/packages.php#package-pg-body">click here.</a></strong></p>
						...
						<div class="normal-desc-box text-center">
							<a class="green-btn order-back-btn" href="web-design.php">
