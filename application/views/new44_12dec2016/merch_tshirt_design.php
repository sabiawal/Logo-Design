		...
		<section class="content">
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">
						Let other people promote your brand <span class="theme-red">automatically</span>, 
						<br />
			...
			<section class="normal-desc-box normal-top-gray-border no-pad-bottom">
				<div class="container">
					<h5 class="bf-med-title text-center">
						Take advantage of the <span style="text-decoration: underline;">clothing demand</span> to upgrade your advertising strategy and 
						<br />
						let the wearers <span class="theme-red">promote the business for you.</span>
					</h5>
				</div>
			</section>
			...
			<section class="normal-desc-box no-pad-bottom">
				<div class="container">
					<div class="row">
						<div class="col-sm-8">
							<p>T-shirts have been popular as clothing essential with customized art, images and designs.</p>
							<p>Brand names, logos and taglines are placed on the, shirts and these designs may contain your<span class="theme-red">advertisements...</span></p>
							<p>You can also use them as uniforms for your employees to <strong>promote unity</strong> among them.</p>
							<p>...luckily, we can provide you with the best designs that suit your advertising needs!</p>
							<p>
								Our <strong> designers (minimum)</strong> will work on you orders! 
								<br />
								So what are you waiting for? Try it <span style="text-decoration: underline;">now!</span>
							</p>
							<div class="row">
								<ul id="featured-logo-coll" class="clearfix">
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/tshirt1.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/tshirt2.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/tshirt3.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/tshirt4.jpg" alt="" /></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 multi-color-box">
							...
							<div style="min-height: 456px;" class="body orange clearfix">
								<div class="price clearfix">
									<span class="old-price"><?php echo CURRENCY.$price_reg[0]; ?></span>
									<span class="new-price orange"><?php echo CURRENCY.$price[0]; ?></span>
								</div>
								<ul class="detail">
									<li><strong>3</strong> customize design prints.</li>
									<li><strong>Small front</strong> print designs.</li>
						...
						<div class="col-md-3 multi-color-box">
							...
							<div style="min-height: 456px;" class="body blue clearfix">
								<div class="price clearfix">
								...
								<ul class="detail">
									<li><strong>3</strong> customize design prints.</li>
									<li><strong>Full front</strong> print designs.</li>
									<li><strong>Unlimited</strong> revisions.</li>
									<li><strong>1</strong> Designer.</li>
									<li>Final design will be sent in <strong>different formats.</strong></li>
									<li><?php echo GUARANTEE_DAYS; ?> day <strong>100%</strong> money back guarantee.</li>
						...
						<div class="col-md-3 multi-color-box">
							...
							<div style="min-height: 456px;" class="body green clearfix">
								<div class="price clearfix">
									<span class="old-price"><?php echo CURRENCY.$price_reg[2]; ?></span>
									<span class="new-price orange"><?php echo CURRENCY.$price[2]; ?></span>
								</div>
								<ul class="detail">
									<li><strong>6</strong> customize design prints (3 designs for front print and 3 designs for back print).</li>
									<li><strong>Full front</strong> print designs.</li>
									<li><strong>Unlimited</strong> revisions.</li>
									<li><strong>1</strong> Designer.</li>
									<li>Final design will be sent in <strong>different formats.</strong></li>
									<li style="margin: 0 0 70px;"><?php echo GUARANTEE_DAYS; ?> day <strong>100%</strong> money back guarantee.</li>
								</ul>
								<div class="btn-wrap clearfix">
									<a class="green-btn" href="#"><span data-hover="More info">More info</span></a>
									<a class="orange-btn-s" href="#"><span data-hover="Order now">Order now</span></a>
