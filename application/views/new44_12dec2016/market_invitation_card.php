		...
		<section class="content">
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">
						Through a smart invitation card you can <span class="theme-red">express</span> yourself 
						<br />
						better than other ways of inviting...
					</h1>
				</div>
			</section>
			...
			<section class="normal-desc-box normal-top-gray-border no-pad-bottom">
				<div class="container">
					<h5 class="bf-med-title text-center">
						If you really care about the occasion and it really means a lot to you...
						<br />
						Opt for designing <span style="font-style: italic;">Invitation Cards.</span>
					</h5>
				</div>
			</section>
			...
			<section class="normal-desc-box no-pad-bottom">
				<div class="container">
					<div class="row">
						<div class="col-sm-8">
							<p>Invitation card designs convey the love and care you have for your invitees. Your target prospects won't get bored, since we would be creating a unique design that is fit to your business needs.</p>
							<p>And the best part... Is that <strong>you</strong> can customize It <strong>as you want it!</strong> Get your Invitations designed <span style="text-decoration: underline;">now.</span></p>
							<div class="row">
								<ul id="featured-logo-coll" class="clearfix">
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/invitation-card1.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/invitation-card2.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/invitation-card3.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/invitation-card4.jpg" alt="" /></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-orange double">One sided Invitation Card</h2>
							<div style="min-height: 460px;" class="body orange clearfix">
								...
								<ul class="detail">
									...
									<li>Custom design according to your design <strong>needs.</strong></li>
									<li><strong>Unlimited</strong> revisions.</li>
									<li><strong>100%</strong> satisfaction about your design.</li>
									<li><strong><?php echo GUARANTEE_DAYS; ?></strong> day money back guarantee.</li>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-blue double">Two sided Invitation Card</h2>
							<div style="min-height: 460px;" class="body blue clearfix">
								<div class="price clearfix">
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-green double">Folded Invitation Card</h2>
							<div style="min-height: 460px;" class="body green clearfix">
								<div class="price clearfix">
