		...
		<section class="content">
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">
						Stop looking like common-stock...
						<br />
			...
			<section class="normal-desc-box normal-top-gray-border no-pad-bottom">
				<div class="container">
					<h5 class="bf-med-title text-center">
						If you want your <span class="theme-red">high-quality</span> product to be considered as such, then you have to make it look the part.
						<br />
						Give your product the royal treatment it deserves. Give it a well-designed Product Label.
					</h5>
				</div>
			</section>
			...
			<section class="normal-desc-box no-pad-bottom">
				<div class="container">
					<div class="row">
						<div class="col-sm-8">
							<p>Our product label services enable you to customize the design of your label as you please!</p>
							<p>In the world of marketing, your label <span style="text-decoration: underline;">can make or break sales...</span> </p>
							<p>It can be the fine line between trustworthiness and plain shadiness. <span style="font-style: italic;">A fine product needs a fine label.</span></p>
							<p>For the lowest prices and the highest quality, get yours <span style="text-decoration: underline;">here.</span></p>
							<div class="row">
								<ul id="featured-logo-coll" class="clearfix">
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/product-label1.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/product-label2.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/product-label3.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/product-label4.jpg" alt="" /></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-orange triple">Return Address Labels or Mailing Labels</h2>
							<div class="body orange clearfix">
								...
								<ul class="detail">
									<li><strong>3</strong> label designs.</li>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-blue triple">Small Labels (3.43" x 1.93")</h2>
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-green triple">Large Labels (4" x 3")</h2>
