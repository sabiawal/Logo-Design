		...
		<section class="content">
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">
						Bad-looking packages are <span class="theme-red">dropped</span> like hot potatoes.
						<br />
						Make them look cool!
					</h1>
				</div>
			...
			<section class="normal-desc-box normal-top-gray-border no-pad-bottom">
				<div class="container">
					<h5 class="bf-med-title text-center">
						If you think your packages look too bland... Pick up the pace, and <span class="theme-red">increase</span> your sales with the help of 
						<br />
						our team of expert designers that can create the coolest packages for low prices!
					</h5>
				</div>
			</section>
			...
			<section class="normal-desc-box no-pad-bottom">
				<div class="container">
					<div class="row">
						<div class="col-sm-8">
							<p>We can guarantee your satisfaction with your personalized package designs that can sweep your customers off their feet!</p>
							<p style="font-style: italic;">Back your quality products up with quality packaging.</p>
							<p>With the designs that we can create for you, you can say good-bye to low sales, and <strong>wow</strong> your customers many times over!</p>
							<p>Give us a call <span style="text-decoration: underline;">now.</span></p>
							<div class="row">
								<ul id="featured-logo-coll" class="clearfix">
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/product-packaging1.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/product-packaging2.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/product-packaging3.jpg" alt="" /></li>
									<li class="col-sm-3"><img class="img-responsive" src="assets/images/brand-logos/product-packaging4.jpg" alt="" /></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-orange double">Eco-Friendly Product Packaging</h2>
							<div style="min-height: 415px;" class="body orange clearfix">
								...
								<ul class="detail">
									...
									<li><strong>2</strong> designs to choose from. Unlimited revisions.</li>
						...
						<div class="col-md-3 multi-color-box">
							...
							<div style="min-height: 415px;" class="body blue clearfix">
								<div class="price clearfix">
						...
						<div class="col-md-3 multi-color-box">
							<h2 class="color-box-title-green double">Box Product Packaging </h2>
							<div style="min-height: 415px;" class="body green clearfix">
								<div class="price clearfix">
