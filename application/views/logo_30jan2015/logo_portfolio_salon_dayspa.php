				...
				<div class="row">
					<div class="logo-in-portfolio col-xs-12">
						<section class="port-gray-border-round-box port-gray-border-round-box-alter clearfix">
							...
							<a href="<?php echo site_url('industry/logo_portfolio_service_industry'); ?>" class="green-btn-port">Next Industry</a>
						</section>
				...
				<div class="container">
					...
					<div class="green-vertical-divider clearfix">
						<div class="col-sm-6">
							...
							<p>With our <?php echo COUNTRY;?>-award winning designers who have done <span style="font-style: italic;">quality logos</span> for salons and spas around the US, UK and many places all over the world, you will surely have the luxurious and classy appearance that will make you noticeable.</p>
