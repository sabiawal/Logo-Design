	...
	<div class="row">
		...
		<div class="col-sm-7">
			...
			<div class="white-shade-box">
				...
				<p class="theme-green-style2-conly bold700"><input name="extra_qty12" class="extra_qty" value="1" type="radio" <?php echo (!isset($_SESSION['options12']) || (isset($_SESSION['options12']) && $_SESSION['options12']) == BUSINESS_CARD_PRINT_250) ? "checked='checked'" : ""; ?> /> 250 business cards (matt) including free delivery</p>
			...
			<div class="white-shade-box">
			    ...
			    <div class="lft-spacer">
				<p class="theme-green-style2-conly bold700"><input name="extra_qty13" class="extra_qty" value="1" type="radio" <?php echo (!isset($_SESSION['options13']) || (isset($_SESSION['options13']) && $_SESSION['options13'] == LETTER_HEAD_PRINT_25)) ? "checked='checked'" : ""; ?> /> 25 letterheads including free delivery</p>
			...
			<div class="white-shade-box">
			    ...
			    <div class="lft-spacer">
				<p class="theme-green-style2-conly bold700"><input name="extra_qty14" class="extra_qty" value="1" type="radio" <?php echo (!isset($_SESSION['options14']) ||(isset($_SESSION['options14']) && $_SESSION['options14'] == '')) ? "checked='checked'" : ""; ?> /> 100 envelopes including free delivery</p>
			...
			<div class="normal-desc-box text-center">
			    <a href="<?php echo base_url('orders/extra1'); ?>" class="green-btn order-back-btn">
				<span data-hover="Back">Back</span>
			    </a>
			    <!--<button type="submit" class="green-btn order-submit-btn">
				    <span data-hover="Continue">Continue</span>
			    </button>-->
			    <a class="green-btn order-submit-btn" href="<?php echo base_url('orders/review'); ?>">
				<span data-hover="Continue">Continue</span>
			    </a>
			</div>
			<!--</form>-->
    ...
    $(document).ready(function(){
    	...
    	$(".custom-input-shell").find(".unchk").on("click", function(){
    	    ...
    	    $.post("<?php echo site_url('orders/save_extra_options') ?>",{extra_options:row_class,val:val, ext_option:ext_value},function(data){
        		...
        		if(opt.extra_options){
        		    if($('.'+row_class).length){}
        		    else{$(".calc-box.cart").append("<div class='inner-border-box "+row_class+" row' />");}
    	...
    	$('.extra_qty').click(function(){
    		...
    		$.post("<?php echo site_url('orders/save_extra_options') ?>",{extra_options:row_class,val:val,extra_qty:extra_qty},function(data){
                ...
                $(".calc-box.cart").find("."+row_class).html('<span class="col-sm-8">'+opt.extra_options+'</span><span class="col-sm-2">fdsa</span><span class="col-sm-2 pull-right">$<span class="package_price">'+opt.extra_options_price+'</span></span>');
