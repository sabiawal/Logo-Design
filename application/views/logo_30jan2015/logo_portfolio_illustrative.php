        ...
        <section class="content">
				...
				<div class="row">
					<div class="logo-in-portfolio col-xs-12">
						<section class="port-gray-border-round-box port-gray-border-round-box-alter clearfix">
							...
							<a href="<?php echo site_url('industry/logo_portfolio_international'); ?>" class="green-btn-port">Next Industry</a>
						</section>
			...
			<section class="normal-desc-box">
				...
				<div class="green-vertical-divider clearfix">
					<div class="col-sm-6">
						<p>Our <strong><?php echo COUNTRY;?> award-winning designers</strong> can help you create a logo that would suit your tastes, and give the feel of total professionalism; mixed with the elegance and skill and art that others must see.</p>
