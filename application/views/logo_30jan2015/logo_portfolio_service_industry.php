				...
				<div class="row">
					<div class="logo-in-portfolio col-xs-12">
						<section class="port-gray-border-round-box port-gray-border-round-box-alter clearfix">
							...
							<a href="<?php echo site_url('industry/logo_portfolio_travel'); ?>" class="green-btn-port">Next Industry</a>
						</section>
				...
				<div class="container">
					...
					<div class="green-vertical-divider clearfix">
						<div class="col-sm-6">
							...
							<p>That is the first half. We can take care of the <strong>first half</strong> for you. Employ our <?php echo COUNTRY;?> award-winning designers to create your custom logo that would suit your purposes...</p>
