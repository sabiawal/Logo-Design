<?php $this->load->view('includes/header-common'); ?>
        <section class="content clearfix">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="trapzoid-box about-box">
								<h3 class="text-center"><a href="<?php echo site_url('guarantee'); ?>">Learn more about our Guarantee...</a></h3>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="slogan">
				<div class="container">
					<h1 class="text-center">Hello, there. Let us introduce ourselves..in style</h1>
				</div>
			</section>
