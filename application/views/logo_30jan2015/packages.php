...
<?php //for($aaa=1; $aaa<10; $aaa++){if(isset($_SESSION['options'.$aaa])){echo $_SESSION['options'.$aaa];}}
                ...
                <div class="row mrtb ">
                    <div class="col-md-4  ">
                        <div class="three-pack mtp">
                            ...
                            <div class="delivery dropdown">                        
                                <a class="<?php echo isset($_SESSION['poptions_pack1'])? "hourd" : ''?>" data-toggle="dropdown" href="#"> <span class="pack1">24 hour delivery</span><span class="pack2"><?php echo CURRENCY . EXPRESS_DELIVERY_P ?></span>
                                ...
                                <ul class="dropdown-menu"  >
                                    ...
                                    <div class="add1">
                                        <li id="1"> <A class="add3 <?php echo isset($_SESSION['poptions_pack1'])? "removecolor" : 'addcolor'?>" href="javascript:void(0)" ><?php if(isset($_SESSION['poptions_pack1'])){ echo "Remove";}else{echo 'Add';}?></A></li>
                                    </div>	
                                </ul>                       
                            </div>
                    ...
                    <div class="col-md-4  ">
                        <div class="three-pack mtp">
                            ...
                            <?php endif; ?>
                            <div class="delivery dropdown">
                                <a class="<?php echo isset($_SESSION['poptions_pack4'])? "hourd" : ''?>" data-toggle="dropdown" href="#"> <span class="pack1">24 hour delivery</span><span class="pack2"><?php echo CURRENCY . EXPRESS_DELIVERY_P ?></span><span class="pack3">  ON SALE</span><span class="caret"></span></a>
                                <ul class="dropdown-menu"  >
                                    <li class="old-pack"><a> <span class="pack1">24 hour delivery</span><span class="pack2"><?php echo CURRENCY . EXPRESS_DELIVERY_P ?> <?php if(SHOW_REGULAR_PRICE): ?><span class="old-d"><?php echo CURRENCY . EXPRESS_DELIVERY_P_R ?></span><?php endif; ?></span><span class="pack3">  ON SALE <?php if(SHOW_REGULAR_PRICE): ?><br>SAVE 50%<?php endif; ?></span></a></li>
                                    <div class="add1">
                                        <li id="4"> <A class="add3 <?php echo isset($_SESSION['poptions_pack4'])? "removecolor" : 'addcolor'?>" ><?php echo (isset($_SESSION['poptions_pack4'])) ? "Remove" : "Add"; ?></A></li>
                                    </div>
                                    </li>	
                                </ul>
                            </div>                                
                    ...
                    <div class="col-md-4  ">
                        ...
                        <div class="three-pack mtp fmtp">
                            ...
                            <?php endif; ?>
                            <div class="delivery dropdown">
                                <a class="<?php echo isset($_SESSION['poptions_pack7'])? "hourd" : ''?>" data-toggle="dropdown" href="#"> <span class="pack1">24 hour delivery</span><span class="pack2"> <?php echo CURRENCY . EXPRESS_DELIVERY_P ?> </span>
                                    <span class="pack3">  ON SALE</span><span class="caret"></span></a>
                                <ul class="dropdown-menu"  >
                                    <li class="old-pack"><a> <span class="pack1">24 hour delivery </span><span class="pack2"> <?php echo CURRENCY . EXPRESS_DELIVERY_P ?> <?php if(SHOW_REGULAR_PRICE): ?><span class="old-d"><?php echo CURRENCY . EXPRESS_DELIVERY_P_R ?></span><?php endif; ?></span><span class="pack3">  ON SALE<?php if(SHOW_REGULAR_PRICE): ?><br>SAVE 50%<?php endif; ?></span></a></li>
                                    <div class="add1">
                                        <li id="7"> <A class="add3 <?php echo isset($_SESSION['poptions_pack7'])? "removecolor" : 'addcolor'?>" ><?php echo (isset($_SESSION['poptions_pack7'])) ? "Remove" : "Add"; ?></A></li>
                                    </div>
                                    </li>	
                                </ul>
                            </div>
            ...
            <div class="row">
                <div class="col-md-4  ">
                    ...
                    <div class="three-pack smt">
                        ...
                        <?php endif; ?>
                        <div class="delivery dropdown">
                            <a class="<?php echo isset($_SESSION['poptions_pack2'])? "hourd" : ''?>" data-toggle="dropdown" href="#"> <span class="pack1">24 hour delivery</span><span class="pack2"><?php echo CURRENCY . EXPRESS_DELIVERY_P ?></span>
                                <span class="pack3">  ON SALE</span><span class="caret"></span></a>
                            <ul class="dropdown-menu"  >
                                ...
                                <div class="add1">
                                    <li id="2"> <A class="add3 <?php echo isset($_SESSION['poptions_pack2'])? "removecolor" : 'addcolor'?>" ><?php echo isset($_SESSION['poptions_pack2']) ? "Remove" : "Add"; ?></A>
                                    </li>
                                </div>
                                </li>	
                            </ul>
                ...
                <div class="col-md-4  ">
                    ...
                    <div class="three-pack smt">
                        ...
                        <?php endif; ?>
                        <div class="delivery dropdown">
                            <a class="<?php echo isset($_SESSION['poptions_pack5'])? "hourd" : ''?>" data-toggle="dropdown" href="#"> <span class="pack1">24 hour delivery</span><span class="pack2">          <?php echo CURRENCY . EXPRESS_DELIVERY_P ?>        </span>
                                <span class="pack3">  ON SALE</span><span class="caret"></span></a>
                            <ul class="dropdown-menu"  >
                                <li class="old-pack"><a> <span class="pack1">24 hour delivery
                                        </span><span class="pack2">          <?php echo CURRENCY . EXPRESS_DELIVERY_P ?> <?php if(SHOW_REGULAR_PRICE): ?><span class="old-d"><?php echo CURRENCY . EXPRESS_DELIVERY_P_R ?></span><?php endif; ?>       </span>
                                        <span class="pack3">  ON SALE<?php if(SHOW_REGULAR_PRICE): ?><br>
                                            SAVE 50%<?php endif; ?></span></a></li>
                                <div class="add1">
                                    <li id="5"> <A class="add3 <?php echo isset($_SESSION['poptions_pack5'])? "removecolor" : 'addcolor'?>" ><?php echo (isset($_SESSION['poptions_pack5'])) ? "Remove" : "Add"; ?></A>
                                    </li>
                                </div>
                                </li>	
                            </ul>
            ...
            <div class="row">
                <div class="col-md-4  ">
                    <div class="three-pack smt mtp1">
                        ...
                        <?php endif; ?>
                        <div class="delivery dropdown">
                            <a class="<?php echo isset($_SESSION['poptions_pack3'])? "hourd" : ''?>" data-toggle="dropdown" href="#"> <span class="pack1">24 hour delivery</span><span class="pack2"> <?php echo CURRENCY . EXPRESS_DELIVERY_P ?> </span>
                                <span class="pack3">  ON SALE</span><span class="caret"></span></a>
                            <ul class="dropdown-menu"  >
                                <li class="old-pack"><a> <span class="pack1">24 hour delivery
                                        </span><span class="pack2">          <?php echo CURRENCY . EXPRESS_DELIVERY_P ?> <?php if(SHOW_REGULAR_PRICE): ?><span class="old-d"><?php echo CURRENCY . EXPRESS_DELIVERY_P_R ?></span><?php endif; ?>       </span>
                                        <span class="pack3">  ON SALE<?php if(SHOW_REGULAR_PRICE): ?><br>
                                            SAVE 50% <?php endif; ?></span></a></li>
                                <div class="add1">
                                    <li id="3"> <A class="add3 <?php echo isset($_SESSION['poptions_pack3'])? "removecolor" : 'addcolor'?>" ><?php echo (isset($_SESSION['poptions_pack3'])) ? "Remove" : "Add"; ?></A>
                                    </li>
                                </div>
                                </li>	
                            </ul>
