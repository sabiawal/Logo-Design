				...
				<div class="row">
					<div class="logo-in-portfolio col-xs-12">
						<section class="port-gray-border-round-box port-gray-border-round-box-alter clearfix">
							...
							<a href="<?php echo site_url('industry/logo_portfolio_bio_techno'); ?>" class="green-btn-port">Next Industry</a>
						</section>
				...
				<div class="container">
					...
					<div class="green-vertical-divider clearfix">
						<div class="col-sm-6">
							...
							<p>Our <strong> <?php echo COUNTRY; ?>-award winning team of designers have years of experience</strong> in making hotshot logos and designs for automobile owners and manufacturers worldwide. Our team of experienced and professional designers applies their knowledge on creating the perfect logo for your automotive company.</p>
