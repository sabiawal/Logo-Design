        ...
        <section class="content clearfix">
			<div id="banner-bottom-slogan">
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<h3>We will <a href="<?php echo base_url('compare'); ?>"><span class="theme-green-style">beat</span></a> any competitor's price.
								<br>
								Guaranteed.
							</h3>
						</div>
						<div class="col-sm-6">
							<div class="trapzoid-box about-box">
								<?php /*?><h3 class="text-center"><a href="<?php echo site_url('guarantee'); ?>">Learn more about our Guarantee...</a></h3><?php */?>
                                <h3 class="text-center"><a href="<?php echo site_url('portfolio'); ?>">See Our Portfolio </a></h3>
							</div>
						</div>
					</div>
				</div>
			...
			<section id="self-intro" class="lineH26">
				<div class="container">
					<div class="row">
						<div class="clearfix">
							<div class="col-sm-6">
								<p>At Logo Design Guarantee we believe logo designs can be given at great prices with quality to match. Further, all our logos are hand-drawn, which is essential in giving finer detail and creativity to your logos. Few competitors offer hand-drawn logos as the technology is expensive and it’s challenging to hire and/or train designers for this skill set.</p>
