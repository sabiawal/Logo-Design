					...
					<div class="row">
						<div class="col-sm-6">
							<h3>
								...
								<br />
								<a class="theme-green-style2" href="<?php echo base_url('guarantee'); ?>"> <?php echo GUARANTEE_DAYS; ?> Day, 100% Money Back Guarantee </a>
							</h3>
						</div>
						<div class="col-sm-6">
							<div class="trapzoid-box about-box">
								<h3 class="text-center"><a href="<?php echo base_url('guarantee'); ?>">Learn more about our Guarantee...</a></h3>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="green-vertical-divider clearfix">
							<div class="col-sm-6 stack">
								<p>Unlike many firms who limit the number of revisions, we provide unlimited revisions for you as part of our 100% satisfaction guarantee.</p>
			...
			<section class="process-diff-body-patt">
				<div class="container">
					<div class="row">
						...
						<p>
							Wouldn't it be helpful for your colleagues and friends to view
							<br />
							your designs and for them to vote for their favorite? They can
							<br />
							provide helpful feedback to you also. This advertises your
							<br />
							business and starts making connections.
						</p>
					</div>
				</div>
			</section>
