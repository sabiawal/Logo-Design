...
<section class="content">
                        ...
                        <div class="three-pack mtp">
                            ...
                            <div class="pack-list">
                                <ul>
                                   ...
                                   <?php /*?> <li><strong><?php echo GUARANTEE_DAYS ?>-Day - 100% No-Risk <br>Money Back Guarantee</strong>.</li><?php */?>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="three-pack mtp">
                            ...
                            <div class="delivery dropdown">
                                ...
                                <ul class="dropdown-menu"  >
                                    <li class="old-pack"><a  href=""> <span class="pack1">24 hour delivery</span><span class="pack2"><?php echo CURRENCY . EXPRESS_DELIVERY_P ?> <?php if(SHOW_REGULAR_PRICE): ?><span class="old-d"><?php echo CURRENCY . EXPRESS_DELIVERY_P_R ?></span><?php endif; ?></span><span class="pack3">  ON SALE <?php if(SHOW_REGULAR_PRICE): ?><br>SAVE 50%<?php endif; ?></span></a></li>
                                    <div class="add1">
                                        <li> <A class="add3 <?php echo isset($_SESSION['options_price'])? "removecolor" : 'addcolor'?>" href="javascript:void(0)" ><?php echo (isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == SURGE_LP && isset($_SESSION['options_price'])) ? "Remove" : "Add"; ?></A></li>
                                    </div>
                                    </li>	
                                </ul>
                            </div>                                
                        ...
                        <div class="three-pack mtp fmtp">
                            ...
                            <div class="delivery dropdown">
                                ...
                                <ul class="dropdown-menu"  >
                                    <li class="old-pack"><a  href=""> <span class="pack1">24 hour delivery </span><span class="pack2"> <?php echo CURRENCY . EXPRESS_DELIVERY_P ?> <?php if(SHOW_REGULAR_PRICE): ?><span class="old-d"><?php echo CURRENCY . EXPRESS_DELIVERY_P_R ?></span><?php endif; ?></span><span class="pack3">  ON SALE<?php if(SHOW_REGULAR_PRICE): ?><br>SAVE 50%<?php endif; ?></span></a></li>
                                    <div class="add1">
                                        <li> <A class="add3 <?php echo isset($_SESSION['options_price'])? "removecolor" : 'addcolor'?>" href="javascript:void(0)" ><?php echo (isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == EXCEL_LP && isset($_SESSION['options_price'])) ? "Remove" : "Add"; ?></A></li>
                                    </div>
                                    </li>	
                                </ul>
                            </div>
                            ...
                            <div class="pack-list">
                                <ul>
                                    ...
                                    <li>-</li>
                                    <li>-</li>
                                    <li style="margin-bottom: -27px;">-</li>
                                    <!--<li>-</li>-->
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="three-pack smt">
                        ...
                        <div class="delivery dropdown">
                            ...
                            <ul class="dropdown-menu"  >
                                ...
                                <div class="add1">
                                    <li> <A class="add3 <?php echo isset($_SESSION['options_price'])? "removecolor" : 'addcolor'?>" href="javascript:void(0)" ><?php echo (isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == START_PLUS_LP && isset($_SESSION['options_price'])) ? "Remove" : "Add"; ?></A>
                                    </li>
                                </div>
                                </li>	
                            </ul>
                            ...
                            <ul class="dropdown-menu"  >
                                <li class="old-pack"><a  href=""> <span class="pack1">24 hour delivery
                                        ...
                                        <span class="pack3">  ON SALE<?php if(SHOW_REGULAR_PRICE): ?><br>
                                            SAVE 50%<?php endif; ?></span></a></li>
                                <div class="add1">
                                    <li> <A class="add3 <?php echo isset($_SESSION['options_price'])? "removecolor" : 'addcolor'?>" href="javascript:void(0)" ><?php echo (isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == SURGE_PLUS_LP && isset($_SESSION['options_price'])) ? "Remove" : "Add"; ?></A>
                                    </li>
                                </div>
                                </li>	
                            </ul>
                            ...
                            <ul class="dropdown-menu"  >
                                <li class="old-pack"><a  href=""> <span class="pack1">24 hour delivery
                                        ...
                                        <span class="pack3">  ON SALE<?php if(SHOW_REGULAR_PRICE): ?><br>
                                            SAVE 50% <?php endif; ?></span></a></li>
                                <div class="add1">
                                    <li> <A class="add3 <?php echo isset($_SESSION['options_price'])? "removecolor" : 'addcolor'?>" href="javascript:void(0)" ><?php echo (isset($_SESSION['logo_package']) && $_SESSION['logo_package'] == SUPER_START_PLUS_LP && isset($_SESSION['options_price'])) ? "Remove" : "Add"; ?></A>
                                    </li>
                                </div>
                                </li>	
                            </ul>
    ...
    <?php /*?><section class="widget1 normal-whitebox clearfix">
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
