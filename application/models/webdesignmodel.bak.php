...
class Webdesignmodel extends CI_Model {
    ...
    function save_web_order() {
        ...
        $_SESSION['payment_link'] = "";
        if (isset($_SESSION['web_id'])) {
            if (isset($_SESSION['reseller_id'])) {
                $_SESSION['payment_link'] = base_url() . 'reseller_web_orders/epayment.php?web_id=' . $_SESSION['web_id'] . '&amp;auth_code=' . $_SESSION['auth_code'] . $p_info;
            } else {
        ...
        if (isset($_SESSION['reseller_id']) && !strstr($company_name, "- (R)") ) {
            $company_name .= ' - (R)';
        }
        ...
        if ($_SESSION['contact_info'] == '0' || $_SESSION['company_name'] == '0')
            ...
            if (isset($_SESSION['web_id']) && $_SESSION['web_id'] != '') {         //die(1);   
            ...
            if (isset($_SESSION['logo_package'])):
                ...
                if (isset($_SESSION['logo_web_id'])) {
                    ...
                    $this->db->delete('order_extra', array('logo_web_id' => $_SESSION['logo_web_id']));
                } else {
            ...
            if (($query->num_rows()) > 0) {
                ...
                if ($row->payment_status == "1") {
                    ...
                    if ($row->logo_web_id != '0') {
					  ...
					  $mailbody_we = "<br><br>Dear " .  $contact_info . ",
						<br><br>Greetings!
							<br>
						<p>I would like to welcome you and thank you personally for choosing Logo Design Guarantee to be your partner in creating a great website for your business.</p>
						<p>I will personally be supervising on your web design project, so I wanted to introduce myself and to provide you with my contact details if in any case you need to reach me, or if you have any questions regarding your project.</p>
						<p>If there is anything I can assist or help you with, please do not hesitate to call. I look forward to a wonderful and successful business relationship.</p>
						<br><br>Sincerely,
						<br>
						Wendy Graham
						<br>
                        ...
                        $this->email->from('<' . ORDER_MAIL . '>', 'Web Admin');
                        $this->email->subject('Your Web Account Manager');
                        $this->email->message($mailbody_we);
