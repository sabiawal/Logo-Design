...
class Web_order extends CI_Controller {
    ...
    public function index($p_index = NULL) {
        ...
        $this->load->view('web/orders/index', $data);
    }
    ...
    public function extramid() {
        if (@$_SESSION['va'] == 1):
            ...
            redirect('web-site-design/webdesigner-limited-sale/orders/review');
        endif;
    }
    ...
    public function review() {
        ...
        if (!isset($_SESSION['company_name']) && !isset($_SESSION['contact_info'])):
            ...
            redirect('web-site-design/webdesigner-limited-sale/orders');
        endif;
        ...
        //echo 'saved';
        $this->load->view('web/orders/review');
    }
    ...
    public function payment() {
       /* if (!isset($_SESSION['contact_info']) && !isset($_SESSION['company_name'])):
            if (!isset($_SESSION['web_package'])):
                redirect('web-site-design/webdesigner-limited-sale/index');
            endif;
        ...
        if (SITE_ID == 7):
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($xmlResponse->ActionCode == '000'):
                    ...
                    redirect('web-site-design/webdesigner-limited-sale/orders/thankyou?p=' . $amount);
                else:
        ...
        elseif (SITE_ID == 6):
            $this->load->view('web/orders/nochex', $data);
        endif;
    }
        ...
        if (isset($_REQUEST['web_id']) && $_REQUEST['web_id'] != '') {
            ...
            if ($get_row > 0) {
                ...
                if ($unpaid_status > 0) {
                    ...
                    if ($logo_price) {
                        $order_desc .= ', ' . $details->$this->logo_package . '(' . CURRENCY . $this->logo_price . ')';
                    }
    ...
    public function thankyou() {
        ...
        session_destroy();
        $this->load->view('web/orders/thankyou');
    }
	
	// delete image of website design  in wrb order
	function delete_website_design_image()
		{
			$img = $this->input->post('imgName');
			$imgpath = $_SERVER['DOCUMENT_ROOT'].'ldg_com/web_images/'.$img;
			//die;
			if(is_file($imgpath)){
				unlink($imgpath);
