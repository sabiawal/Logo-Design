...
//Mail Sending Ajax module for Hotmail, Gmail and Aol
        ...
        $('.imported_send').click(function(){
                ...
                var all_logos = [];
                //alert(logo_web_id); return false;
               $('.all_l').each(function(){
                   all_logos.push($(this).val());
               });
               //alert(all_logos); return false;
		...
		if(checked_emails.length==0){
                        ...
                        $('.error').remove();
			$(this).after('<img src="http://www.logodesignguarantee.com/contact_import/images/processing_new.gif" style="float: left; margin: 3px 0 0 10px; width: 200px;" class="show-img" />');                     
                         $.post("../client_panel/send_Mail", {Emails: checked_emails, Sender_email: sender_email, LogoWebId: logo_web_id, All_Logo: all_logos} ).done(function(data) {
                            ...
                            window.top.location.href="http://www.logodesignguarantee.com/contact_import/clear_database.php";
			});
		}          		
	});	
