...
var Sliderman = new function(){
	...
	Sliderman.effect({name: 'blinds', cols: 20, delay: 100, duration: 1000, order: 'straight', right: true, zoom: true, fade: true});
	Sliderman.effect({name: 'rain', cols: 20, delay: 100, duration: 1000, order: 'straight', top: true, fade: true});
