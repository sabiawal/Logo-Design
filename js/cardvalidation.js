    ...
    //var base_url = 'http://ldg.com/';
    var base_url = 'https://www.logodesignguarantee.com/';
    //var base_url = 'https://www.logodesignguarantee.co.uk/';
	cardPics[nVisaCardType] = new Image();
	cardPics[nVisaCardType].src=base_url+"jetpay/images/cards/visa.jpg";
	cardPics[nMastercardCardType] = new Image();
	cardPics[nMastercardCardType].src=base_url+"jetpay/validation/cards/mastercard.jpg";
	cardPics[nDiscoverCardType] = new Image();
	cardPics[nDiscoverCardType].src=base_url+"jetpay/images/cards/discover.jpg";
	cardPics[nAmexCardType] = new Image();
	cardPics[nAmexCardType].src=base_url+"jetpay/images/cards/amex.jpg";
	cardPics[nDinersClubCardType] = new Image();
	cardPics[nDinersClubCardType].src=base_url+"jetpay/images/cards/dinersclub.jpg";
	cardPics[nCarteBlancheCardType] = new Image();
	cardPics[nCarteBlancheCardType].src=base_url+"jetpay/images/cards/carteblanche.jpg";
	cardPics[nEnRouteCardType] = new Image();
	cardPics[nEnRouteCardType].src=base_url+"jetpay/images/cards/enroute.jpg";
	cardPics[nJCBCardType] = new Image();
	cardPics[nJCBCardType].src=base_url+"jetpay/images/cards/jcb.jpg";
	cardPics[nUnknownCardType] = new Image();
	cardPics[nUnknownCardType].src=base_url+"jetpay/images/cards/invalid.gif";
