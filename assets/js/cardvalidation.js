	...
	cardPics[nVisaCardType].src="http://localhost/ldg_com/jetpay/images/cards/visa.jpg";
	cardPics[nMastercardCardType] = new Image();
	cardPics[nMastercardCardType].src="http://localhost/ldg_com/jetpay/validation/cards/mastercard.jpg";
	cardPics[nDiscoverCardType] = new Image();
	cardPics[nDiscoverCardType].src="http://localhost/ldg_com/jetpay/images/cards/discover.jpg";
	cardPics[nAmexCardType] = new Image();
	cardPics[nAmexCardType].src="http://localhost/ldg_com/jetpay/images/cards/amex.jpg";
	cardPics[nDinersClubCardType] = new Image();
	cardPics[nDinersClubCardType].src="http://localhost/ldg_com/jetpay/images/cards/dinersclub.jpg";
	cardPics[nCarteBlancheCardType] = new Image();
	cardPics[nCarteBlancheCardType].src="http://localhost/ldg_com/jetpay/images/cards/carteblanche.jpg";
	cardPics[nEnRouteCardType] = new Image();
	cardPics[nEnRouteCardType].src="http://localhost/ldg_com/jetpay/images/cards/enroute.jpg";
	cardPics[nJCBCardType] = new Image();
	cardPics[nJCBCardType].src="http://localhost/ldg_com/jetpay/images/cards/jcb.jpg";
	cardPics[nUnknownCardType] = new Image();
	cardPics[nUnknownCardType].src="http://localhost/ldg_com/jetpay/images/cards/invalid.gif";
